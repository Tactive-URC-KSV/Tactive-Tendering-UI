...
function ProjectInfo({ project, handleSubmit, region, 
    Pack, sector, setProject, setRegion, setSector, setScopePack, setUom, uom, loading, fileInputRef, uploadedFiles, setUploadedFiles }) {
