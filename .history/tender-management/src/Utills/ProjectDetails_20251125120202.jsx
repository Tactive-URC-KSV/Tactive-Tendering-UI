...
function ProjectInfo({ project, handleSubmit, region, scopePack, sector, setProject, setRegion, setSector, setScopePack, setUom, uom, loading, fileInputRef, uploadedFiles, setUploadedFiles }) {
    ...
    // 🚨 START: CUSTOM COMPONENTS FOR EXTERNAL TAG DISPLAY 🚨

    // 1. Component to stop rendering the selected value tags inside the box
    const CustomMultiValueContainer = ({ children, ...props }) => {
        // By returning null, we hide the multi-value tags inside the control.
        return null;
    };

    // 2. Component to hide the dropdown indicator (the down arrow)
    const CustomDropdownIndicator = (props) => {
        return null;
    };

    // 3. Component to hide the vertical line separator
                ...
                <div className="row align-items-center ms-4 me-4">
                    <div className="col-12 mt-3">
                        ...
                        <Select
                            ...
                            // Apply custom components to hide internal tags and indicators
                            components={{
                        ...
                        {/* 🎯 START: EXTERNAL TAGS DISPLAY (BELOW THE BOX) 🎯 */}
                            ...
                            {scopeOptions
                                ...
                                .map(selectedOpt => (
                                    <span key={selectedOpt.value} className="select__multi-value">
                                        ...
                                        {/* External Remove 'X' Button, using CSS class defined in style.css */}
                                        <span
