...
function ProjectInfo({ project, handleSubmit, region, scopePack, sector, setProject, setRegion, setSector, setScopePack, setUom, uom, loading, fileInputRef, uploadedFiles, setUploadedFiles }) {
  ...
  <Select
    ...
    onChange={onChange}
    components={{
      ValueContainer: () => null,   // hide everything inside input
      IndicatorsContainer: () => null // remove arrow + X from inside
    }}
  />

  {/* Below-area containing chips + icons */}
  <div className="multi-select-below">
    ...
    <div className="below-icons">
      <span className="clear-icon" onClick={() => onChange([])}>×</span>
