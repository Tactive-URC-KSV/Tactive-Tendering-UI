...
const AttachmentRow = ({ title, files, notes }) => (
  ...
  const reviewTender = () => {
        ...
        return (
           <div className="p-4">
    {/* Outer Container for the entire 'Review & Float Tender' step content */}

    {/* Header (Review & Float Tender) - Kept outside the first card for standard page header style */}
    ...
    {/* NEW WHITE CONTAINER CARD for Floating Info */}
    ...
    {/* End of White Container Card */}

    {/* ... other content sections (General Details, Package Details, etc.) would follow here ... */}
