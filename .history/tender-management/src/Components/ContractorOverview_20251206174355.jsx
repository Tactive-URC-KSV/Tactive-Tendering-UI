...
function ContractorOverview() {
 ...
 const ManualEntryForm = () => (
  <>
    ...
    <div className="row mb-3">
      <div className="col-md-6 mt-3 mb-4">
                        <label className="formdata  text-start d-block">Effective Date</label>
                        <Flatpickr
                            id="effectiveDate"
                            className="form-input w-100"
                            ...
                            onChange={([date]) => setFormData({ ... <div className="col-md-6 mt-3 mb-4">
    ...
    >
      ...
      <label htmlFor="fileUpload" className="d-block cursor-pointer">
        ...
        <p className="mb-1 fw-bold" style={{ color: bluePrimary || "#007bff" }}>
