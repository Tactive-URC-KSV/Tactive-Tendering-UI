...
import { ArrowLeft, ArrowRight, BoxesIcon, ChevronDown, ChevronRight, IndianRupee, Info, Paperclip, Plus, User2, X,ArrowUp } from 'lucide-react'; 
...
>
    ...
    // 2. Handler to trigger the file input
    const handleClick = () => {
        fileInputRef.current.click();
    };

    // 3. Handler to capture the selected file
        ...
        <div className="col-md-6 mb-4">
            <div className="border rounded p-3" style={{ border: '2px dashed #ced4da', minHeight: '220px' }}>
                <div className="text-center">
                    ...
                    {file ? (
                        <div className='py-4 px-3 text-success fw-medium'>
                    ...
                    <textarea
                        ...
                        style={{ resize: 'none' }}
                        value={notes}
                        onChange={(e) => setNotes(e.target.value)} // Update the notes state in the parent
                    ></textarea>
                </div>
            </div>
        </div>
   ...
   const attachmentDetails = ({ handlePrevious, setCurrentTab }) => { // Assume these handlers are passed from the main component
    ...
    // The UploadBox component definition should be outside or above this function, 
    // but for completeness, we'll keep the rest of the return block here:
    ...
    return (
        <div className="p-2">
            ...
            <div className="container mt-4">
             ...
             {/* Footer Navigation (Replicates the screenshot structure) */}
            <div className="d-flex justify-content-between align-items-center ms-3 me-3 mt-4 mb-4">
                <button className="btn cancel-button" onClick={handlePrevious}>Previous</button>
                <button className="btn action-button" onClick={() => setCurrentTab('review')}>
                    <span className="fw-bold me-2">Review & Confirm</span><ArrowRight size={18} />
