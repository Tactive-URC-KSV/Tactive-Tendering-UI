...
import { ArrowLeft, ArrowRight, BoxesIcon, ChevronDown, ChevronRight, IndianRupee, Info, Paperclip, Plus, User2, X, FaCloudUploadAlt, FaTimes  } from 'lucide-react'; 
...
>
   ...
   export default function AttachmentsComponent() {
                    ...
                    {attachmentTypes.map(item => (
                        <div className="col-md-6 mb-4" key={item.key}>
                            ...
                            <div className="mb-3 bg-white">
                                <div className="upload-file row p-3 ms-auto me-auto text-center">
                                    ...
                                    {/* Choose File Button */}
                                    <div className="col-12 mt-2 py-2">
                                        <button
                                            className="btn action-button mt-2"
