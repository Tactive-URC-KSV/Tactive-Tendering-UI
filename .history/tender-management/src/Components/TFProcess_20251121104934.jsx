...
function TFProcess({ projectId }) {
    ...
    [plugin:vite:react-babel] C:\Users\karth\OneDrive\Desktop\projects\Tactive-Tendering-UI\tender-management\src\Components\TFProcess.jsx: 'import' and 'export' may only appear at the top level. (175:4)
  178 | // --- 1. UploadBox Component Definition ---
C:/Users/karth/OneDrive/Desktop/projects/Tactive-Tendering-UI/tender-management/src/Components/TFProcess.jsx:175:4
176 |  import { Paperclip, ArrowUp, ArrowRight, X } from 'lucide-react'; // Added 'X' for file removal
177 |  
178 |  // --- 1. UploadBox Component Definition ---
    |                              ^
179 |  // This component handles the UI for a single attachment and manages the file/notes state.
180 |  const UploadBox = ({ title, placeholder, notesPlaceholder, file, setFile, notes, setNotes }) => {
