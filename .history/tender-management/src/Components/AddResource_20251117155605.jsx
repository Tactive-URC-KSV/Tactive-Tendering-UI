...
  // Placeholder data for the BOQ summary (matching the image)
  const boqUOM = "CUM"; 
...
  const FormSectionContainer = ({ title, icon, defaultOpen, children }) => {
        // Use details/summary for the collapsible functionality and shape
        return (
            <div className="mb-4">
                <details open={defaultOpen}>
                    <summary 
                        ...
                        style={{
                            ...
                            borderRadius: '0.5rem',
                            marginBottom: '1rem', // Space below the summary when collapsed
                        }}
                    >
                    ...
                    {/* Content area - Hidden when collapsed, visible when open */}
                    <div className="p-4" style={{ 
                        ...
                        marginTop: '-1rem' // Pull content up to meet the header border
                    }}>
                        {children}
                    </div>
                </details>
