...
function ContractorOverview() {
    ...
    // ADDED THE OUTER CARD CONTAINER HERE
    <div className="card text-start border-0 shadow-sm mt-4" style={{ borderRadius: "8px", padding: "0 1.5rem 1.5rem 1.5rem" }}>
        ...
        <div className="row">
            <div className="col-md-6 mt-3 mb-4"> {/* Consistent Margin */}
                <label className="projectform text-start d-block">
        ...
        {/* Row 2: Effective Date (FIXED) | Entity Type (FIXED Margin) */}
        <div className="row"> 
            <div className="col-md-6 mt-3 mb-4"> {/* Consistent Margin */}
                ...
                <div className="input-group">
                    ...
                    {/* ADDED Calendar ICON using Lucide React */}
