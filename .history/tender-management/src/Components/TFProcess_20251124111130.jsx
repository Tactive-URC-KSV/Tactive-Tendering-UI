...
const AttachmentRow = ({ title, files, notes }) => (
  ...
  const reviewTender = () => {
    ...
    <div className="p-4">
        ...
        {/* 1. REVIEW & FLOAT TENDER (Header + Floating Info) - WHITE CONTAINER */}
        ...
        {/* 2. GENERAL DETAILS - WHITE CONTAINER */}
        ...
        {/* 3. PACKAGE DETAILS - WHITE CONTAINER */}
        <div className="p-4 mt-5 bg-white rounded-3" style={{ border: '1px solid #e0e0e0', boxShadow: '0 2px 4px rgba(0,0,0,.05)' }}>
        ...
        {/* 4. CONTRACTOR DETAILS - WHITE CONTAINER */}
        <div className="p-4 mt-5 bg-white rounded-3" style={{ border: '1px solid #e0e0e0', boxShadow: '0 2px 4px rgba(0,0,0,.05)' }}>
            <div className="text-start ms-1 mb-3">
        ...
        {/* SUMMARY/FLOAT BAR (Kept Outside the standard cards, but still in the main p-4 wrapper) */}
