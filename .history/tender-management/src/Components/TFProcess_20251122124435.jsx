...
function TFProcess({ projectId }) {
    ...
    const [tenderDetail, setTenderDetail] = useState({
        ...
        contractorIds: '', offerSubmissionMode: null,
    offerSubmissionDate: null, // Critical: These date fields must be present
    bidOpeningDate: null,       // Critical: These date fields must be present
    contactPerson: null,
    contactMobile: null,
    contactEmail: null,
    scopeOfWork: null,
