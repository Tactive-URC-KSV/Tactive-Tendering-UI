                    ...
                    <div className="col-lg-3 col-md-4 position-relative"> {/* Reduced col-lg width from 4 to 3 for smaller width */}
                        ...
                        <div className="dropdown w-100">
                            ...
                            >
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-chevron-down ms-1" style={{ width: '18px', height: '18px', color: '' }}>
