...
// Place these definitions inside your current component function
...
const handleRemoveScope = (idToRemove) => {
    ...
    <Select
        ...
        className="w-100"
        classNamePrefix="select"
        // 🚨 HIDING LOGIC: Apply custom components 🚨
        components={{
    ...
    {/* 🛠️ EXTERNAL TAGS DISPLAY (BELOW THE BOX) 🛠️ */}
            ...
            .map(selectedOpt => (
                <span key={selectedOpt.value} className="select__multi-value">
                    ...
                    <span
                        ...
                        onClick={(e) => {
                            e.preventDefault();
                            handleRemoveScope(selectedOpt.value); // Use the new handler
                        }}
                    >
                        &times;
                    </span>
