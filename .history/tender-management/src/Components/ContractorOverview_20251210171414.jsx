...
const taxCityOptions = [];
 export const additionalInfoTypeOptions = [{ value: 'pan_no', label: 'PAN No' },
...
export const getDisplayLabel = (value, options) => {
    const foundOption = options.find(option => option.value === value);
    return foundOption ? foundOption.label : value; // Returns the label or the raw value if not found
};
