...
function ContractorOverview() {
  ...
  // Assuming FaCalendarAlt, FileText, UploadCloud, Select, bluePrimary, customSelectStyles are defined
...
const ManualEntryForm = () => (
    ...
    <div className="card text-start border-0 shadow-sm mt-4" style={{ borderRadius: "8px", padding: "0 1.5rem 1.5rem 1.5rem" }}>
        ...
        {/* Row 1: Entity Code | Entity Name (Correct) */}
        <div className="row">
            <div className="col-md-6 mt-3 mb-4">
        ...
        {/* Row 2: Effective Date | Entity Type (Select component FIX) */}
        <div className="row"> 
            <div className="col-md-6 mt-3 mb-4">
                ...
                <div className="input-group" style={{ borderRadius: '8px', border: '1px solid #dee2e6' }}>
                    ...
                    <span 
                        ...
                        style={{ height: "40px", borderRadius: '0 8px 8px 0', cursor: 'pointer' }} 
                    >
        ...
        {/* Row 3: Nature of business | Grade (Select component FIX) */}
        <div className="row">
            <div className="col-md-6 mt-3 mb-4">
                <label htmlFor="natureOfBusiness" className="projectform-select text-start d-block mb-1">Nature of business</label>
                <Select
            ...
            <div className="col-md-6 mt-3 mb-4">
                <label htmlFor="grade" className="projectform-select text-start d-block mb-1">Grade</label>
                <Select
                    name="grade"
