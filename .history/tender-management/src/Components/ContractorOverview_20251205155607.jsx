...
function ContractorOverview() {
    ...
    // I will add separate state for the Email Invite form fields here to capture the input values 
    // unique to the Email Invite view, as they are not present in your initial formData state.
    ...
    // Existing formData and handlers remain unchanged
    ...
    // Updated emailButtonStyle to correctly handle the border radius when inactive
    ...
    // --- NEW Email Invite Form Component (Matching Screenshot) ---
        ...
        <form onSubmit={handleSendInvitation} className="p-3">
            ...
            <div className="row mb-4">
                <div className="col-md-6 mb-3">
                    <label htmlFor="contractorEmailID" className="form-label text-secondary small">Contractor Email ID <span className="text-danger">*</span></label>
                    <input 
                        type="email" 
                ...
                <div className="col-md-6 mb-3">
                    <label htmlFor="contractorName" className="form-label text-secondary small">Contractor Name</label>
                    <input 
                        type="text" 
                        className="form-control" 
                        id="contractorName" 
    ...
    // --- Existing Manual Entry Form Components (Unchanged) ---
    ...
    return (
        <div className="container-fluid min-vh-100 p-0">
            ...
            <div className="px-4 text-start">
                ...
                {/* Only display submit/cancel buttons for manual view */}
                {selectedView === 'manual' && (
