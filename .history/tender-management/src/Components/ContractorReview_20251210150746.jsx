...
// Detail Item Component (kept as is)
...
// 🌟 CHANGE 1: Removed 'export' keyword here 
        ...
        <div className="container-fluid min-vh-100 p-0">
            ...
            <div className="px-4 text-start">
                ...
                <div className="bg-white p-4 mb-4 shadow-sm" style={{ borderRadius: "8px", border: '1px solid #e0e0e0' }}>
                    ...
                    {/* BANK ACCOUNTS SECTION (UNCHANGED) */}
                    <div className="pt-4 mt-4" style={{ borderTop: '1px solid #f0f0f0' }}>
                        <div className="row mt-3">
                            <div className="col-lg-4 col-md-12 col-sm-12 mb-4">
                                <h5 className="fw-bold mb-1" style={{ color: bluePrimary }}>
                    ...
                    {/* ⭐⭐⭐ ADDITIONAL INFO SECTION ADDED HERE ⭐⭐⭐ */}
                    <div className="pt-4 mt-4" style={{ borderTop: '1px solid #f0f0f0' }}>
                        <div className="row mt-3">
                            <div className="col-lg-4 col-md-12 col-sm-12 mb-4">
                                <h5 className="fw-bold mb-1" style={{ color: bluePrimary }}>
                            ...
                            <div className="col-lg-8 col-md-12 col-sm-12">
                                <div className="row">
                                    ...
                                    {/* Empty DetailItem for layout alignment */}
                                    <DetailItem label="" value="" /> 
                                </div>
                            </div>
                        </div>
...
// 🎯 CHANGE 2: Added the Default Export to match your desired import line in App.jsx
