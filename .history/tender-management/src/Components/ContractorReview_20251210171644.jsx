...
// ----------------------------------------------------------------------
// STEP 1: Import the helper function and the options list(s) from your form component
// IMPORTANT: Adjust the path './ContractorOverview.js' if your file structure is different
// ----------------------------------------------------------------------
import { 
    getDisplayLabel, // <-- The function to map value to label
    entityTypeOptions, 
...
function ContractorReview() {
    ...
    const {
        ...
        phoneNo,
        emailId,
        addressType, // Assuming this is also a select field that needs conversion
        address1,
        address2,
        country, // Assuming this is also a select field that needs conversion
        city, // Assuming this is also a select field that needs conversion
        zipCode,
        contactName,
        contactPosition,
        contactPhoneNo,
    ...
    // ----------------------------------------------------------------------
    // STEP 2: Use the getDisplayLabel function to convert stored values to labels
    // ----------------------------------------------------------------------
    const getLabel = (value, options) => getDisplayLabel(value, options);

    // Basic Information Conversions
    const displayEntityType = getLabel(entityType, entityTypeOptions);
    const displayNatureOfBusiness = getLabel(natureOfBusiness, natureOfBusinessOptions);
    
    // Address Details Conversions
    // You would define and import countryOptions, cityOptions, etc., if they are select fields
    // For this example, we will treat 'country' and 'city' as if they were simple text fields, 
    // but convert 'addressType' if you define its options and export them.
    const displayAddressType = addressType; // Replace with getLabel(addressType, addressTypeOptions) if needed
    
    // Tax Details Conversions
    const displayTaxType = getLabel(taxType, taxTypeOptions);
    const displayTerritoryType = getLabel(territoryType, territoryTypeOptions);
    const displayTerritory = getLabel(territory, territoryOptions);

    // Additional Info Conversion (The one you specifically asked about)
    const displayAdditionalInfoType = getLabel(additionalInfoType, additionalInfoTypeOptions);
    // ----------------------------------------------------------------------
                ...
                <div className="bg-white p-4 mb-4 shadow-sm" style={{ borderRadius: "8px", border: '1px solid #e0e0e0' }}>
                    ...
                    <div className="row mt-4">
                        ...
                        <div className="col-lg-8 col-md-12 col-sm-12">
                            ...
                            <div className="row mb-4">
                                <DetailItem label="Entity Type" value={displayEntityType} /> {/* FIXED */}
                                <DetailItem label="Nature of Business" value={displayNatureOfBusiness} /> {/* FIXED */}
                        ...
                        <div className="row mt-3">
                            ...
                            <div className="col-lg-8 col-md-12 col-sm-12">
                                <div className="row">
                                    ...
                                    <DetailItem label="Address Type" value={displayAddressType} /> {/* FIXED if addressType is a select field */}
                                </div>
                    ...
                    <div className="pt-4 mt-4" style={{ borderTop: '1px solid #f0f0f0' }}>
                        <div className="row mt-3">
                            ...
                            <div className="col-lg-8 col-md-12 col-sm-12">
                                <div className="row">
                                    <DetailItem label="Tax Type" value={displayTaxType} /> {/* FIXED */}
                                    <DetailItem label="Territory Type" value={displayTerritoryType} /> {/* FIXED */}
                                    <DetailItem label="Territory" value={displayTerritory} /> {/* FIXED */}
                                </div>
                    ...
                    <div className="pt-4 mt-4" style={{ borderTop: '1px solid #f0f0f0' }}>
                        <div className="row mt-3">
                            ...
                            <div className="col-lg-8 col-md-12 col-sm-12">
                                <div className="row">
                                    <DetailItem label="Type" value={displayAdditionalInfoType} /> {/* <-- THIS IS THE FIX FOR TIN_NO */}
