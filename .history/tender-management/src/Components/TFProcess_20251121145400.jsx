...
const attachmentDetails = () => {
    ...
    const handleRemoveFile = (fileKey, index) => {
        ...
        // Update the attachment state with the new files list
    ...
    return (
        <div className="p-4">
            ...
            {/* Outer container with solid semi-transparent blue border */}
            <div className="outer-container" style={{
                border: "2px solid #0051973D",  // Solid semi-transparent blue border around all 4 sections
                borderRadius: "10px", 
                padding: "15px", // Padding inside the outer container
            }}>
                <div className="row mt-4">
                    {attachmentTypes.map((item) => (
                        <div className="col-md-6 mb-4" key={item.key}>
                            {/* Inner container for upload and textarea */}
                            <div className="attachment-container p-4" style={{
                                border: "2px dashed #B0C4DE",  // Dashed border for the file upload box
                                borderRadius: "10px", 
                                backgroundColor: "transparent"  // No background color for the file upload box
                            }}>
                                {/* Upload Box */}
                                <label
                                    ...
                                    style={{
                                        ...
                                        backgroundColor: "transparent", // No background color for the upload box itself
                                    }}
                                ...
                                >
                                    ...
                                    {/* Updated "Click to upload" text color */}
                                    ...
                                    <ul className="mt-2" style={{ fontSize: "13px" }}>
                                        {attachments[item.key].files.map((file, index) => (
                                            <li key={index} className="d-flex align-items-center">
                                                📄 {file.name}
                                                {/* Remove button (FaTimes icon) */}
                                                <FaTimes
                                                    size={16}
                                                    color="#FF4F4F" // Red color for the close icon
                                                    style={{ cursor: "pointer", marginLeft: "8px" }}
                                                    onClick={() => handleRemoveFile(item.key, index)} // Remove the file on click
                                                />
                                            </li>
                                        ))}
                                    </ul>
                                ...
                                {/* Notes textarea with updated color */}
                                <textarea
