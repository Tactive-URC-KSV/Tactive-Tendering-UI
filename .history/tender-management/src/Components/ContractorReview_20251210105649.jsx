...
function ContractorReview() {
    ...
    const {
        ...
        natureOfBusiness,
        grade,
        // Mocking attachments array structure for display purposes:
        ...
        <div className="container-fluid min-vh-100 p-0">
            ...
            <div className="px-4 text-start">
                ...
                >
                    ...
                    {/* This row structures the "Basic Information" header and the data side-by-side */}
                    <div className="row mt-4 mb-5">
                        
                        {/* A. Basic Information Header Block (Aligns to the far left) */}
                    ...
                    {/* This is a simple div that spans the full width of the main container, 
                        correctly placing the header and file list starting from the left edge. */}
