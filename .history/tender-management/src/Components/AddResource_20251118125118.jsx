            ...
            >
                <FormSectionContainer title="Basic Information" icon={<span className="text-primary" style={{ fontSize: '1.2em' }}>•</span>}>
                    <div className="row g-3">
                        {/* LEFT COLUMN: Resource Type (Left Aligned) */}
                        ...
                        {/* RIGHT COLUMN: Nature (Aligned Right) */}
                        <div className="col-md-6">
                        ...
                        {/* LEFT COLUMN: Resource Name (Left Aligned) */}
                        <div className="col-md-6">
                        ...
                        {/* RIGHT COLUMN: Rate (Aligned Right) */}
                        <div className="col-md-6">
                ...
                <FormSectionContainer title="Quantity & Measurements" icon={<AlignLeft size={20} className="text-primary" />}>
                    <div className="row g-3">
                        ...
                        {/* RIGHT COLUMN: Quantity Type (Aligned Right) */}
                        <div className="col-md-6">
                        ...
                        {/* LEFT COLUMN: Coefficient (Left Aligned) */}
                        <div className="col-md-6">
                        ...
                        {/* RIGHT COLUMN: Calculated Quantity (Aligned Right) */}
                        <div className="col-md-6">
