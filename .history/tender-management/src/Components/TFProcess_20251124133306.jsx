 ...
 * @param {string | Date} startDate The Tender Floating Date.
 * @param {string | Date} endDate The Submission Last Date.
 * @returns {string} e.g., "10 days", "5 days", or "Expired".
 */
...
<div className="mt-5 mb-5">
    ...
    >
        ...
        <div className="d-flex flex-column" style={{ color: '#005197', fontSize: '14px' }}> 
          ...
          // ... (The rest of the component structure above this line remains the same)
...
<div className="d-flex">
    ...
    <div className="d-flex justify-content-between ps-4" style={{ width: '50%' }}>
        ...
        >
            {/* CALL A FUNCTION to calculate days difference */}
            {tenderDetail.floatingDate && tenderDetail.offerSubmissionDate ? 
                calculateDaysRemaining(tenderDetail.floatingDate, tenderDetail.offerSubmissionDate) : 
                'Not Set'
            }
        </span>
    </div>
