...
<div className="p-4 mt-5 bg-white rounded-3" style={{ border: '1px solid #e0e0e0', boxShadow: '0 2px 4px rgba(0,0,0,.05)' }}>
    ...
    <div className="table-responsive ms-1 me-1">
        ...
        {/* 🌟 ATTACHMENTS SECTION - RENDERING SEPARATE CARDS PER CATEGORY */}
<div className="mt-5">
    ...
    {Object.keys(attachments).map((key) => {
        ...
        return (
            // New separate white card for EACH attachment category
            <div 
                key={key} 
                className="p-4 mt-4 bg-white rounded-3" 
                style={{ border: '1px solid #e0e0e0', boxShadow: '0 2px 4px rgba(0,0,0,.05)' }}
            >
                <div className="d-flex justify-content-between align-items-start">
                    
                    {/* Left Column: Title, File Details, and Description */}
                    <div className="text-start me-4 flex-grow-1">
                        ...
                        {/* 2. File Type and Size (RED COLOR) */}
                        {fileInfo ? (
                        ...
                        {/* 3. Description/Notes (Muted color) */}
...
{/* 🛑 NOTE: The main "Attachments" header (Paperclip + Title) 
    is removed here because the title is now inside each card. 
    If you want the main header to stay, you'll need to re-add it outside this map 
    but inside its own wrapper. 
*/}
