...
function ContractorOverview() {
    ...
    const handleGoBack = () => {
        // Mock navigation logic (since 'useNavigate' isn't available outside a router)
        ...
        <form onSubmit={handleSubmit}>
            {/*
                *** MODIFIED FOR FULL WIDTH ***
                Used negative margins (-1.5rem) to counteract the parent card's 'p-4' padding.
                Adjusted border-radius to match the top corners of the card and square the bottom.
            */}
            <div
                className="p-3 mb-4 d-flex align-items-center" // Removed 'rounded' class
                style={{
                    backgroundColor: bluePrimary,
                    // Use negative margin to span the full width of the card's container (p-4 = 1.5rem)
                    marginLeft: '-1.5rem', 
                    marginRight: '-1.5rem',
                    // Match the parent card's top radius (8px) and square off the bottom
                    borderTopLeftRadius: '8px',
                    borderTopRightRadius: '8px',
                    borderBottomLeftRadius: '0',
                    borderBottomRightRadius: '0',
                    // Restore the visual padding inside the blue bar
                    paddingLeft: '1.5rem', 
                    paddingRight: '1.5rem',
                    alignItems: 'center', 
                }}
    ...
    return (
        <div className="container-fluid min-vh-100 p-0">
            ...
            <div className="px-4 text-start">
                ...
                {/* Content Card (This has p-4 padding) */}
