...
function ContractorOverview() {
    ...
    <Flatpickr
        ...
        // 🚨 Changed state field name to effectiveDate
        value={tenderDetail.effectiveDate} 
        onChange={([date]) => 
            // 🚨 Changed state field name to effectiveDate
            setTenderDetail({ ...tenderDetail, effectiveDate: date })
        }
        // You may need to define this ref if you want external access to the date picker
        // ref={datePickerRef} 
    />
</div>
                <div className="col-md-6 mb-3">
