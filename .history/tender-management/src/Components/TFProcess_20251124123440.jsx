...
<div
    ...
    style={{
        ...
        ...(!isLast && { marginBottom: "16px" })
    }}
>
    <div className="text-start me-4 flex-grow-1">

        {/* Title */}
        <span className="fw-semibold d-block mb-1" style={{ color: "#333" }}>
            {title}
        </span>
        ...
        {fileInfo ? (
            <small className="text-muted d-block">
                {getFriendlyFileType(fileInfo.type || fileInfo.extension)} • {formatFileSize(fileInfo.size)}
            </small>
        ) : (
            <small className="text-muted d-block">No file uploaded</small>
        )}
    ...
    {fileInfo && (
        <div
            ...
            style={{
                width: "38px",
                height: "38px",
                backgroundColor: "#E8F4FF",   // SAME COLOR AS FIGMA
                cursor: "pointer"
            }}
        >
