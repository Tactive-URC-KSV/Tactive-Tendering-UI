...
function AddResource() {
    ...
    const FormSectionContainer = ({ title, icon, defaultOpen = false, children }) => {
        // The image shows Basic Information and Quantity & Measurements as static/open
        const isStatic = ['Basic Information', 'Quantity & Measurements'].includes(title);
        
        // Use state for genuinely collapsible sections
        ...
        const contentStyle = { 
            backgroundColor: 'white', // <-- Added white background here
            padding: '1rem 1.5rem', 
        ...
        return (
            // Add mx-3 for the margin to match the blue header, and mb-4 for vertical spacing
            <div className="mx-3 mb-4">
                <div 
                    style={headerStyle} 
                    onClick={() => { if (!isStatic) setIsOpen(!isOpen); }} // Only allow click on non-static headers
                >
                    {HeaderContent}
                </div>
        ...
        <div className="container-fluid min-vh-100">
            ...
            <div 
                ...
                style={{ 
                    ...
                    borderRadius: '0.5rem', // Fully rounded corners for the standalone header
                    // Ensure full width usage for the header when margin is mx-3
                }} 
            >
                <div className="d-flex align-items-center">
            ...
            {/* --- Form Sections (NO OUTER CONTAINER) --- */}
            ...
            <div className="d-flex justify-content-end pt-3 me-3"> {/* Added me-3 to align button with containers */}
                <button 
                    className="btn" 
                    style={{ 
