...
function ContractorOverview() {
    ...
    // 1. ADDED THE OUTER CARD CONTAINER HERE
    <div className="card text-start border-0 shadow-sm mt-4" style={{ borderRadius: "8px", padding: "0 1.5rem 1.5rem 1.5rem" }}>
        ...
        {/* Row 1: Entity Code | Entity Name */}
        <div className="row"> {/* Removed mb-3, margins handled by columns */}
            <div className="col-md-6 mt-3 mb-4">
                <label className="projectform text-start d-block">
        ...
        {/* Row 2: Effective Date | Entity Type */}
        <div className="row"> {/* Removed mb-3, margins handled by columns */}
            <div className="col-md-6 mt-3 mb-4"> {/* ADDED mt-3 mb-4 for consistency */}
                ...
                <div className="input-group">
                    ...
                    {/* RESTORED Calendar Icon Span */}
                    <span className="input-group-text bg-white" style={{ borderLeft: "none", height: "40px" }}><i className="fa fa-calendar-alt text-muted" /></span>
                </div>
            </div>
            <div className="col-md-6 mt-3 mb-4"> {/* ADDED mt-3 mb-4 for consistency */}
        ...
        <div className="row"> {/* Removed mb-4, margins handled by columns */}
            <div className="col-md-6 mt-3 mb-4"> {/* ADDED mt-3 mb-4 for consistency */}
        ...
        {/* Attachment Section */}
        <div className="row mb-4">
            <div className="col-12 mt-3"> {/* Use col-12 for full width and mt-3 for spacing from above row */}
  ...
  const AddressDetailsContent = () => (
    <div className="card text-start border-0 shadow-sm mt-4" style={{ borderRadius: "8px", padding: "0 1.5rem 1.5rem 1.5rem" }}>
        ...
        <div className="row"> {/* Removed mb-3 here to control spacing via column margins */}
            <div className="col-md-6 mt-3 mb-4">
                <label className="projectform text-start d-block">
        ...
        <div className="row"> {/* Row 2: Address Type and Address 1 */}
        ...
        <div className="row"> {/* Row 3: Address 2 and Country */}
            <div className="col-md-6 mt-3 mb-4"> {/* Added mt-3 and mb-4 for consistency */}
                <label className="projectform text-start d-block">
        ...
        <div className="row"> {/* Row 4: City and Zip/Postal Code */}
            <div className="col-md-6 mt-3 mb-4"> {/* Added mt-3 and mb-4 for consistency */}
