...
const STORAGE_KEY = 'contractorFormData'; // Key used to clear the persistent data

const DetailItem = ({ label, value }) => {
    // Ensure the key for City matches the state key 'addresscity'
...
function ContractorReview() {
    ...
    // Assuming formData.addresscity is the key for the city field based on previous code
    const formData = location.state?.formData || {}; 

    const navigate = useNavigate();
    const handleGoBack = () => navigate(-1);
    
    // Updated function to handle submission, clear session data, and navigate
    const handleSubmitFinal = () => {
        console.log("Submitting final data to server:", formData);
        
        // 1. Clear session storage to ensure the form page is empty on return
        sessionStorage.removeItem(STORAGE_KEY);
        
        // 2. Navigate to the next page (e.g., Contractor Onboarding/Success Page)
    ...
    const {
        ...
        attachmentMetadata = [],
        phoneNo,
        emailID, // Corrected to match form key (Email ID)
        addressType,
        address1,
        address2,
        country,
        addresscity, // Corrected to use the form key 'addresscity'
        zipCode,
        contactName,
        contactPosition,
        contactPhoneNo,
        ...
        taxRegNo,
        taxRegDate,
        taxAddress1, // Included for review display
        taxAddress2, // Included for review display
        taxCity,     // Included for review display
        taxZipCode,  // Included for review display
        taxEmailID,  // Included for review display
        accountHolderName,
        accountNo,
        bankName,
        branchName,
                        ...
                        <div className="row mt-3">
                            ...
                            <div className="col-lg-8 col-md-12 col-sm-12">
                                ...
                                <div className="row mb-3">
                                    ...
                                    <DetailItem label="City" value={addresscity} /> {/* Using addresscity */}
