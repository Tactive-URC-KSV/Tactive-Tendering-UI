...
import { ArrowLeft, Pencil, Mail, UploadCloud, Calendar, FileText, Building, PhoneCall } from "lucide-react"; 
...
function ContractorOverview() {
    ...
    // UPDATED STATE: Includes all Basic, Address, and NEW Contact fields
    const [formData, setFormData] = useState({
        ...
        phoneNo: '', // Note: This phoneNo is for the primary entity/address.
        emailID: '', // Note: This emailID is for the primary entity/address.
        ...
        // --- CONTACT DETAILS FIELDS (NEW) ---
        contactName: '',
        contactPosition: '',
        contactPhoneNo: '', // Renamed to avoid collision with primary phoneNo
        contactEmailID: '' // Renamed to avoid collision with primary emailID
    });
    ...
    // --- Component 3: Contact Details Content (NEW Card Content) ---
    const ContactDetailsContent = () => (
        <div 
            className="card text-start border-0 shadow-sm mt-4" // mt-4 creates space below the previous card
            style={{
                borderRadius: "8px",
                padding: "0 1.5rem 1.5rem 1.5rem"  
            }}
        >
            {/* Contact Details Header (Matching screenshot style) */}
            <div
                className="p-3 mb-4 d-flex align-items-center justify-content-center"
                style={{
                    backgroundColor: bluePrimary,
            ...
            <div className="row mb-4">
                ...
                <div className="col-md-6 mb-3">
                    ...
                    <select
                        ...
                        onChange={handleChange}
                        placeholder="Select position" // Placeholder doesn't work well on select, but added for consistency
                        style={{ height: "40px" }}
                    >
            ...
            {/* Row 2: Phone No and Email ID (Matching screenshot layout) */}
            <div className="row mb-3">
                <div className="col-md-6 mb-3">
        ...
        <div className="container-fluid min-vh-100 p-0">
            ...
            <div className="px-4 text-start">
                ...
                <form id="contractorForm" onSubmit={handleSubmit}> 
                    ...
                    {/* --- THIRD CARD: CONTACT DETAILS (NEW) --- */}
