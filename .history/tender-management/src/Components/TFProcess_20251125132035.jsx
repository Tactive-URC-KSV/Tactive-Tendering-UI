        ...
        <div className="row align-items-center ms-1 mt-5">
            <div className="col-md-4 col-lg-4 ">
                ...
                <Select
                    ...
                    className="w-100"
                    classNamePrefix="select"
                    // Use your specific state variables here:
                    ...
                    // 🚨 Apply all custom components here to hide internal elements 🚨
                    components={{
                ...
                />
                {/* *** UPDATED BLOCK FOR VERTICAL DISPLAY ***
                  Removed: d-flex flex-wrap gap-2 from the div
                  Added: d-inline-block, mb-2, and me-2 to the span
                */}
                <div className="mt-2"> 
                    {scopeOptions 
                        .filter(opt => selectedScopes.includes(opt.value)) // Filter only selected options
                        .map(selectedOpt => (
                            <span 
                                key={selectedOpt.value} 
                                className="select__multi-value d-inline-block mb-2 me-2" // ADDED: d-inline-block and mb-2 for vertical stacking
                            >
                                <span className="select__multi-value__label">
                                    {selectedOpt.label}
                                </span>
                                {/* 🚨 This is the functional external 'X' button 🚨 */}
                                <span
                                    className="select__multi-value__remove"
                                    onClick={(e) => {
                                        e.preventDefault();
                                        handleRemoveScope(selectedOpt.value); // Calls the handler from Step 2
                                    }}
                                >
                                    &times;
                                </span>
