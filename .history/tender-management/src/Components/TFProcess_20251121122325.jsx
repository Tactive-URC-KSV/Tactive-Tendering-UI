...
import { ArrowLeft, ArrowRight, BoxesIcon, ChevronDown, ChevronRight, IndianRupee, Info, Paperclip, Plus, User2, X ,FaCloudUploadAlt} from 'lucide-react'; 
    ...
    return (
        <div className="p-2">
            <div className="text-start ms-1 mt-3 d-flex align-items-center">
                <FaCloudUploadAlt size={20} color="#2BA95A" />
                    ...
                    <div className="col-md-6 mb-4" key={item.key}>
                        ...
                        >
                            ...
                            <div className="d-flex justify-content-center mb-2">
                                ...
                                >
                                    <Paperclip size={24} color="#005197" />
                                </div>
                            </div>
