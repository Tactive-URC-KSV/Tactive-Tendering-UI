            ...
            <div className="px-4 text-start">
                ...
                {selectedView === 'manual' && (
                    <div className="d-flex justify-content-end mt-4">
                        ...
                        <button type="submit" form="contractorForm" className="btn px-4 fw-bold" style={{ backgroundColor: bluePrimary, color: "white",border:'null'}}>Review & Submit<ArrowRight size={21} color="white" className="ms-2" /></button>
                    </div>
                )}
            </div>
