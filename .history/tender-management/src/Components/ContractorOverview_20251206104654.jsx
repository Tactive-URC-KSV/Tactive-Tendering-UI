        ...
        <>
            ...
            <div className="row mb-4">
                <div className="col-md-6 mb-3">
                    ...
                    <select className="form-select" id="natureOfBusiness" name="natureOfBusiness" value={formData.natureOfBusiness} onChange={handleChange} style={{ height: "40px" }} placeholder="Select nature of business" classNamePrefix="select">
                        placeholder="Select nature of business" classNamePrefix="select"
                    </select>
                </div>
                <div className="col-md-6 mb-3">
