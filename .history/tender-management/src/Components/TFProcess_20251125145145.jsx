...
<div className="row align-items-center ms-1 mt-5">
    ...
    <div className="col-md-4 col-lg-4 ">
        ...
        />
        {/* NOTE: If you also want the selected tags (below) to be full width, 
            you may need to adjust the enclosing div and/or the classes on the tags. 
            I'm keeping the original separate tag display for reference.
        */}
...
{/* --- Separate the rows to force a new line --- */}
<div className="row align-items-center ms-1 mt-5">
    {/* 🎯 ROW 2: Scope of Work */}
    <div className="col-md-4 col-lg-4">
