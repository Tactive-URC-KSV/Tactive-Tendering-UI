...
const AttachmentRow = ({ title, files, notes }) => (
  ...
  const reviewTender = () => {
    ...
    <div className="p-4">
        ...
        {/* 1. General Details Container (NEW CARD) */}
        {/* The original <div className="pt-4"> wrapper has been replaced by this styled container */}
        ...
        {/* 2. Package Details Container (NEW CARD) */}
        {/* The original text-start div for the title and the table-responsive div are now wrapped in this container */}
        ...
        {/* 3. Contractor Details Container (NEW CARD) */}
        {/* The original text-start div for the title and the d-flex wrapper for contractors are now inside this container */}
        <div className="p-4 mt-5 bg-white rounded-3" style={{ border: '1px solid #e0e0e0', boxShadow: '0 2px 4px rgba(0,0,0,.05)' }}>
            <div className="text-start ms-1 mb-3">
        ...
        {/* 4. Attachments Container (NEW CARD) */}
        {/* The original text-start div for the title and the content div are now inside this container */}
        <div className="p-4 mt-5 bg-white rounded-3" style={{ border: '1px solid #e0e0e0', boxShadow: '0 2px 4px rgba(0,0,0,.05)' }}>
            <div className="text-start ms-1 mb-3">
                <Paperclip size={20} color="#005197" />
                <span className="ms-2 fw-bold" style={{ color: '#005197' }}>Attachments</span>
        ...
        {/* Summary Bar and Float Button (Unchanged) */}
