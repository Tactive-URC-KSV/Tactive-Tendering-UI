...
<div className="mt-5 mb-5">
    ...
    >
        ...
        {/* Box Header: Tender Summary (LEFT-ALIGNED/START) */}
        ...
        <div className="d-flex flex-column" style={{ color: '#005197', fontSize: '14px' }}> 
            ...
            <div className="d-flex mb-2"> 
                {/* Total Packages - LEFT COLUMN (FIX: Removed all padding around the border, using gap-4 for internal content separation) */}
                <div 
                ...
                {/* Selected Contractors - RIGHT COLUMN (FIX: Adjusted spacing) */}
            ...
            <div className="d-flex">
                {/* Attachments - LEFT COLUMN (FIX: Removed all padding around the border, using gap-4 for internal content separation) */}
                <div 
                    className="d-flex justify-content-between pe-2 me-4" 
                    style={{ 
                        width: '50%',
                ...
                {/* Submission Deadline - RIGHT COLUMN (FIX: Adjusted spacing) */}
                <div className="d-flex justify-content-between ps-4" style={{ width: '50%' }}>
