...
// Define the primary color used in headers (assuming it's available globally or defined here)
...
function ContractorReview() {
    ...
    // Function to handle the final submission (placeholder for API call)
