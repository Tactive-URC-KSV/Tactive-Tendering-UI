                ...
                <div className="row g-3">
                    ...
                    <div className="col-md-6">
                        <div style={{ width: '80%' }} className="ms-auto">
                            ...
                            <input type="number" className="form-control" style={{ borderRadius: '0.5rem' }} placeholder="0.00" className="form-input w-100"/>
                        </div>
                    </div>
                </div>
            ...
            <FormSectionContainer title="Quantity & Measurements" icon={<AlignLeft size={20} className="text-primary" />} defaultOpen={true}>
                <div className="row g-3">
                    ...
                    <div className="col-md-6">
                        ...
                        <div style={{ width: '80%' }}>
                            <input type="number" className="form-control" style={{ borderRadius: '0.5rem'className="form-input w-100" }} placeholder="0.00" className="form-input w-100" />
                        </div>
                    </div>
                    ...
                    <div className="col-md-6">
                        <div style={{ width: '80%' }} className="ms-auto">
                            ...
                            <input type="text" className="form-control" style={{ borderRadius: '0.5rem' }} placeholder="" readOnly className="form-input w-100"/>
                        </div>
                    </div>
                </div>
            </FormSectionContainer>
