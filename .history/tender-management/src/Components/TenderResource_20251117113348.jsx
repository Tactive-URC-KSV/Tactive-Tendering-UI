      ...
      <div className="bg-white rounded-3 ms-3 me-3 p-4" style={{ border: '1px solid #0051973D' }}>
        ...
        <div className="text-start d-flex justify-content-between align-items-center pb-3" style={{ borderBottom: '5px solid #0051973D' }}>
          ...
          <div className="d-flex align-items-center">
            <button className="btn action-button me-2" onClick={handleAddResource}><Plus size={20} /><span className="ms-2">Add Resource</span></button>

            <button className="btn action-button me-2" onClick={handleCopyResources}><Plus size={20} /><span className="ms-2">Add Resource</span></button>
