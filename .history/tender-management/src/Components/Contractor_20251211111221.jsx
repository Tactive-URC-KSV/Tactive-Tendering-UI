...
function Contractor() {
    ...
    // === MODIFIED: HELPER COMPONENT FOR EXACT VISUAL MATCH (Checkbox appearance with single-select logic) ===
    const CheckboxFilterItem = ({ category, label }) => {
        ...
        return (
            ...
            >
                <input
                    type="checkbox" // Restored to checkbox type for visual resemblance
                    checked={isSelected}
                    onChange={() => {}} // Controlled by the parent div onClick
                    style={{ 
                        cursor: 'pointer', 
                        marginRight: '8px', 
                        // Style checkbox indicator to match the image: blue border/check when selected, light/default border when not
                        accentColor: isSelected ? bluePrimary : '#ffffff', 
                        transform: 'scale(1.05)',
                        border: isSelected ? `1px solid ${bluePrimary}` : '1px solid #ced4da', // Darker border when not selected
                        borderRadius: '3px', // Square corners for checkbox look
                        backgroundColor: isSelected ? '#ffffff' : '#ffffff', // Ensure background is white inside the checkbox
                    }}
                />
                <span 
                    className="fw-normal"
        ...
        <div className="container-fluid min-vh-100">
            ...
            <div className="ms-3 me-3 bg-white rounded-3 mt-5 p-2" style={{ border: '1px solid #0051973D' }}>
                ...
                <div className="row g-3 ms-2 mt-2 mb-4 me-2 d-flex justify-content-between">
                    ...
                    {/* === MODIFIED: SORT BY FIELD WITH LIGHT BLUE BACKGROUND, NARROW WIDTH, AND PUSHED DOWN === */}
                        ...
                        <div className="dropdown w-100">
                            <button
                                ...
                                style={{
                                    ...
                                    paddingLeft: '12px',
                                    paddingRight: '12px',
                                    border: '1px solid #E9F5FF', // Ensure border matches background for clean look
                                }}
                            >
                                Sort by 
