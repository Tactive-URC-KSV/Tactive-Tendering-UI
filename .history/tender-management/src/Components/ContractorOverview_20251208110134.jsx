...
function ContractorOverview() {
   ...
   const EmailInviteForm = ({ handleSendInvitation, formData, setFormData, bluePrimary, Mail, Info }) => (
    <>
        <form id="email-invite-form" onSubmit={handleSendInvitation} className="p-3">
        ...
        <div className="d-flex justify-content-end p-3 border-top" style={{ marginTop: "20px" }}>
            <button
                type="submit"
