        ...
        return (
            <div className="p-2">
                ...
                <div className="row align-items-center justify-content-between ms-1 mt-4">
                    <div className="col-md-4 col-lg-4">
                        ...
                        <select
                            ...
                            onChange={(e) =>
                                setTenderDetail(prev => ({ ...prev, offerSubmissionMode: e.target.value }))
                            }
                        >
                    ...
                    <div className="col-md-4 col-lg-4">
                        ...
                        <div className="input-group">
                            ...
                            <span
                                ...
                                onClick={() => {
                                    const input = document.querySelector('#offerSubmissionDate');
                    ...
                    <div className="col-md-4 col-lg-4">
                        ...
                        <div className="input-group">
                            ...
                            <span
                                ...
                                style={{ cursor: 'pointer' }}
                                onClick={() => {
                                    const input = document.querySelector('#bidOpeningDate');
                                    if (input && input._flatpickr) input._flatpickr.open();
                                }}
                            >
                                <FaCalendarAlt />
                ...
                <div className="row align-items-center justify-content-between ms-1 mt-4">
                    ...
                    <div className="col-md-4 col-lg-4">
                        <label className="projectform text-start d-block">Contact Mobile</label>
                        <input
                            type="tel"
                            className="form-input w-100"
    ...
    return (
        <div className="tfprocess-container">
            ...
            <div className="tfprocess-content mt-4">
                {currentTab === 'general' && generalDetails()}
                {currentTab === 'package' && packageDetails()}
                {currentTab === 'contractor' && contractorDetails()}
                {currentTab === 'attachments' && attachmentDetails()}
                {currentTab === 'review' && reviewTender()}
            </div>
        </div>
    );
}
