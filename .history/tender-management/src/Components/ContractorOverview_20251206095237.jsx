            ...
            <div className="row mb-3">
                <div className="col-md-6 mb-3">
                    ...
                    <div className="input-group">
                        <input type="text" className="form-input w-100" id="effectiveDate" name="effectiveDate" value={formData.effectiveDate} onChange={handleChange} placeholder="mm/dd/yy" style={{ height: "40px" }} />
