        ...
        <div className="container-fluid min-vh-100">
            ...
            >
                <FormSectionContainer title="Basic Information" icon={<span className="text-primary" style={{ fontSize: '1.2em' }}>•</span>}>
                    <div className="row g-3">
                        <div className="col-md-6">
                            <label className="form-label text-start w-100">Resource Type <span style={{ color: "red" }}>*</span>
</label>
                        ...
                        <div className="col-md-6">
                            <label className="form-label text-start w-100">Nature</label>
                            <div style={{ width: '80%' }}>
                                <Select 
                                    options={emptyOption} 
                                    styles={customStyles} 
                        ...
                        <div className="col-md-6">
                            <label className="form-label text-start w-100">Resource Name</label>
                            <div style={{ width: '80%' }}>
                                <Select 
                                    options={emptyOption} 
                                    styles={customStyles} 
                        ...
                        <div className="col-md-6">
                            <label className="form-label text-start w-100">Rate</label>
                            <input 
                                type="number" 
                ...
                <FormSectionContainer title="Quantity & Measurements" icon={<AlignLeft size={20} className="text-primary" />}>
                    <div className="row g-3">
                        <div className="col-md-6">
                            <label className="form-label text-start w-100">UOM</label>
                            <div style={{ width: '80%' }}>
                                <Select 
                                    options={emptyOption} 
                                    styles={customStyles} 
                        ...
                        <div className="col-md-6">
                            <label className="form-label text-start w-100">Quantity Type</label>
                            <div style={{ width: '80%' }}>
                                <Select 
                                    options={emptyOption} 
                                    styles={customStyles} 
                        ...
                        <div className="col-md-6">
                            <label className="form-label text-start w-100">Coefficient</label>
                            <input 
                                type="number" 
                                className="form-control" 
                                style={{ borderRadius: '0.5rem', width: '80%' }} 
