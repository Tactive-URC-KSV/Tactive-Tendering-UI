...
function AddResource() {
    ...
    const FormSectionContainer = ({ title, icon, defaultOpen = false, children }) => {
        // Determine if the section should be permanently open (static)
        ...
        // Note: For static sections, the content area border should blend into the header border
        const contentStyle = { 
            padding: '1rem 1.5rem', 
            ...
            >
                ...
                <FormSectionContainer title="Basic Information" icon={<span className="text-primary" style={{ fontSize: '1.2em' }}>•</span>}>
                    ...
                    <div className="row g-3">
                        <div className="col-md-6"><label className="form-label">Resource Type</label><select className="form-select" style={{ borderRadius: '0.5rem' }}><option>Labor</option></select></div>
                        <div className="col-md-6"><label className="form-label">Nature</label><select className="form-select" style={{ borderRadius: '0.5rem' }}><option>Simple</option></select></div>
                        <div className="col-md-6"><label className="form-label">Resource Name</label><select className="form-select" style={{ borderRadius: '0.5rem' }}><option>Select resource</option></select></div>
                ...
                <FormSectionContainer title="Quantity & Measurements" icon={<AlignLeft size={20} className="text-primary" />}>
                    {/* Placeholder for actual form fields */}
                    <div className="row g-3">
                        <div className="col-md-6"><label className="form-label">UOM</label><select className="form-select" style={{ borderRadius: '0.5rem' }}><option>kg</option></select></div>
                        <div className="col-md-6"><label className="form-label">Quantity Type</label><select className="form-select" style={{ borderRadius: '0.5rem' }}><option>Coefficient</option></select></div>
                ...
                <FormSectionContainer title="Cost Summary" icon={<Calculator size={20} className="text-primary" />}>
                    {/* Cost Summary content structure */}
