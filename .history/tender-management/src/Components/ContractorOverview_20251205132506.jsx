...
function ContractorOverview() {
    ...
    <form onSubmit={handleSubmit}>
        ...
        {/* Basic Information Section Header - FULL WIDTH, NO GAP */}
        <div 
           className="w-100 p-3 mb-4 d-flex align-items-center justify-content-center"
        ...
        <div className="d-flex justify-content-end pt-4 mt-5">
            <button type="button" className="btn btn-outline-secondary me-3 px-4 fw-bold" onClick={handleCancel} style={{ borderRadius: "6px" }}>
                Cancel
            </button>

            <button type="submit" className="btn px-4 fw-bold" style={{ backgroundColor: bluePrimary, color: "white", borderRadius: "6px", borderColor: bluePrimary }}>
                Submit
            </button>
        </div>
    </form>
    ...
    return (
        <div className="container-fluid min-vh-100 p-0">
            ...
            <div 
    className="d-flex align-items-center py-3 px-4 mb-4 mx-auto"
    style={{ maxWidth: '1200px' }} // Set the maximum desired width (e.g., 1200px)
>
                <ArrowLeft
                    size={24}
                    className="me-3"
 ...
 <div className="px-4 text-start">
                ...
                <div 
    className="px-4 text-start mx-auto" 
    style={{ maxWidth: '1200px' }} // Match the header width
>
                    <button
                ...
                {/* Content Card */}
                {/* Applied a small shadow and rounded corners to the main card */}
