...
function Contractor() {
    ...
    // === FINAL AND CORRECTED HELPER COMPONENT: CUSTOM CHECKBOX STYLING ===
    const CheckboxFilterItem = ({ category, label }) => {
        ...
        return (
            ...
            >
                {/* Custom Checkbox Indicator (Guaranteed Blue Colors) */}
                <span
                    style={{
                        height: '18px',
                        width: '18px',
                        border: `1px solid ${bluePrimary}`, // Guaranteed blue border
                        borderRadius: '3px',
                        marginRight: '8px',
                        display: 'flex',
                        alignItems: 'center',
