...
/**
 * Custom Upload Component (Used in Manual Entry)
 */
...
/**
 * Email Invite Form (Corrected, matches UI/Figma)
 */
...
/**
 * Address Details Content (Full implementation provided for completeness)
 */
    ...
    <div className="card text-start border-0 shadow-sm mt-4" style={{ borderRadius: "8px", padding: "0 1.5rem 1.5rem 1.5rem" }}>
        ...
        <div className="row"> 
            <div className="col-md-6 mt-3 mb-4">
                ...
                <input type="text" className="form-input w-100" placeholder="Enter Phone No" name="phoneNo" value={formData.phoneNo} onChange={handleChange} />
            </div>
            <div className="col-md-6 mt-3 mb-4">
                <label className="projectform text-start d-block">Email ID</label>
                <input type="text" className="form-input w-100" placeholder="Enter Email ID" name="emailID" value={formData.emailID} onChange={handleChange} />
            </div>
        </div>
        ...
        <div className="row"> 
            ...
            <div className="col-md-6 mt-3 mb-4">
                ...
                <input type="text" className="form-input w-100" placeholder="Enter Address 1" name="address1" value={formData.address1} onChange={handleChange} /> 
            </div> 
        </div>
        ...
        <div className="row"> 
            <div className="col-md-6 mt-3 mb-4"> 
                ...
                <input type="text" className="form-input w-100" placeholder="Enter Address 2" name="address2" value={formData.address2} onChange={handleChange} /> 
            </div> 
            <div className="col-md-6 mt-3 mb-4"> 
        ...
        <div className="row">
            ...
            <div className="col-md-6 mt-3 mb-4"> 
                ...
                <input type="text" className="form-input w-100" placeholder="Enter Zip/Postal Code" name="zipCode" value={formData.zipCode} onChange={handleChange} />
            </div>
        </div>
    </div>
);
...
/**
 * Contact Details Content (Full implementation provided for completeness)
 */
    ...
    <div className="card text-start border-0 shadow-sm mt-4" style={{ borderRadius: "8px", padding: "0 1.5rem 1.5rem 1.5rem" }}>
        ...
        <div className="row"> 
            <div className="col-md-6 mt-3 mb-4">
                ...
                <input type="text" className="form-input w-100" placeholder="Enter contact name" name="contactName" value={formData.contactName} onChange={handleChange} />
            </div>
            <div className="col-md-6 mt-3 mb-4"> 
        ...
        <div className="row mb-3">
            <div className="col-md-6 mt-3 mb-4">
                <label className="projectform text-start d-block">Phone No</label>
                <input type="text" className="form-input w-100" placeholder="Enter Phone No" name="contactPhoneNo" value={formData.contactPhoneNo} onChange={handleChange} />
            </div>
            <div className="col-md-6 mt-3 mb-4">
                <label className="projectform text-start d-block">Email ID</label>
                <input type="text" className="form-input w-100" placeholder="Enter Email ID" name="contactEmailID" value={formData.contactEmailID} onChange={handleChange} />
            </div>  
        </div>
    </div>
);
...
/**
 * Tax Details Content (Full implementation provided for completeness)
 */
    ...
    <div className="card text-start border-0 shadow-sm mt-4" style={{ borderRadius: "8px", padding: "0 1.5rem 1.5rem 1.5rem" }}>
        ...
        <div className="row"> 
            ...
            <div className="col-md-6 mt-3 mb-4">
                ...
                <input type="text" className="form-input w-100" placeholder="Enter tax registration no" name="taxRegNo" value={formData.taxRegNo} onChange={handleChange} />
            </div> 
        </div>
        <div className="row"> 
            <div className="col-md-6 mt-3 mb-4"> 
            ...
            <div className="col-md-6 mt-3 mb-4">
                ...
                <input type="text" className="form-input w-100" placeholder="Enter Address 1" name="taxAddress1" value={formData.taxAddress1} onChange={handleChange} />  
            </div> 
        </div>
        <div className="row"> 
            <div className="col-md-6 mt-3 mb-4">
                <label className="projectform text-start d-block">Address 2</label>
                <input type="text" className="form-input w-100" placeholder="Enter Address 2" name="taxAddress2" value={formData.taxAddress2} onChange={handleChange} /> 
            </div> 
            <div className="col-md-6 mt-3 mb-4">
        ...
        <div className="row mb-4"> 
            <div className="col-md-6 mt-3 mb-4">
                <label className="projectform text-start d-block">Zip/Postal Code</label>
                <input type="text" className="form-input w-100" placeholder="Enter Zip/Postal Code" name="taxZipCode" value={formData.taxZipCode} onChange={handleChange} />
            </div> 
            <div className="col-md-6 mt-3 mb-4">
                <label className="projectform text-start d-block">Email ID</label>
                <input type="text" className="form-input w-100" placeholder="Enter Email ID" name="taxEmailID" value={formData.taxEmailID} onChange={handleChange} />   
            </div>
        </div>
    </div>
);
...
/**
 * Bank Accounts Content (Full implementation provided for completeness)
 */
    ...
    <div className="card text-start border-0 shadow-sm mt-4" style={{ borderRadius: "8px", padding: "0 1.5rem 1.5rem 1.5rem" }}>
        ...
        <div className="row"> 
            <div className="col-md-6 mt-3 mb-4">
                ...
                <input type="text" className="form-input w-100" placeholder="Enter Account Holder Name" name="accountHolderName" value={formData.accountHolderName} onChange={handleChange} /> 
            </div> 
            <div className="col-md-6 mt-3 mb-4">
                <label className="projectform text-start d-block">Account No <span style={{ color: 'red' }}>*</span></label>
                <input type="text" className="form-input w-100" placeholder="Enter Account No" name="accountNo" value={formData.accountNo} onChange={handleChange} />  
            </div> 
        </div>
        ...
        <div className="row"> 
            <div className="col-md-6 mt-3 mb-4">
                ...
                <input type="text" className="form-input w-100" placeholder="Enter Bank Name" name="bankName" value={formData.bankName} onChange={handleChange} />  
            </div> 
    
            <div className="col-md-6 mt-3 mb-4">
                <label className="projectform text-start d-block">Branch Name <span style={{ color: 'red' }}>*</span></label>
                <input type="text" className="form-input w-100" placeholder="Enter Branch Name" name="branchName" value={formData.branchName} onChange={handleChange} />  
            </div> 
        </div>
        <div className="row mb-4">
            <div className="col-md-6 mt-3 mb-4">
                <label className="projectform text-start d-block">Bank Address</label>
                <input type="text" className="form-input w-100" placeholder="Enter Bank Address" name="bankAddress" value={formData.bankAddress} onChange={handleChange} /> 
            </div> 
...
/**
 * Additional Info Content (Full implementation provided for completeness)
 */
    ...
    <div className="card text-start border-0 shadow-sm mt-4" style={{ borderRadius: "8px", padding: "0 1.5rem 1.5rem 1.5rem" }}>
        ...
        <div className="row"> 
            ...
            <div className="col-md-6 mt-3 mb-4">
                ...
                <input type="text" className="form-input w-100" placeholder="Enter Registration No" name="registrationNo" value={formData.registrationNo} onChange={handleChange} />  
            </div> 
        </div>
    </div>
);
        ...
        <div className="container-fluid min-vh-100 p-0">
            ...
            <div className="px-4 text-start">
                ...
                <form id="contractorForm" onSubmit={handleSubmit}>
                    ...
                    {/* Main Content Card (Basic Info or Email Invite) */}
                    ...
                    {/* Manual Entry submit/cancel buttons */}
                    {selectedView === 'manual' && (
                        <div className="d-flex justify-content-end mt-4">
