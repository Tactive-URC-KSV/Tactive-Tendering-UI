...
function TFProcess({ projectId }) {
    ...
    const handleFileChange = (event) => {
        ...
        event.target.value = null; // Important: Resets input so same file can be selected after deletion
    };
        ...
        <div className="col-md-6 mb-4">
            <div className="border rounded p-3" style={{ border: '2px dashed #ced4da', minHeight: '220px' }}>
                <div className="text-center">
                    ...
                    {/* Textarea for notes (ADDED value and onChange) */}
                    <textarea
...
const attachmentDetails = ({ handlePrevious, setCurrentTab }) => { 
    ...
    return (
        <div className="p-2">
            ...
            {/* Upload Boxes Container (ADDED STATE PROPS) */}
