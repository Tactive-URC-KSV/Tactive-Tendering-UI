        ...
        <div className="card text-start border-0 shadow-sm mt-4" style={{ borderRadius: "8px", padding: "0 1.5rem 1.5rem 1.5rem" }}>
            ...
            <div className="row mb-3">
                ...
                <div className="col-md-6 mb-3">
                    ...
                    <input type="text" className="form-input w-100l" id="accountNo" name="accountNo" value={formData.accountNo} onChange={handleChange} placeholder="Enter account no" style={{ height: "40px" }} />
                </div>
            </div>
            <div className="row mb-3">
                <div className="col-md-6 mb-3">
                ...
                <div className="col-md-6 mb-3">
                    ...
                    <input type="text" className="" id="branchName" name="branchName" value={formData.branchName} onChange={handleChange} placeholder="Enter branch name" style={{ height: "40px" }} />
                </div>
            </div>
            <div className="row mb-4">
