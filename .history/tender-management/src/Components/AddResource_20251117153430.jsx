...
style={{ maxWidth: '98%', background: 'linear-gradient(to right, #005197, #007BFF)' }} /* Ensuring a consistent blue color if bg-primary isn't exact */
 >
...
<div className="d-flex justify-content-end mx-3 mt-4"><button className="btn btn-primary">Add Resource</button>
</div>
