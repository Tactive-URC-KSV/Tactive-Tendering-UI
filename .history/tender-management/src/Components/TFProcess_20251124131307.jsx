...
<div className="mt-5 mb-5">
    ...
    {/* 1. TENDER SUMMARY BOX (Exact Color, Two-Row Grid, and Vertical Divider) */}
    <div 
    ...
    >
        ...
        <div className="d-flex flex-column" style={{ color: '#005197', fontSize: '14px' }}> 
            ...
            <div className="d-flex mb-2"> 
                {/* Total Packages - LEFT COLUMN (Needs Vertical Separator) */}
                <div 
                    className="d-flex justify-content-between pe-4" 
                    style={{ 
                        width: '50%', 
                        borderRight: '1px solid #D2E3F4' // 🌟 VERTICAL DIVIDER 🌟
                    }}
                > 
            ...
            <div className="d-flex">
                {/* Attachments - LEFT COLUMN (Needs Vertical Separator) */}
                <div 
                    className="d-flex justify-content-between pe-4" 
                    style={{ 
                        width: '50%',
                ...
                {/* Submission Deadline - RIGHT COLUMN */}
                <div className="d-flex justify-content-between ps-4" style={{ width: '50%' }}>
                    <span>Submission Deadline:</span> 
                    <span 
                        style={{ 
                            // Red color (#dc3545) for the deadline 
                            color: '#dc3545' 
                        }}
                    >
