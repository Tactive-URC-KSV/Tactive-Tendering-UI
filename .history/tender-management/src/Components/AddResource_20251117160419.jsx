...
navigate(-1); 
 ...
 const containerBgColor = '#EFF6FF'; // Very light gray/blue for container background
...
<div 
 ...
 <button  className="btn"  style={{  backgroundColor: darkBlue, color: 'white',border: 'none', padding: '0.5rem 1.5rem', borderRadius: '0.5rem'  }}
 > Add Resource
  </button>
 </div>
</div>
