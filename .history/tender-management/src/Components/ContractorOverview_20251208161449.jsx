...
import { ArrowLeft, Pencil,FaCalendarAlt, Mail, UploadCloud, FileText, Building, PhoneCall, Receipt, Landmark, Info } from "lucide-react"; 
...
const handleEffectiveDateChange = (date) => {
        setFormData({ ...formData,taxRegDate: date });
    };
  ...
  <>
   ...
   <div className="row mb-4">
    <div className="col-12 mt-3">
        <h4 className="fs-6 fw-bold mb-3" style={{ color: '#005197' }}>Attachment (Certificates/Licenses)</h4>
        ...
        >
            ...
            <label htmlFor="fileUpload" className="d-block cursor-pointer">
                ...
                <p className="mb-0 small" style={{ color: '#005197' }}>PDF, DOCX up to 10MB</p>
            </label>
        </div>
    </div>
</div>
        ...
        <div className="row"> 
             <div className="col-md-6 mt-3 mb-4">
                        ...
                        <Flatpickr
                            ...
                            onChange={([date]) => handleformData.taxRegDateChange(date)}
                            ref={datePickerRef}
                        />
                        <span className='calender-icon' onClick={() => openCalendar('formData.taxRegDateDate')}><FaCalendarAlt size={18} color='#005197' /></span>
                    </div>
            <div className="col-md-6 mt-3 mb-4">
                <label className="projectform text-start d-block">
                    Address 1 
