...
function AddResource() {
    ...
    // Using '#f8f9fa' which is closer to the subtle light grey of the screenshot boxes
            ...
            >
                ...
                <FormSectionContainer title="Basic Information" icon={<span className="text-primary" style={{ fontSize: '1.2em' }}>•</span>}>
                    <div className="row g-3">
                        {/* Resource Type - React Select (Width Reduced) */}
                        <div className="col-md-6">
                            <label className="form-label">Resource Type</label>
                            <div style={{ width: '80%' }}> {/* Wrapper for Select */}
                                <Select 
                        ...
                        {/* Nature - React Select (Width Reduced) */}
                        <div className="col-md-6">
                        ...
                        {/* Resource Name - React Select (Width Reduced) */}
                        <div className="col-md-6">
                        ...
                        {/* Rate - Standard Input (Width Reduced) */}
                        <div className="col-md-6">
                            <label className="form-label">Rate</label>
                            <input 
                                type="number" 
                                className="form-control" 
                                style={{ borderRadius: '0.5rem', width: '80%' }} /* Width applied here */
                                placeholder="0.00" 
                            />
                        </div>
                    </div>
                ...
                <FormSectionContainer title="Quantity & Measurements" icon={<AlignLeft size={20} className="text-primary" />}>
                    <div className="row g-3">
                        {/* UOM - React Select (Width Reduced) */}
                        <div className="col-md-6">
                        ...
                        {/* Quantity Type - React Select (Width Reduced) */}
                        <div className="col-md-6">
                        ...
                        {/* Coefficient - Standard Input (Width Reduced) */}
                        <div className="col-md-6">
                        ...
                        {/* Calculated Quantity - Standard Input (Width Reduced) */}
                        <div className="col-md-6">
