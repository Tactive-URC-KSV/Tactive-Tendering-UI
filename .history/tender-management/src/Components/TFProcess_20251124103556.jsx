...
const AttachmentRow = ({ title, files, notes }) => (
  ...
  const reviewTender = () => {
       ...
       // --- UTILITY FUNCTIONS REQUIRED FOR reviewTender (Add these above reviewTender) ---

// Utility to format the date for the General Details/Footer Summary (e.g., 12/3/2025)
...
// --- REVIEW TENDER FUNCTION (Fully Updated with Box Styles) ---

const reviewTender = () => {
    // Note: Placeholder declarations for data used in reviewTender
    // You should use your actual state/props here.
    ...
    // Placeholder for helper functions that must be available in the scope
    const getDisplayMode = (mode) => mode || 'N/A'; // Replace with actual logic
    const boqNameDisplay = (name) => name || 'N/A'; // Replace with actual logic
    const getAttachmentTitle = (key) => key || 'N/A'; // Replace with actual logic
    
    // Placeholder for AttachmentRow component
    const AttachmentRow = ({ title, files, notes }) => (
        <div className="d-flex justify-content-between p-2 my-1" style={{ borderBottom: '1px solid #eee' }}>
            <span className="fw-medium text-dark">{title}</span>
            <span className="text-muted" style={{ fontSize: '13px' }}>{files.length} Files, {notes ? 'Notes Added' : 'No Notes'}</span>
        </div>
    );
    ...
    return (
        <div className="p-4">
            ...
            {/* Tender Floating No and Floating Date */}
            ...
            <div className="pt-4">
                ...
                {/* 1. General Details Section (White Bordered Box) */}
                    ...
                    <div className="row g-4 ms-1">
                        ...
                        <div className="col-md-4 text-start">
                            ...
                            <span className="fw-medium">{tenderDetail.bidOpeningDate 
                                ? formatScreenshotDate(tenderDetail.bidOpeningDate): 'N/A'} </span>
                        </div>
                ...
                {/* 2. Package Details Section (White Bordered Box) */}
                <div className="p-4 mb-4" style={{ border: '1px solid #e0e0e0', borderRadius: '8px', backgroundColor: 'white' }}>
                ...
                {/* 3. Contractor Details Section (White Bordered Box) */}
                <div className="p-4 mb-4" style={{ border: '1px solid #e0e0e0', borderRadius: '8px', backgroundColor: 'white' }}>
                    <div className="text-start ms-1 mt-5 mb-3">
                ...
                {/* 4. Attachments Section (White Bordered Box) */}
                <div className="p-4 mb-4" style={{ border: '1px solid #e0e0e0', borderRadius: '8px', backgroundColor: 'white' }}>
                    <div className="text-start ms-1 mt-5 mb-3">
                        <Paperclip size={20} color="#005197" />
                        <span className="ms-2 fw-bold" style={{ color: '#005197' }}>Attachments</span>
...
// --- END OF reviewTender FUNCTION ---

// You should place the `reviewTender` function and the two format functions above your main `TFProcess` component definition.
