...
function AddResource() {
    ...
    const FormSectionContainer = ({ title, icon, defaultOpen = false, children, controlledOpen, onToggle }) => {
    ...
    const [localOpen, setLocalOpen] = useState(isStatic || defaultOpen);

    // if parent passed a boolean controlledOpen, use that; otherwise use localOpen
    const isOpen = typeof controlledOpen === 'boolean' ? controlledOpen : localOpen;
    ...
    // click handler: if parent provided onToggle use it; otherwise toggle local
    ...
    return (
        <div className="mx-3 mb-4">
            <div style={headerStyle} onClick={handleHeaderClick}>{HeaderContent}</div>
