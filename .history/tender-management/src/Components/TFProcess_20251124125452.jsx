...
<div className="p-4 mt-5 bg-white rounded-3" style={{ border: '1px solid #e0e0e0', boxShadow: '0 2px 4px rgba(0,0,0,.05)' }}>
    ...
    style={{ 
        backgroundColor: '#005197', // Solid Blue Background
...
>
    ...
    <div className="d-flex flex-column" style={{ color: '#FFFFFF' }}> 
        
        {/* Row 1: Total Packages and Selected Contractors */}
        <div className="d-flex gap-5 mb-2"> 
            {/* Total Packages */}
            <div style={{ fontSize: '14px', width: '200px' }}> 
                Total Packages: <span className="fw-bold" style={{ color: '#FFFFFF' }}>{boqArray.length > 0 ? 1 : 0}</span> {/* Changed to White */}
            </div> 

            {/* Selected Contractors */}
            <div style={{ fontSize: '14px', width: '200px' }}>
                Selected Contractors: <span className="fw-bold" style={{ color: '#FFFFFF' }}>{contractorsList.length}</span> {/* Changed to White */}
            </div>
        </div>
        ...
        <div className="d-flex gap-5">
            {/* Attachments */}
            <div style={{ fontSize: '14px', width: '200px' }}>
                Attachments: <span className="fw-bold" style={{ color: '#FFFFFF' }}>{Object.keys(attachments).filter(key => attachments[key].files?.length > 0 || attachments[key].notes).length}</span> {/* Changed to White */}
            </div>

            {/* Submission Deadline */}
            <div style={{ fontSize: '14px', width: '200px' }}>
                Submission Deadline: 
                {/* If date is set (10 days), use Bright Red/Orange (#FF5733)
                    If date is 'Not Set', use standard Red (#dc3545) 
                */}
                <span className="fw-bold" 
                    style={{ 
                        color: tenderDetail.offerSubmissionDate ? '#FF5733' : '#dc3545' 
                    }}
                >
