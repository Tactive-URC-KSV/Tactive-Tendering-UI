...
function TFProcess({ projectId }) {
    ...
    offerSubmissionMode: null, // Use null for clarity
...
// Add these to your component's state definitions
const [project, setProject] = useState({ projectName: '', projectCode: '' }); 
const [parentTree, setParentTree] = useState([]); // Or whatever the correct initial structure is
