                ...
                <div className="pt-4">
                    ...
                    <div className="row g-4 ms-1">
                        ...
                        <div className="col-md-4 text-start">
                            ...
                            <span className="fw-medium">{getDisplayMode(tenderDetail.bidOpeningDate || 'N/A'}</span>
                        </div>
                        <div className="col-md-4 text-start">
                            <span className="text-muted d-block">Contact Person</span>
                            <span className="fw-medium">{tenderDetail.contactPerson }</span>
                        </div>
                        <div className="col-md-4 text-start">
                            <span className="text-muted d-block">Contact Number</span>
                            <span className="fw-medium">{tenderDetail.contactMobile }</span>
                        </div>
                        <div className="col-md-4 text-start">
                            <span className="text-muted d-block">Contact Email ID</span>
                            <span className="fw-medium">{tenderDetail.contactEmail }</span>
                        </div>
                        <div className="col-md-8 text-start">
                            <span className="text-muted d-block">Scope of Work</span>
                            <span className="fw-medium">{getDisplayMode(tenderDetail.scopeOfWork)}</span>
                        </div>
