    ...
    return (
        <div className='container-fluid min-vh-100'>
            ...
            <div className={`d-flex justify-content-${currentTab === 'boq' ? 'end' : 'between'} align-items-center mt-5 me-3 ms-3 mb-4`}>
                ...
                <button className="btn action-button" disabled={selectedBoq.size === 0} onClick={handleNextTabChange}><span className="fw-bold me-2">Confirm & Proce</span><ArrowRight size={18} /></button>
            </div>
        </div>
