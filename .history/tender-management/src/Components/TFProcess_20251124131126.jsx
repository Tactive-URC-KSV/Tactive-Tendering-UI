...
<div className="mt-5 mb-5">
    ...
    {/* 1. TENDER SUMMARY BOX (Matches Screenshot 2025-11-24 125613.png) */}
    <div 
        className="p-4 d-flex flex-column rounded-3" 
        style={{ 
            // Color matching the final light blue box
            backgroundColor: '#F7F8FC', 
            border: '1px solid #D2E3F4', 
        }}
    >
        
        {/* Box Header: Tender Summary (No Icon) */}
        ...
        <div className="d-flex flex-column" style={{ color: '#005197', fontSize: '14px' }}> 
            ...
            <div className="d-flex mb-2"> 
                {/* Total Packages - Uses 50% width and spacing to push value right */}
                <div className="d-flex justify-content-between" style={{ width: '50%' }}> 
                    <span>Total Packages:</span> <span style={{ color: '#005197' }}>{boqArray.length > 0 ? 1 : 0}</span> 
                </div> 

                {/* Selected Contractors - Uses 50% width and spacing to push value right */}
                <div className="d-flex justify-content-between" style={{ width: '50%' }}>
            ...
            <div className="d-flex">
                {/* Attachments - Uses 50% width and spacing to push value right */}
                <div className="d-flex justify-content-between" style={{ width: '50%' }}>
                ...
                {/* Submission Deadline - Uses 50% width and spacing to push value right */}
                <div className="d-flex justify-content-between" style={{ width: '50%' }}>
