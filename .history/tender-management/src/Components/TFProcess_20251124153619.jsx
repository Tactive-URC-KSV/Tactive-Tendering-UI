...
const getDaysFromToday = (endDate) => {
...
const getFriendlyFileType = (mimeType) => {
  ...
  const reviewTender = () => {
        ...
        console.log("Submission Date =", tenderDetail.offerSubmissionDate);
    console.log("Floating Date =", tenderDetail.floatingDate);
    console.log("Full Tender Detail =", tenderDetail);
...
<div className="mt-5 mb-5">
    ...
    <span style={{ color: '#dc3545' }}>
        {tenderDetail.offerSubmissionDate 
            ? `${getDaysFromToday(tenderDetail.offerSubmissionDate)} days`
            : 'Not Set'}
    </span>
</div>
