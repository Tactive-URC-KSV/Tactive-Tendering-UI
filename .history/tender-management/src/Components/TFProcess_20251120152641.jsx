            ...
            <div className="p-2">
                ...
                <div className="row align-items-center justify-content-between ms-1 mt-5">
                    <div className="col-md-4 col-lg-4 ">
                        ...
                        <select
                            className="form-input w-100"classNamePrefix="select
                    ...
                    <div className="col-md-4 col-lg-4">
                        ...
                        <Flatpickr
                            ...
                            onChange={([date]) => setTenderDetail({ ...tenderDetail, bidOpeningDate: date ? date.toLocaleDateString('en-GB') : '' })}
                            ref={datePickerRef}
                        />
                    ...
                    <div className="col-md-4 col-lg-4">
                        ...
                        <Flatpickr
                            ...
                            onChange={([date]) => setTenderDetail({ ...tenderDetail, offerSubmissionDate: date ? date.toLocaleDateString('en-GB') : '' })}
                            ref={datePickerRef}
                        />
                ...
                <div className="row align-items-center justify-content-between ms-1 mt-5">
                    <div className="col-md-4 col-lg-4 ">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Enter Contact Person"
                ...
                <div className="row align-items-center ms-1 mt-5">
                    <div className="col-md-4 col-lg-4 ">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Enter Scope of Package"
                             value={tenderDetail.scopeOfPackage}
                             onChange={(e) => setTenderDetail({ ...tenderDetail, scopeOfPackage: e.target.value })}
                        />
                    </div>
                    <div className="col-md-4 col-lg-4">
