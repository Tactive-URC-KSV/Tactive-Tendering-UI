...
// --- Start of Form Sub-Components (Moved Outside and Memoized) ---

// Placeholder Options (Keep these outside too)
...
function ContractorOverview() {
    ...
    // Use useCallback to memoize the event handlers and ensure stability
