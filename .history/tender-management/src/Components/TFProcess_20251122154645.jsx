        ...
        <div className="row align-items-center justify-content-between ms-1 mt-5">
            ...
            <div className="col-md-4 col-lg-4">
                ...
                <Flatpickr
                    ...
                    ref={datePickerRef}
                />
                <span className='calender-icon' onClick={() => openCalendar('bidOpeningDate')}>
            ...
            <div className="col-md-4 col-lg-4">
                ...
                <Flatpickr
                    ...
                    ref={datePickerRef}
                />
                <span className='calender-icon' onClick={() => openCalendar('submissionLastDate')}>
                    <FaCalendarAlt size={18} color='#005197' />
                </span>

                {/* Optional: Display formatted date below picker */}
                <div className="mt-1 text-muted">
                    {tenderDetail.offerSubmissionDate 
                        ? new Date(tenderDetail.offerSubmissionDate).toLocaleDateString()
                        : 'N/A'}
                </div>
            </div>
        </div>
                ...
                <div className="pt-4">
                    ...
                    <div className="row g-4 ms-1">
                        ...
                        <div className="col-md-4 text-start">
                          ...
                          <span 
    className="fw-medium"
    style={{ color: tenderDetail.offerSubmissionDate ? '#dc3545' : '#333' }}
>
    {tenderDetail.offerSubmissionDate 
        ? new Date(tenderDetail.offerSubmissionDate).toLocaleDateString()
        : 'N/A'}
    ...
    ? new Date(tenderDetail.bidOpeningDate).toLocaleDateString()
    : 'N/A'}
</span>
                        </div>
                        <div className="col-md-4 text-start">
