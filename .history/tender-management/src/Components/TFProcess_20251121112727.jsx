...
function TFProcess({ projectId }) {
    ...
    return (
        <div className="p-2 mt-4">
            <div className="text-start ms-1 mb-3 d-flex align-items-center">
            ...
            <div className="mb-3">
                ...
                <textarea
                    ...
                    onChange={(e) =>
                        setTenderDetail(prev => ({ ...prev, scopeOfWork: e.target.value }))
                    }
        ...
        <div className="p-2 mt-4">
            ...
            <div className="mb-3">
                ...
                <input
                    ...
                    onChange={(e) =>
                        setTenderDetail(prev => ({ ...prev, contactPerson: e.target.value }))
                    }
            ...
            <div className="mb-3">
                ...
                <input
                    ...
                    onChange={(e) =>
                        setTenderDetail(prev => ({ ...prev, contactEmail: e.target.value }))
                    }
            ...
            <div className="mb-3">
                ...
                <input
                    ...
                    onChange={(e) =>
                        setTenderDetail(prev => ({ ...prev, contactMobile: e.target.value }))
                    }
