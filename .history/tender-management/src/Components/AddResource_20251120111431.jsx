...
function AddResource() {
    ...
    return (
        <div className="container-fluid min-vh-100">
            ...
            {/* WRAP THE ENTIRE FORM CONTENT IN A FORM TAG TO PREVENT SCROLL-TO-TOP ON IMPLICIT SUBMIT/ENTER KEYPRESS */}
            <form onSubmit={(e) => e.preventDefault()}> 
                ...
                <div className="d-flex justify-content-end pt-3 me-3">
                    <button
                        ...
                        // Added type="button" to prevent implicit form submission that can cause scroll reset
                        type="button" 
                    >
                        Add Resource
                    </button>
