      ...
      {missingFields.map((f, i) => <li key={i}>{f}</li>)}
                ...
                {selectedView === 'manual' && (
                    <div className="d-flex justify-content-end mt-4">
                        ...
                        <button type="submit" form="contractorForm" className="btn px-4 fw-bold" style={{ backgroundColor: isFormValid ? bluePrimary : "#E6EEF9",color: isFormValid ? "white" : "#8FB4DD", borderRadius: "6px", borderColor: bluePrimary, cursor: isFormValid ? "pointer" : "not-allowed" }}>Review & Submit<ArrowRight size={21} color="white" className="ms-2" /></button>
                    </div>
                )}
            </div>
