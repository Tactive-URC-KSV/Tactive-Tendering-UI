...
const AttachmentRow = ({ title, files, notes }) => (
  ...
  const reviewTender = () => {
        ...
        return (
         ...
         // Assuming this is inside your reviewTender function
return (
    <div className="p-4">
        {/* ... (Existing Header/Title content would go here, not shown in your snippet) ... */}

        {/* 1. General Details Container (Updated) 🟢 */}
        {/* The first outer div from your original snippet is removed, and replaced by this new container */}
                            ...
                            tenderDetail.scopeOfPackage.map((scopeId, index) => {
                                ...
                                return (
                                    <span key={index} className="badge p-2"
                                        style={{ backgroundColor: '#E0F0F0', color: '#2BA95A', fontSize: '12px' }}>
        ...
        {/* 2. Package Details Container (Updated) 📦 */}
        ...
        {/* 3. Contractor Details Container (Updated) 👷‍♂️ */}
        <div className="p-4 mt-5 bg-white rounded-3" style={{ border: '1px solid #e0e0e0', boxShadow: '0 2px 4px rgba(0,0,0,.05)' }}>
            <div className="text-start ms-1 mb-3">
        ...
        {/* 4. Attachments Container (Updated) 📎 */}
        <div className="p-4 mt-5 bg-white rounded-3" style={{ border: '1px solid #e0e0e0', boxShadow: '0 2px 4px rgba(0,0,0,.05)' }}>
            <div className="text-start ms-1 mb-3">
                <Paperclip size={20} color="#005197" />
                <span className="ms-2 fw-bold" style={{ color: '#005197' }}>Attachments</span>
        ...
        {/* Existing Summary Bar and Float Button */}
