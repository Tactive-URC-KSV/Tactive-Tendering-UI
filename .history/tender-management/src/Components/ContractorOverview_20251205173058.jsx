        ...
        <div className="card text-start border-0 shadow-sm mt-4" style={{ borderRadius: "8px", padding: "0 1.5rem 1.5rem 1.5rem" }}>
            ...
            <div className="row mb-4">
                <div className="col-md-6 mb-3">
                    ...
                    <input type="text" className="" id="taxZipCode" name="taxZipCode" value={formData.taxZipCode} onChange={handleChange} placeholder="Enter Zip/Postal Code" style={{ height: "40px" }} />
                </div>
                <div className="col-md-6 mb-3">
