...
const handleNoteChange = (key, value) => {
  ...
  {Object.keys(attachments).map((key) => (
    <div className="upload-file row p-3 ms-auto me-auto" key={key}>
      <div className="col-12 text-center">
        <FaCloudUploadAlt size={48} />
      </div>
      <div className="col-12 text-center mt-2">
        {key.charAt(0).toUpperCase() + key.slice(1)} Documents
      </div>
      ...
      {attachments[key].files.length > 0 && (
        <div className="mt-3 px-3 text-start">
          <div className="row g-3">
            {attachments[key].files.map((file, idx) => (
                  ...
                  <FaTimes
                    ...
                    onClick={() =>
                      setAttachments((prev) => ({
                        ...
                        [key]: {
                          ...prev[key],
                          files: prev[key].files.filter((_, i) => i !== idx),
                        },
                      }))
                    }
                  />
      ...
      <div className="col-12 mt-2">
        <textarea
          ...
          placeholder={`Additional notes for ${key}`}
          rows={2}
          value={attachments[key].notes}
