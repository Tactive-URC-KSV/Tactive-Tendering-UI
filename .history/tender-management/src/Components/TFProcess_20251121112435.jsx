...
function TFProcess({ projectId }) {
            ...
            <div className="p-2">
                ...
                <div className="row align-items-center justify-content-between ms-1 mt-5">
                    ...
                    <div className="col-md-4 col-lg-4">
                        ...
                        />
                                ...
                                <div className="mt-4">
                    <span className="fw-bold">Offer Submission Mode</span>
                    <div className="mt-2">
                        <Select
                            options={[
                            ...
                            value={tenderDetail.offerSubmissionMode ? { value: tenderDetail.offerSubmissionMode, label: tenderDetail.offerSubmissionMode.charAt(0).toUpperCase() + tenderDetail.offerSubmissionMode.slice(1) } : null}
                            onChange={(selected) => setTenderDetail(prev => ({ ...prev, offerSubmissionMode: selected.value }))}
                ...
                <div className="row mt-3">
                    <div className="col-md-6 col-lg-6">
                        <label className="projectform text-start d-block">Offer Submission Date</label>
                        <div className="d-flex align-items-center">
                            <input
                                id="offerSubmissionDate"
                                type="text"
                            ...
                            <FaCalendarAlt
                                ...
                                onClick={() => openCalendar('offerSubmissionDate')}
                            />
                        </div>
                    </div>
                    <div className="col-md-6 col-lg-6">
            ...
            <div className="p-2 mt-4">
                ...
                <div className="mb-3">
                    ...
                    <textarea
                        ...
                        onChange={(e) => setTenderDetail(prev => ({ ...prev, scopeOfWork: e.target.value }))}
            ...
            <div className="p-2 mt-4">
                ...
                <div className="mb-3">
                    ...
                    <input
                        ...
                        onChange={(e) => setTenderDetail(prev => ({ ...prev, contactPerson: e.target.value }))}
                ...
                <div className="mb-3">
                    ...
                    <input
                        ...
                        onChange={(e) => setTenderDetail(prev => ({ ...prev, contactEmail: e.target.value }))}
                        placeholder="Enter Email"
                    />
                </div>
                <div className="mb-3">
                    <label className="projectform text-start d-block">Mobile Number</label>
                    <input
                        type="tel"
                        className="form-input w-100"
                        value={tenderDetail.contactMobile}
                        onChange={(e) => setTenderDetail(prev => ({ ...prev, contactMobile: e.target.value }))}
        ...
        return (
            <div className="p-2 mt-4">
                ...
                <div className="mb-3">
                    ...
                    />
                    <small className="text-muted">Upload all tender related documents here</small>
                </div>
            </div>
        );
    };
    ...
    const reviewTender = () => {
        const selectedBoqs = getSelectedLeafBoqs(parentTree);
        return (
            <div className="p-2 mt-4">
                <div className="text-start ms-1 mb-3">
                    <ArrowRight size={20} color="#2BA95A" />
                    <span className="ms-2 fw-bold">Review Tender</span>
                </div>
                <div className="mb-3">
                    <h6>Selected BOQs:</h6>
                    {selectedBoqs.length > 0 ? (
                        <ul>
                            {selectedBoqs.map(boq => (
                                <li key={boq.id}>{boq.boqCode} - {boq.boqName}</li>
                            ))}
                        </ul>
                    ) : (
                        <p className="text-muted">No BOQs selected yet</p>
                    )}
                </div>
                <div className="mb-3">
                    <h6>Scope of Package:</h6>
                    <p>{selectedScopes.map(s => s.label).join(', ')}</p>
                </div>
                <div className="mb-3">
                    <h6>Contact Person:</h6>
                    <p>{tenderDetail.contactPerson} | {tenderDetail.contactEmail} | {tenderDetail.contactMobile}</p>
                </div>
            </div>
        );
    };
    ...
    const renderContent = () => {
        switch (currentTab) {
            ...
            case 'attachments': return attachmentDetails();
            case 'review': return reviewTender();
            default: return null;
        }
    };

    return (
        <div className="tfprocess-container">
            <div className="tfprocess-tabs d-flex border-bottom">
                {['general', 'package', 'contractor', 'attachments', 'review'].map(tabName => (
                    <div
                        key={tabName}
                        className={`tab-item p-3 ${currentTab === tabName ? 'active' : ''}`}
            ...
            <div className="tfprocess-content mt-4">
                {renderContent()}
            </div>
        </div>
    );
