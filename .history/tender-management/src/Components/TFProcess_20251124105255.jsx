...
const AttachmentRow = ({ title, files, notes }) => (
  ...
  const reviewTender = () => {
       ...
       // Assuming necessary imports like React, useState, Info, BoxesIcon, User2, Paperclip, X, ArrowLeft, ArrowRight, getDisplayMode, boqNameDisplay, AttachmentRow, scopeOptions are present

const TFProcess = ({ project, selectedBoq, boqArray, tenderDetail, contractorsList, attachments, getAttachmentTitle, boqSelection, tenderDetails }) => {
    
    // Placeholder function for demonstration, replace with your actual state management/context
    const [currentTab, setCurrentTab] = React.useState('review'); 
    
    // Placeholder for handleNextTabChange and handlePreviousTabChange (used in main return)
    ...
    // The updated reviewTender function with styled cards
    const reviewTender = () => {
        return (
            <div className="p-4">
                ...
                {/* Tender Floating Info (Header Box) */}
                    ...
                    <div className="text-end">
                        ...
                        <span className="fw-medium" style={{ fontSize: '16px' }}>
                            {tenderDetail.floatingDate 
                                ? new Date(tenderDetail.floatingDate).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })
                                : 'N/A'}
                        </span>
                    </div>
                </div>

                {/* 1. General Details Container (Styled Card) */}
                <div className="p-4 mt-4 bg-white rounded-3" style={{ border: '1px solid #e0e0e0', boxShadow: '0 2px 4px rgba(0,0,0,.05)' }}>
                ...
                </div> {/* End of General Details Container */}

                {/* 2. Package Details Container (Styled Card) */}
                ...
                </div> {/* End of Package Details Container */}

                {/* 3. Contractor Details Container (Styled Card) */}
                <div className="p-4 mt-5 bg-white rounded-3" style={{ border: '1px solid #e0e0e0', boxShadow: '0 2px 4px rgba(0,0,0,.05)' }}>
                    <div className="text-start ms-1 mb-3">
                        ...
                        {contractorsList.map((contractor, index) => (
                            <div key={index} className="p-3" style={{ border: '1px solid #ccc', borderRadius: '8px', minWidth: '300px' }}>
                                <div className="d-flex justify-content-between align-items-start">
                                    ...
                                    {/* Assuming there is a function to remove the contractor, otherwise, this X icon is for display */}
                ...
                </div> {/* End of Contractor Details Container */}

                {/* 4. Attachments Container (Styled Card) */}
                <div className="p-4 mt-5 bg-white rounded-3" style={{ border: '1px solid #e0e0e0', boxShadow: '0 2px 4px rgba(0,0,0,.05)' }}>
                    <div className="text-start ms-1 mb-3">
                        <Paperclip size={20} color="#005197" />
                        <span className="ms-2 fw-bold" style={{ color: '#005197' }}>Attachments</span>
                ...
                <div className="p-3 mt-5 mb-5 d-flex justify-content-between align-items-center" style={{ backgroundColor: '#F0F8FF', border: '1px solid #B0C4DE', borderRadius: '8px' }}>
                    ...
                    <button 
                        ...
                        // onClick={handleFloatTender} - Add actual click handler here
                    >
                        Float Tender
                    </button>
                </div>
        ...
        <div className='container-fluid min-vh-100'>
            ...
            <div className="bg-white rounded-3 ms-3 me-3 p-3 mt-4 mb-3" style={{ border: '1px solid #0051973D' }}>
                ...
                <div className="d-flex align-items-center justify-content-between mt-3 p-3">
                    ...
                    <div className="rounded" style={{ background: `${currentTab === 'tender' || currentTab === 'review' ? '#005197' : '#E9ECEF'}`, height: '5px', width: '15%' }}></div>
                    <div className="text-white">
                        <span className="py-2 px-3" style={{ background: `${currentTab === 'tender' || currentTab === 'review' ? '#005197' : '#E9ECEF'}`, borderRadius: '30px' }}>2</span>
                        <span className="ms-2 fw-bold" style={{ color: `${currentTab === 'tender' || currentTab === 'review' ? '#005197' : '#6C757D'}` }}>Tender details</span>
                    </div>
                    <div className="rounded" style={{ background: `${currentTab === 'review' ? '#005197' : '#E9ECEF'}`, height: '5px', width: '15%' }}></div>
                    <div className="text-white">
                        <span className="py-2 px-3" style={{ background: `${currentTab === 'review' ? '#005197' : '#E9ECEF'}`, borderRadius: '30px' }}>3</span>
                        <span className="ms-2 fw-bold" style={{ color: `${currentTab === 'review' ? '#005197' : '#6C757D'}` }}>Review & Float</span>
                    </div>
                </div>
            </div>
            ...
            {/* Navigation Buttons (Previous/Next) - Excludes the 'Float Tender' button */}
            {currentTab !== 'review' && (
                <div className={`d-flex justify-content-${currentTab === 'boq' ? 'end' : 'between'} align-items-center mt-5 me-3 ms-3 mb-4`}>
                    ...
                    {/* Placeholder for selectedBoq.size check: adjust as needed */}
