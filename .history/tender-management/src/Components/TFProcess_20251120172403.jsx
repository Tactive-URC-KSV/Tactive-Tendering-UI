...
// Assuming icon imports from a library like 'lucide-react'
...
// Placeholder/Mock data and utility functions needed for the provided code to run
...
const customStyles = `
    ...
    .form-input { border: 1px solid #ccc; padding: 8px; border-radius: 4px; }
...
// Reusable component for a single attachment card (NEWLY ADDED)
const AttachmentCard = ({ title, attachmentKey, currentAttachment, onChange, setTab }) => {
        ...
        <div className="col-md-6 col-lg-6 mb-4">
            <div className="p-4 rounded-3 d-flex flex-column align-items-center"
                ...
                <div className="d-flex flex-column align-items-center mb-3" 
                    ...
                    {/* Display filename if file is selected (for visual cue) */}
...
const TFProcess = () => {
    // EXISTING STATE & REFs
    const [currentTab, setCurrentTab] = useState('tender'); // Set to 'tender' to match the image context
    const [tab, setTab] = useState('attachment'); // Set to 'attachment' to match the image context
    ...
    const [selectedBoq, setSelectedBoq] = useState(new Set(getSelectedLeafBoqs().map(b => b.id))); // Mock selected BOQ set
    ...
    const boqSelection = () => {
        return <div>BOQ Selection UI placeholder</div>;
    }
    ...
    const attachmentDetails = () => {
        return (
            <div className="p-2">
                ...
                {/* "Previous" button - styled to match the image structure */}
    ...
    const tenderDetails = () => {
        ...
        return (
            <div className="bg-white ms-3 me-3 rounded-3 p-3 mt-5" style={{ border: '1px solid #0051973D' }}>
                ...
                {/* Selected BOQ's Chips (Added to match the image) */}
                ...
                {/* Tab Navigation (Implemented to match the image) */}
                ...
                {/* Removed the internal next/previous buttons as they conflict with the image's structure */}
            </div>
        );
    }
    ...
    return (
        <div className='container-fluid min-vh-100'>
            ...
            <div className={`d-flex justify-content-${currentTab === 'boq' ? 'end' : 'between'} align-items-center mt-5 me-3 ms-3 mb-4`}>
                ...
                {/* The "Review & Confirm" button on the bottom right of the image is for the tender details page */}
