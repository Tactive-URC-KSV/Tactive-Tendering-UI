...
function ContractorOverview() {
    ...
    const ManualEntryForm = () => (
        <form onSubmit={handleSubmit}>
            {/* Basic Information Section Header - MODIFIED FOR FULL WIDTH */}
            <div 
                // mx-n4 removes the side margins to counteract the parent's p-4 padding
                // Removed 'rounded' and 'justify-content-center'
                className="d-flex align-items-center mb-4 mx-n4" 
                style={{ 
                    backgroundColor: bluePrimary,
                    // Apply horizontal padding inside the bar
                    padding: '12px 24px', 
                }}
            >
            ...
            {/* Form Actions (Buttons) - NO LINE ABOVE */}
