...
function AddResource() {
    ...
    // Options are kept empty/commented out as per your original code
    ...
    // Custom Styles for react-select (Ensures 100% width within the Bootstrap column)
    const customStyles = {
    ...
    // Form Section Container Component (unchanged)
                ...
                <FormSectionContainer title="Basic Information" icon={<span className="text-primary" style={{ fontSize: '1.2em' }}>•</span>}>
                    <div className="row g-3">
                        <div className="col-md-6">
                            {/* Label starts at column edge */}
                            <label className="form-label">Resource Type</label>
                            {/* Input fills column width (100% due to customStyles) */}
                            <Select 
                        ...
                        <div className="col-md-6">
                            ...
                            {/* Removed width: '80%' to align flush with label and fill column */}
                            <input 
                                type="number" 
