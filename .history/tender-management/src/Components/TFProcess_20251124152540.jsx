...
return (
    ...
    <div className="d-flex">
        {/* ... first half of the summary (Attachments) */}
        
        <div className="d-flex justify-content-between ps-4" style={{ width: '50%' }}>
            {/* Changed label from "Submission Deadline" to "Submission Window" for clarity */}
            <span>Submission Window</span> 
            <span 
                style={{ 
                    color: '#dc3545' // Keeps the red color for emphasis
                }}
            >
                {daysDisplay} {/* This renders the calculated days, e.g., "15 Days" */}
            </span>
        </div>
    </div>
    
    // ... rest of the reviewTender return
);
            </div>
        </div>
    </div>
