...
const getFriendlyFileType = (mimeType) => {
  ...
  return days >= 0 ? days : 0; // if past, show 0
};
  useEffect(() => {
        console.log("Offer Submission Date =", tenderDetail.offerSubmissionDate);
...
<div className="mt-5 mb-5">
    ...
    <span style={{ color: '#dc3545' }}>
        {tenderDetail.offerSubmissionDate
            ? `${getDaysLeft(tenderDetail.offerSubmissionDate)} days left`
            : "Not Set"}
    </span>
</div>
