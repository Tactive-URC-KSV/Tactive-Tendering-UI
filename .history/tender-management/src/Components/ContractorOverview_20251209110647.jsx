...
const ManualEntryForm = ({ formData, setFormData, handleChange, handleSelectChange, handleFileChange, handleRemoveFile }) => (
    <>
        ...
        {/* --- FILE UPLOAD SECTION MATCHING REFERENCE IMAGE 1 LAYOUT --- */}
        <div className="row mb-4">
            <div className="col-12 mt-3">
                ...
                >
                    ...
                    <UploadCloud size={250} className="mb-2" style={{ color: bluePrimary }} /> 
                    <p className="mb-1 fw-bold" style={{ color: bluePrimary }}>Optional Documents</p>
                    
                    {/* File Input (Hidden, connected to the 'Choose File' label) */}
                    <input 
                        type="file" 
                        id="fileUpload" 
                        name="attachments" 
                    ...
                    {/* "Choose File" Button (Label linked to hidden input) */}
                    <label 
                        htmlFor="fileUpload" 
...
// --- Main Component (ContractorOverview) ---
