...
import { ArrowLeft, Plus, Copy,  EditIcon, Trash2, IndianRupee, BadgeDollarSign, ClipboardPaste, } from "lucide-react";
  ...
  return (
    <div className="container-fluid min-vh-100">
      ...
      <div className="bg-white rounded-3 ms-3 me-3 p-4" style={{ border: '1px solid #0051973D' }}>
        ...
        <div className="text-start d-flex justify-content-between align-items-center pb-3" style={{ borderBottom: '5px solid #0051973D' }}>
          <h6>Resource Details</h6>
          <div className="d-flex align-items-center">
           <button className="btn btn-success d-flex align-items-center me-2" onClick={handleAddResource}><Plus size={20} className="me-2" />Add Resource</button><button className="btn action-button me-2" onClick={handleCopyResources}><Copy size={20} /><span className="ms-2">Copy</span></button>
