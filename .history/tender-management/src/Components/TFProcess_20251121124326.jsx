...
const handleNoteChange = (key, value) => {
 ...
 const attachmentDetails = ({ handlePrevious, setCurrentTab }) => { // <-- ACCEPT NAVIGATION PROPS
    ...
    return (
        <div className="p-2">
                ...
                {attachmentTypes.map((item) => (
                    <div className="col-md-6 mb-4" key={item.key}>
                        ...
                        <label
                            ...
                            style={{
                                // Using the lighter border from the screenshot, though your code used B0C4DE
                                border: "1px dashed #ced4da", 
                                background: "#F8FBFF",
                                textAlign: "center",
                                cursor: "pointer",
                                minHeight: "150px" // Added min-height for structure
                            }}
                        >
                            <input
                                type="file"
                            ...
                            <div className="d-flex justify-content-center mb-2">
                                ...
                                >
                                    {/* Used a different upload icon (FaCloudUploadAlt) based on your code */}
                            ...
                            <ul className="mt-2 list-unstyled text-start ms-3">
                                {attachments[item.key].files.map((file, index) => (
                                    <li key={index} style={{ fontSize: "13px" }}>
                                        📄 {file.name}
                                        {/* You'll need a delete handler here */}
                                    </li>
                                ))}
                            </ul>
                        )}
            ...
            <div className="d-flex justify-content-between align-items-center ms-3 me-3 mt-4 mb-4">
                {/* Note: handlePrevious needs to be passed down as a prop */}
                <button className="btn btn-outline-secondary" onClick={handlePrevious}>Previous</button> 
                <button 
                    className="btn btn-primary" 
                    onClick={() => setCurrentTab('review')} // Note: setCurrentTab needs to be passed down as a prop
