...
<div className="mt-4 pt-3 border-top">
  <div className="row align-items-start mb-3">
    <div className="col-12 d-flex align-items-center">
      <i className="bi bi-geo-alt text-primary me-2" style={{ fontSize: "18px" }}></i>
      <h5 className="fw-semibold mb-0">Address Details</h5>
    </div>
    <div className="col-12 ps-4 ms-1" style={{ marginTop: "-5px" }}>
      <small className="text-muted">Registered company address</small>
    </div>
  </div>
  ...
  <div className="row mb-4 ps-4">
    <div className="col-md-3 mb-3">
      <label className="text-muted small">Phone No</label>
      <div className="fw-semibold">+1 (555) 123-4567</div>
    </div>

    <div className="col-md-3 mb-3">
      <label className="text-muted small">Email ID</label>
      <div className="fw-semibold">contact@apexbuilders.com</div>
    </div>

    <div className="col-md-3 mb-3">
      <label className="text-muted small">Address Type</label>
  ...
  <div className="row mb-4 ps-4">
    <div className="col-md-3 mb-3">
      <label className="text-muted small">Address 1</label>
      <div className="fw-semibold">123 Innovation Drive, Suite 450</div>
    </div>

    <div className="col-md-3 mb-3">
      <label className="text-muted small">Address 2</label>
      <div className="fw-semibold">Tech Park</div>
    </div>

    <div className="col-md-3 mb-3">
      <label className="text-muted small">Country</label>
      <div className="fw-semibold">United States</div>
    </div>

    <div className="col-md-3 mb-3">
      <label className="text-muted small">City</label>
      <div className="fw-semibold">Metropolis</div>
    </div>
  </div>
  ...
  <div className="row mb-4 ps-4">
    <div className="col-md-3 mb-3">
      <label className="text-muted small">Zip/Postal Code</label>
      <div className="fw-semibold">10001</div>
    </div>
  </div>
