...
function Contractor() {
    ...
    // === HELPER COMPONENT FOR VISUAL MATCH AND RADIO LOGIC ===
        ...
        return (
            <div 
                ...
                style={{ 
                    ...
                    paddingLeft: '1rem', 
                    paddingRight: '1rem',
                    backgroundColor: isSelected ? '#E6F0F8' : 'white', // Light blue background on selected
        ...
        <div className="container-fluid min-vh-100">
            ...
            <div className="ms-3 me-3 bg-white rounded-3 mt-5 p-2" style={{ border: '1px solid #0051973D' }}>
                ...
                <div className="row g-3 ms-2 mt-2 mb-4 me-2 d-flex justify-content-between">
                    ...
                    {/* === MODIFIED: SORT BY FIELD WITH BLUE BACKGROUND AND SMALLER WIDTH === */}
                    <div className="col-lg-3 col-md-4 position-relative"> {/* Reduced col-lg width from 4 to 3 for smaller width */}
                        <label className="text-start d-block" style={{ visibility: 'hidden' }}>Sort</label>
                        <div className="dropdown w-100">
                            <button
                                // Custom button styling for blue background and white text
                                className="btn w-100 d-flex justify-content-between align-items-center"
                                type="button"
                                onClick={toggleSortDropdown}
                                style={{
                                    height: '38px',
                                    backgroundColor: bluePrimary, // Solid blue background
                                    color: 'white', // White text
                                    borderColor: bluePrimary, // Blue border
                                    boxShadow: 'none', 
                                    paddingLeft: '12px',
                                    paddingRight: '12px',
                                }}
                            >
                                Sort by 
                                {/* In Lucide-react, the icon color is usually set via the `color` prop, 
                                but since this is a custom button, we'll ensure the dropdown arrow is white. */}
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-chevron-down ms-1" style={{ width: '18px', height: '18px', color: 'white' }}>
