...
<div className="mt-5 mb-5">
    ...
    >
        ...
        <div className="d-flex flex-column" style={{ color: '#005197', fontSize: '14px' }}> 
         ...
         // ... (JSX for the Tender Summary container and Rows 1 remains the same)

{/* Row 2: Attachments and Submission Deadline */}
<div className="d-flex">
    {/* Attachments - LEFT COLUMN (Has Vertical Separator) */}
    <div 
        className="d-flex justify-content-between pe-2 me-4" 
        style={{ 
            width: '50%',
    ...
    {/* Submission Deadline - RIGHT COLUMN (Displays calculated days) */}
    <div className="d-flex justify-content-between ps-4" style={{ width: '50%' }}>
        <span>Submission Deadline:</span> 
        <span 
            style={{ 
                // Color remains red for the deadline 
                color: '#dc3545' 
            }}
        >
            {/* CALL the function to calculate the day difference */}
            {calculateDaysDifference(tenderDetail.floatingDate, tenderDetail.lastSubmissionDate)}
        </span>
    </div>
</div>

// ... (The rest of the component structure below this line remains the same)
        </div>
    </div>
