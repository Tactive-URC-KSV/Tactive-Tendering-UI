...
import { ArrowLeft, Pencil, Mail, UploadCloud, FaCalendarAlt, FileText, Building, PhoneCall, Receipt, Landmark, Info } from "lucide-react"; 
    ...
    <div className="col-md-6 mb-3">
        ...
        <div className="input-group">
            <input 
                ...
                // FIX 1: Remove the right border of the input to merge seamlessly with the icon span
                style={{ height: "40px", borderRight: "none" }} 
            />
            <span 
                className="input-group-text bg-white" 
                // FIX 2: Ensure the left border of the icon span is removed 
                style={{ borderLeft: "none", height: "40px" }}
            >
                {/* Assuming FaCalendarAlt is imported */}
    ...
    <div className="col-md-6 mb-3">
        ...
        <Select
            ...
            styles={{
                ...
                // FIX 3: Remove the vertical separator line in the react-select component
