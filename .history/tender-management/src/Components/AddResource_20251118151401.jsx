...
function AddResource() {
    ...
    const FormSectionContainer = ({ title, icon, defaultOpen = false, children }) => {
        // 'Cost Summary' is included to make it static and always open.
        ...
        return (
            // mx-3 provides lateral margin, mb-4 provides vertical space below this section
    ...
    return (
        <div className="container-fluid min-vh-100">
            ...
            <div 
                // FIXED: Added mb-4 class here to create space below the header
