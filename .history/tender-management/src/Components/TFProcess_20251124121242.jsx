...
<div className="p-4 mt-5 bg-white rounded-3" style={{ border: '1px solid #e0e0e0', boxShadow: '0 2px 4px rgba(0,0,0,.05)' }}>
    ...
    <div className="table-responsive ms-1 me-1">
      ...
      // Define this helper function OUTSIDE your component (e.g., near the top of the file)
const getFriendlyFileType = (mimeType) => {
    ...
    // Fallback: use the extension if available (e.g., .txt -> TXT)
    const parts = mimeType.split('.');
    if (parts.length > 1) {
        return parts.pop().toUpperCase();
    }

    return 'Document'; // General fallback
};
...
<div className="mt-5">
    ...
    {Object.keys(attachments).map((key) => {
        ...
        // Using the existing formatFileSize helper (must also be defined outside)
            ...
            >
                <div className="d-flex justify-content-between align-items-start">
                    ...
                    <div className="text-start me-4 flex-grow-1">
                        ...
                        {/* 🌟 2. UPDATED FILE TYPE DISPLAY (RED COLOR) */}
                        {fileInfo ? (
