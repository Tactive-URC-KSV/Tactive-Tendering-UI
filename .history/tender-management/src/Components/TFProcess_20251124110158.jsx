...
const AttachmentRow = ({ title, files, notes }) => (
  ...
  const reviewTender = () => {
        ...
        return (
            <div className="p-4">
    {/* 1. NEW WHITE CONTAINER CARD STARTS HERE. 
         It wraps both the header and the floating details.
    */}
    <div className="p-4 bg-white rounded-3" style={{ border: '1px solid #e0e0e0', boxShadow: '0 2px 4px rgba(0,0,0,.05)' }}>
        
        {/* Header (Original Block 1) - Inside the new white card */}
        ...
        {/* Floating Details (Original Block 2) - Inside the new white card */}
    ...
    {/* NEW WHITE CONTAINER CARD ENDS HERE */}
</div>
