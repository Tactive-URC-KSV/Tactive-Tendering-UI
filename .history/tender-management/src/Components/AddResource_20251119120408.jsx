            ...
            <FormSectionContainer title="Quantity & Measurements" icon={<AlignLeft size={20} className="text-primary" />} defaultOpen={true}>
                <div className="row g-3">
                    <div className="col-md-6">
                        ...
                        <div style={{ width: '80%' }}>
                            <Select  options={uomOptions}  value={selectedUom} onChange={setSelectedUom}  styles={customStyles}  placeholder="Select UOM"  className="w-100" classNamePrefix="select" /> </div>
                    </div>
