...
function AddResource() {
    ...
    axios
      .get(`${import.meta.env.VITE_API_BASE_URL}/resourceNature`, {  // <-- backticks here
        headers: {
          Authorization: `Bearer ${sessionStorage.getItem('token')}`, // <-- backticks here
          'Content-Type': 'application/json',
        },
      })
      .then((res) => {
                ...
                <div className="row g-3">
                    ...
                    <div className="col-md-6">
                        <div style={{ width: '80%' }} className="ms-auto">
                            ...
                            <Select options={resourceNatureOption} styles={customStyles} placeholder=""/>
                        </div>
                    </div>
