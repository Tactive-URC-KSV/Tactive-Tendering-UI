...
const handleNoteChange = (key, value) => {
  ...
  // NOTE: Ensure your imports (React, useState, Paperclip, FaCloudUploadAlt, ArrowRight)
// and state handlers (attachments, handleFileUpload, handleNoteChange)
// are defined at the top level of your file, before this function.

const attachmentDetails = ({ handlePrevious, setCurrentTab }) => { 
    
    // NOTE: This array assumes the attachments state structure is available.
    ...
    return (
        <div className="p-2">
            ...
            <div className="row mt-4">
                {attachmentTypes.map((item) => (
                    <div className="col-md-6 mb-4" key={item.key}>
                        ...
                        {/* --- 1. UPLOAD BOX CONTAINER (Matches Screenshot Design) --- */}
                        <div className="p-3 rounded-3" 
                             style={{ 
                                border: "1px solid #ced4da", // Solid, light grey border around the main box
                                background: "#FFFFFF",
                                minHeight: "180px" // Ensure boxes align vertically
                             }}
                        >
                            <div className="text-center">
                                <h6 className="fw-bold mb-3 mt-2">{item.title}</h6>
                                
                                {/* Upload Area (The dashed border box) */}
                                <label
                                    className="p-4 w-100 d-block"
                                    style={{
                                        border: "1px dashed #B0C4DE", // Light dashed border
                                        textAlign: "center",
                                        cursor: "pointer",
                                        borderRadius: "4px",
                                ...
                                >
                                    ...
                                    <div className="d-flex justify-content-center mb-2">
                                        ...
                                        >
                                            <FaCloudUploadAlt size={35} color="#005197" />
                                        </div>
                                    </div>
                        ...
                        {/* --- END UPLOAD BOX CONTAINER --- */}
                        
                        {/* List of Uploaded Files (Placeholder if using 'multiple') */}
                        {attachments[item.key].files.length > 0 && (
                            <ul className="mt-2 list-unstyled text-start ms-3">
                        ...
                        {/* --- 2. NOTES TEXTAREA (Separated from Upload Box) --- */}
                        <textarea
                            className="form-control mt-3" // Increased margin-top for separation
            ...
            {/* Footer Navigation (Matches Screenshot Layout) */}
            <div className="d-flex justify-content-end align-items-center ms-3 me-3 mt-4 mb-4">
                 {/* The 'Previous' button is placed far left in the screenshot,
                    but sometimes it's grouped with the final button. Based on 
                    the final screenshot, it seems to be outside this area. 
                    We'll provide the final button here. 
                 */}
                 <button className="btn btn-primary" 
                    onClick={() => setCurrentTab('review')}
                    style={{ background: '#005197', border: 'none' }}
                >
                    Review & Confirm <ArrowRight size={18} />
                </button>
            </div>
            
            {/* If you need the 'Previous' button to appear on the far left 
                of the same container as 'Review & Confirm', use this structure:
                ...
                <div className="d-flex justify-content-between align-items-center ms-3 me-3 mt-4 mb-4">
                    ...
                    <button className="btn btn-primary" onClick={() => setCurrentTab('review')} style={{ background: '#005197', border: 'none' }}>
                        Review & Confirm <ArrowRight size={18} />
                    </button>
                </div> 
            */}
