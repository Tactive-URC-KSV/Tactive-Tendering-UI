import { Filter, List, Plus, Grid, Check } from "lucide-react"; 
import '../CSS/Styles.css';
import Select from "react-select";
import { useState } from "react";
import { useNavigate } from "react-router-dom";

// Define the primary color (dark blue)
...
function Contractor() {
    ...
    // === CUSTOM CHECKBOX STYLING (Guaranteed Blue Colors) ===
            ...
            >
                ...
                <span
                    style={{
                        ...
                        // Background is light blue when selected, white when unselected
                        backgroundColor: isSelected ? '#E9F5FF' : 'white', 
                    }}
                >
                    {/* Checkmark Icon (Dark Blue, only visible when selected) */}
                    {isSelected && <Check size={14} color={bluePrimary} strokeWidth={3} />}
                </span>
    ...
    // Custom styles for react-select to enforce blue border
    const customSelectStyles = {
        control: (provided, state) => ({
            ...
            minHeight: '38px',
            boxShadow: 'none',
            // Blue border always, slightly darker on focus
            borderColor: state.isFocused ? bluePrimary : `${bluePrimary}99`, 
            '&:hover': {
        ...
        placeholder: (provided) => ({
            ...
            color: `${bluePrimary}66`, 
        }),
        singleValue: (provided) => ({
            ...provided,
            // Blue selected value text
            color: bluePrimary, 
        }),
    };
                ...
                <div className="row g-3 ms-2 mt-2 mb-4 me-2 d-flex justify-content-between">
                    ...
                    <div className="col-lg-4 col-md-6">
                        ...
                        <input 
                            ...
                            // Applied blue border and placeholder styling
                            style={{ 
                                height: '38px',
                                borderColor: `${bluePrimary}99`, // Soft blue border
                                color: bluePrimary, // Input text color
                                '::placeholder': { color: `${bluePrimary}66` }, // Placeholder color
                            }}
                        />
                    </div>
                    ...
                    <div className="col-lg-4 col-md-6">
                        ...
                        <Select
                            ...
                            isClearable
                            styles={customSelectStyles} // Apply custom blue styles
                        />
                    </div>
