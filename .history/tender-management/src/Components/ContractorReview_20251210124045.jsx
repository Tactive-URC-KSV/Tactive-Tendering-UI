...
const DetailItem = ({ label, value }) => {
    ...
    return (
        // *** CHANGE 1: mb-4 -> mb-3 (Slightly less space between rows)
        <div className="col-lg-4 col-md-6 col-sm-12 mb-3">
            <div className="text-start">
                <p 
                    // *** CHANGE 2: mb-1 -> mb-0 (Remove margin between label and value)
                ...
                <p
                    ...
                    style={{
                        ...
                        minHeight: '1.1em',
                        // *** CHANGE 3: Add small margin bottom to value to space it from the next label above it
                        marginBottom: '0.5rem' 
                    }}
                >
                    {displayValue}
