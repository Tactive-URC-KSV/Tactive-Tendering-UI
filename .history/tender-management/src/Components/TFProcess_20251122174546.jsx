...
function TFProcess({ projectId }) {
    ...
    <div className="p-2">
        ...
        {/* First row: Floating No (left) and Floating Date (right) */}
        ...
        {/* Third row: Offer Submission Mode, Bid Opening Date, Submission Last Date */}
        ...
        {/* Fourth row: Contact Person, Email, Number */}
        <div className="row align-items-center ms-1 mt-5">
            <div className="col-md-4 col-lg-4">
        ...
        {/* Fifth row: Scope of Package & Scope of Work */}
        <div className="row align-items-center ms-1 mt-5">
            <div className="col-md-4 col-lg-4">
