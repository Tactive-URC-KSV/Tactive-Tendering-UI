...
function ContractorOverview() {
    ...
    const handleSelectChange = (selectedOption) => {
        setFormData({
            ...formData,
            additionalInfoType: selectedOption.value
        });
    };
...
<form onSubmit={handleSendInvitation} className="p-3" >
    ...
    const AdditionalInfoContent = () => (
        <div className="card text-start border-0 shadow-sm mt-4" style={{ borderRadius: "8px", padding: "0 1.5rem 1.5rem 1.5rem" }}>
            <div className="p-3 mb-4 d-flex align-items-center justify-content-center"
                style={{
                    backgroundColor: bluePrimary,
                    width: "calc(100% + 3rem)",
                    marginLeft: "-1.5rem",
            ...
            <div className="row">
                <div className="col-md-6 mt-3 mb-4">
                    <label htmlFor="additionalInfoType" className="projectform-select text-start d-block">
            ...
            <div className="container-fluid min-vh-100 p-0">
                ...
                <div className="px-4 text-start">
                    ...
                    <div className="d-inline-flex mb-4" style={buttonGroupStyle}>
                        <button className="btn d-flex align-items-center fw-bold"
                    ...
                    <form id="contractorForm" onSubmit={handleSubmit}>
                        <div className="card text-start border-0 shadow-sm"
                            style={{ borderRadius: "8px", padding: selectedView === "manual" ? "0 1.5rem 1.5rem 1.5rem" : "1.5rem" }}>
                    ...
                    {selectedView === "manual" && (
                        <div className="d-flex justify-content-end mt-4">
                            <button type="button" className="btn btn-outline-secondary me-3 px-4 fw-bold"
                                onClick={handleCancel} style={{ borderRadius: "6px" }}>Cancel</button>

                            <button type="submit" form="contractorForm"
