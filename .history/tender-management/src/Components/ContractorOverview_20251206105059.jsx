        ...
        <>
            ...
            <div className="row mb-4">
                <div className="col-md-6 mb-3">
                    ...
                    <select className="form-select" id="natureOfBusiness" name="natureOfBusiness" value={formData.natureOfBusiness} onChange={handleChange} classNamePrefix="select" >
        ...
        <div className="card text-start border-0 shadow-sm mt-4" style={{ borderRadius: "8px", padding: "0 1.5rem 1.5rem 1.5rem" }}>
            ...
            <div className="row mb-3">
                <div className="col-md-6 mb-3">
                    ...
                    <select className="form-select" classNamePrefix="select" id="addressType" name="addressType" value={formData.addressType} onChange={handleChange} style={{ height: "40px" }}>
