            ...
            return (
                <div key={key} className="d-flex justify-content-between align-items-center py-3 border-bottom" style={{ borderColor: '#eee' }}>
                    <div className="text-start">
                        ...
                        {/* File Type/Size */}
                        {files.length > 0 && (
                            <span className="text-danger fw-medium me-2" style={{ fontSize: '13px', color: '#dc3545' }}>
                                {/* Using placeholder file details */}
                    ...
                    {files.length > 0 && (
                        <span 
                            ...
                            // onClick={() => handleDownload(files[0])} // This line should be commented out or use a defined function
                        >
                            <Download size={18} />
                        </span>
                    )}
