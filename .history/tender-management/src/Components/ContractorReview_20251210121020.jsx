...
const labelTextColor = '#00000080'; // 🚨 NEW: Requested color for labels
        ...
        <div className="col-lg-4 col-md-6 col-sm-12 mb-4">
            <div className="text-start">
                <p 
                    ...
                    // 🚨 MODIFIED: Applying the requested color instead of 'text-muted' default
            ...
            <div className="px-4 text-start">
                ...
                >
                    ...
                    <div className="row mt-4">
                        ...
                        {/* This section will start immediately below the previous content in the same outer row */}
                    ...
                    <div className="attachments-section mt-4">
                        ...
                        {/* 1. Attachments Header (Now right-aligned to match the file boxes) */}
                        <h5 className="fw-bold mb-3" 
                            style={{ 
                                color: labelTextColor, // Using the new color for this header too
                                width: "62%",
                                marginLeft: "auto", // Aligning the block right
                                textAlign: "right"
                            }}>
                            ...
                            {hasAttachments ? (
                                attachments.map((file, index) => (
                                    <div
                                        ...
                                        style={{ border: '1px solid #f0f0f0', width: '66%', marginLeft: "auto",background:'#00000004' }}
                                    >
