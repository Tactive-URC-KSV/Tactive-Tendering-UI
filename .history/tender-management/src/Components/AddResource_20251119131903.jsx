...
function AddResource() {
    ...
    return (
        <div className="container-fluid min-vh-100">
            ...
            {/* Update all inputs to call handleCalculations onChange */}
            {/* Example: */}
            {/* <input type="number" value={resourceData.coEfficient} onChange={e => handleCalculations({ coEfficient: e.target.value })} /> */}
            {/* Same for rate, additionalRate, shippingPrice, wastePercentage, exchangeRate, etc. */}
            {/* Add button */}
