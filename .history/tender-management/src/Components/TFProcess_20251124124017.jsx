...
{/* 5. ATTACHMENTS - Outer Wrapper (No shadow/border here) */}
<div className="mt-5">
    
    {/* Header for Attachments Section (Always present at the top) */}
    <div className="text-start ms-1 mb-3">
        <Paperclip size={20} color="#005197" /> 
        <span className="ms-2 fw-bold" style={{ color: '#005197' }}>Attachments</span>
    </div>

    {/* Iterate over attachments, creating a separate card for each */}
    {Object.keys(attachments).map((key, index) => {
        ...
        return (
            // 🌟 NEW SEPARATE CONTAINER FOR EACH ATTACHMENT
            <div 
                key={key} 
