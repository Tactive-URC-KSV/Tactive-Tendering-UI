...
import { ArrowLeft, Pencil, Mail, UploadCloud, Calendar } from "lucide-react";
...
function ContractorOverview() {
    ...
    // Tailwind-like or custom classes should be defined in a CSS file, but using inline style for quick demonstration
    ...
    const ManualEntryForm = () => (
        <form onSubmit={handleSubmit}>
            ...
            <div className="bg-light p-3 mb-4 rounded d-flex align-items-center justify-content-center">
                <h3 className="mb-0 fs-6 fw-bold text-dark">Basic Information</h3>
            </div>
            ...
            <div className="row mb-3">
                <div className="col-md-6 mb-3">
                    ...
                    <div className="input-group">
                        <input
                            type="text" // Change to 'date' or keep 'text' with a date picker library for production
                            className="form-control"
                            id="effectiveDate"
                            name="effectiveDate"
                            ...
                            style={{ height: '40px' }}
                        />
                        {/* Calendar Icon Button - Mocking the design from the image */}
                ...
                <div className="col-md-6 mb-3">
                    ...
                    <select
                        ...
                        style={{ height: '40px' }}
                    >
                        {/* The image shows 'Contractor' pre-selected */}
            ...
            <div className="d-flex justify-content-end pt-4 border-top mt-5">
                <button
                    type="button"
                ...
                <button
                    ...
                    style={{ backgroundColor: '#005197', borderColor: '#005197', borderRadius: '6px' }}
                >
                    Submit
                </button>
            </div>
    ...
    return (
        <div className="container-fluid min-vh-100 p-0">
            {/* Header */}
            <div className="d-flex align-items-center py-3 px-4 mb-4 border-bottom">
                <ArrowLeft
                    size={24}
                    className="me-3"
            ...
            <div className="px-4 text-start">
                ...
                {/* Content Card */}
                <div className="card p-4 text-start border-0 shadow-sm">
                    {selectedView === 'manual' ? (
                        <ManualEntryForm />
                    ) : (
                        <div>
                            {/* Content for sending an email invite goes here */}
                            <h4 className="text-primary">Email Invite View Active</h4>
                            <p>Enter the email address and send the onboarding link.</p>
                        </div>
                    )}
                </div>
            </div>
