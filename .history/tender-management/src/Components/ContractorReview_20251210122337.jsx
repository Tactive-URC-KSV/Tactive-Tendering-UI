        ...
        <div className="container-fluid min-vh-100 p-0">
            ...
            <div className="px-4 text-start">
                ...
                >
                    ...
                    {/* --- ATTACHMENTS SECTION (Restored Layout) --- */}
                    {/* Note: This section is now correctly positioned AFTER Address Details */}
                    <div className="attachments-section mt-4 pt-3 border-top" style={{ borderColor: '#f0f0f0' }}>
                        
                        {/* 1. Attachments Header (Aligned right to match previous requirement) */}
                        ...
                        {/* 2. Attachment File List (Right-aligned boxes) */}
