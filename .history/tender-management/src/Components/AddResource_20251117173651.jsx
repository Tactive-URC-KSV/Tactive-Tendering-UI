...
function AddResource() {
    ...
    const customStyles = {
        ...
        // This is still needed for overall component style, even if dropdown arrow is styled inline below
    ...
    const FormSectionContainer = ({ title, icon, defaultOpen = false, children }) => {
        ...
        const HeaderContent = (
            <div className="py-3 px-4 d-flex justify-content-between align-items-center">
                ...
                {/* Blue Arrow for Collapsible Sections */}
            ...
            >
                ...
                <FormSectionContainer title="Basic Information" icon={<span className="text-primary" style={{ fontSize: '1.2em' }}>•</span>}>
                    <div className="row g-3">
                        {/* Resource Type: Field Group Width 80% */}
                        <div className="col-md-6">
                            <div style={{ width: '80%' }}> {/* <--- Wrapper for alignment */}
                        ...
                        {/* Resource Name: Field Group Width 80% */}
                        <div className="col-md-6">
                            <div style={{ width: '80%' }}> {/* <--- Wrapper for alignment */}
                        ...
                        <div className="col-md-6">
                            <div style={{ width: '80%' }}> {/* <--- Wrapper for alignment */}
                                ...
                                <input 
                                    ...
                                    style={{ borderRadius: '0.5rem' }} // Width is now controlled by parent div
                                    placeholder="0.00" 
                                />
                            </div>
                        </div>
                ...
                <FormSectionContainer title="Quantity & Measurements" icon={<AlignLeft size={20} className="text-primary" />}>
                    <div className="row g-3">
                        ...
                        {/* Quantity Type: Field Group Width 80% */}
                        <div className="col-md-6">
                            <div style={{ width: '80%' }}> {/* <--- Wrapper for alignment */}
                        ...
                        {/* Coefficient: Field Group Width 80% */}
                        <div className="col-md-6">
                            <div style={{ width: '80%' }}> {/* <--- Wrapper for alignment */}
                        ...
                        {/* Calculated Quantity: Field Group Width 80% */}
                        <div className="col-md-6">
                            <div style={{ width: '80%' }}> {/* <--- Wrapper for alignment */}
