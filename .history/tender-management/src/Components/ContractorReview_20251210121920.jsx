...
<div className="mt-4 pt-3 border-top">
  ...
  <div className="row mb-4 ps-1">
    <div className="col-md-3 mb-3">
      ...
      <div className="fw-semibold">{contractor.phoneNo}</div>
    </div>

    <div className="col-md-3 mb-3">
      <label className="text-muted small">Email ID</label>
      <div className="fw-semibold">{contractor.email}</div>
    </div>

    <div className="col-md-3 mb-3">
      <label className="text-muted small">Address Type</label>
      <div className="fw-semibold">{contractor.addressType}</div>
    </div>
  </div>
  ...
  <div className="row mb-4 ps-1">
    <div className="col-md-3 mb-3">
      ...
      <div className="fw-semibold">{contractor.address1}</div>
    </div>

    <div className="col-md-3 mb-3">
      <label className="text-muted small">Address 2</label>
      <div className="fw-semibold">{contractor.address2}</div>
    </div>

    <div className="col-md-3 mb-3">
      <label className="text-muted small">Country</label>
      <div className="fw-semibold">{contractor.country}</div>
    </div>

    <div className="col-md-3 mb-3">
      <label className="text-muted small">City</label>
      <div className="fw-semibold">{contractor.city}</div>
    </div>
  </div>
  ...
  <div className="row mb-3 ps-1">
    <div className="col-md-3 mb-3">
      ...
      <div className="fw-semibold">{contractor.zipCode}</div>
    </div>
  </div>
