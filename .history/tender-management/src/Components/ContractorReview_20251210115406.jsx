...
const grayHeader = "#6c757d"; // Requested grey color for the header
        ...
        <div className="container-fluid min-vh-100 p-0">
            ...
            <div className="px-4 text-start">
                ...
                >
                    ...
                    {/* To align the header with 'Entity Type' (the first column of the second row of data), 
                        we place the header in a new row, within the data column structure. */}
                    <div className="row mt-4">
                        
                        {/* LEFT COLUMN (col-lg-4): Empty Placeholder */}
                        <div className="col-lg-4 col-md-12 col-sm-12">
                            {/* This column is empty to push the content starting point to the right. */}
                        </div>

                        {/* RIGHT COLUMN (col-lg-8): Attachments Header and List */}
                        <div className="col-lg-8 col-md-12 col-sm-12">
                            
                            {/* Attachments Header: Starts exactly where the data fields start (col-lg-8's left edge) */}
                            <h5 className="fw-bold mb-3" style={{ color: grayHeader }}>
                                Attachments (Certificates/Licenses)
                            </h5>

                            {/* Attachment File List (Full width of col-lg-8) */}
                            <div className="mt-2">
                                    ...
                                    displayAttachments.map((file, index) => (
                                        <div
                                            ...
                                            style={{
                                                ...
                                                width: "75%", // Maintain the reduced width from the original code
