        ...
        <>
            ...
            <div className="row mb-3">
                ...
                <div className="col-md-6 mb-3">
                    ...
                    <input type="text" className="" id="entityName" name="entityName" value={formData.entityName} onChange={handleChange} placeholder="Enter entity name" style={{ height: "40px" }} />
                </div>
            </div>
            <div className="row mb-3">
                <div className="col-md-6 mb-3">
