...
function AddResource() {
    ...
    return (
        <div className="container-fluid min-vh-100">
                ...
                <div className="row g-3">
                    <div className="col-md-6">
                        ...
                        <div style={{ width: '80%' }}>
                            <Select  options={uomOptions}  value={selectedUom} onChange={setSelectedUom} 
                             styles={customStyles}  placeholder="Select UOM"  className="w-100" />
                        </div>
                    </div>
                    ...
                    <div className="col-md-6">
                        <div style={{ width: '80%' }} className="ms-auto">
                            ...
                            <input type="text" value={resourceData.calculatedQuantity} readOnly className="form-input w-100"/>
                        </div>
                    </div>
                </div>
            </FormSectionContainer>
                ...
                <div className="row g-3">
                    ...
                    <div className="col-md-4">
                        ...
                        <input 
                            ...
                            placeholder="0.00"
                            style={{ borderRadius: "0.5rem" }}
                            value={resourceData.wasteQuantity}
                            readOnly
                        />
                    </div>
                    ...
                    <div className="col-md-4">
                        ...
                        <input 
                            ...
                            placeholder="0.00"
                            style={{ borderRadius: "0.5rem" }}
                            value={resourceData.netQuantity}
                            readOnly
                        />
                    </div>
                </div>
                ...
                <div className="row g-4">
                    <div className="col-md-6">
                        <div className="mb-3">
                            ...
                            <input type="number" className="form-input w-100" placeholder="0.00"
                                style={{ borderRadius: '0.5rem' }} 
            ...
            {/* Cost Summary */}
            <FormSectionContainer title="Cost Summary" icon={<Calculator size={20} className="text-primary" />} defaultOpen={true}>
                <div className="row g-3">
                    <div className="col-md-6">
                        <label className="form-label">Cost Unit Rate</label>
                        <input type="text" className="form-input w-100" value={resourceData.costUnitRate} readOnly />
                    </div>

                    <div className="col-md-6">
                        <label className="form-label">Total Cost (Company Currency)</label>
                        <input type="text" className="form-input w-100" value={resourceData.totalCostCompanyCurrency} readOnly />
                    </div>

                    <div className="col-md-6">
                        <label className="form-label">Resource Total Cost</label>
                        <input type="text" className="form-input w-100" value={resourceData.resourceTotalCost} readOnly />
                    </div>
                </div>
            </FormSectionContainer>
