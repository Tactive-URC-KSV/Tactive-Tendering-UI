...
/**
 * A reusable component to display a label-value pair in the review screen.
 */
const DetailItem = ({ label, value }) => {
    // Treat null/undefined/empty string as missing data for display purposes
    const isValuePresent = value !== undefined && value !== null && String(value).trim() !== '';
    const displayValue = isValuePresent ? value : '\u00A0'; // Non-breaking space for empty fields
    ...
    return (
        <div className="col-lg-4 col-md-6 col-sm-12 mb-3">
            ...
            <p
                className={`detail-value ${isValuePresent ? 'fw-bold' : ''}`}
                style={{
                    fontSize: '0.9rem',
                    color: isValuePresent ? '#333' : 'transparent',
                    minHeight: '1.1em', 
                    marginBottom: '0.5rem'
                }}
            >
...
function ContractorReview() {
    ...
    /**
     * Handler to view the selected file.
     * Uses the stored Data URL (file.fileData) to open the file in a new tab.
     */
    ...
    const {
        ...
        natureOfBusiness, grade, attachmentMetadata = [], 
        phoneNo, emailID, addressType, address1, address2,
        country, addresscity, zipCode, contactName, contactPosition, 
        contactPhoneNo, contactEmailID, taxType, territoryType, territory, 
        taxRegNo, taxRegDate, taxAddress1, taxAddress2, taxCity, 
        taxZipCode, taxEmailID, accountHolderName, accountNo, bankName, 
        branchName, bankAddress, additionalInfoType, registrationNo,
    } = formData;
            ...
            <div className="px-4 text-start">
                ...
                <div className="bg-white p-4 mb-4 shadow-sm" style={{ borderRadius: "8px", border: '1px solid #e0e0e0' }}>
                    ...
                    <div className="attachments-section pb-4">
                        <h5 className="fw-bold mb-3" style={{ color: labelTextColor, width: "66%", marginLeft: "auto" }}>
                    ...
                    <div className="pt-4 mt-4" style={{ borderTop: '1px solid #f0f0f0' }}>
                        <div className="row mt-3">
                            <div className="col-lg-4 col-md-12 col-sm-12 mb-4">
                                <h5 className="fw-bold mb-1" style={{ color: bluePrimary }}><MapPin size={18} className="me-2" /> Address Details</h5>
                    ...
                    <div className="pt-4 mt-4" style={{ borderTop: '1px solid #f0f0f0' }}>
                        <div className="row mt-3">
                            <div className="col-lg-4 col-md-12 col-sm-12 mb-4">
                                <h5 className="fw-bold mb-1" style={{ color: bluePrimary }}><User size={18} className="me-2" /> Contact Details</h5>
                    ...
                    <div className="pt-4 mt-4" style={{ borderTop: '1px solid #f0f0f0' }}>
                        <div className="row mt-3">
                            <div className="col-lg-4 col-md-12 col-sm-12 mb-4">
                                <h5 className="fw-bold mb-1" style={{ color: bluePrimary }}><Briefcase size={18} className="me-2" /> Tax Details</h5>
                    ...
                    <div className="pt-4 mt-4" style={{ borderTop: '1px solid #f0f0f0' }}>
                        <div className="row mt-3">
                            <div className="col-lg-4 col-md-12 col-sm-12 mb-4">
                                <h5 className="fw-bold mb-1" style={{ color: bluePrimary }}><DollarSign size={18} className="me-2" /> Bank Accounts</h5>
                    ...
                    <div className="pt-4 mt-4" style={{ borderTop: '1px solid #f0f0f0' }}>
                        <div className="row mt-3">
                            <div className="col-lg-4 col-md-12 col-sm-12 mb-4">
                                <h5 className="fw-bold mb-1" style={{ color: bluePrimary }}><Info size={18} className="me-2" /> Additional Info</h5>
