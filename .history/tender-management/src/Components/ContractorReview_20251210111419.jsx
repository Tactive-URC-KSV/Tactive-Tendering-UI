            ...
            <div className="px-4 text-start">
                ...
                >
                    ...
                    <div className="row mt-4">
                        ...
                        {/* ROW 2: Entity Details and Attachments Header */}
                        <div className="col-lg-4 col-md-12 col-sm-12 mb-4">
                                    ...
                                    attachments.map((file, index) => (
                                        <div
                                            ...
                                            style={{
                                                ...
                                                width: "85%",          // ← Not full width (matches screenshot)
                                                background: "#fafafa" // soft card feel
                                            }}
                                        >
                                            <div className="d-flex align-items-center">
                                                <FileText size={22} className="me-2 text-danger" />
                                                <div>
                                                    <p className="mb-0 fw-medium">{file.name}</p>
                                                    <small className="text-muted">{file.type} • {file.size}</small>
                                                </div>
                                            </div>
                                            <button className="btn btn-sm" style={{ color: bluePrimary }}>
                                                View
                                            </button>
                                        </div>
                                    ))
