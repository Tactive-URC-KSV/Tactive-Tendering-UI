...
import { ArrowLeft, Pencil, Mail, UploadCloud, FileText, Building, PhoneCall, Receipt, Landmark, Info UploadCloud, X} from "lucide-react"; 
...
function ContractorOverview() {
    ...
    <div 
        ...
        style={{ 
            cursor: "pointer", 
            // Ensures the exact look of the dotted line
            border: "2px dashed #a0c3e3", 
        }} 
        // This makes the entire box clickable, triggering the hidden input
    ...
    >
        ...
        <label htmlFor="fileUpload" className="d-block cursor-pointer p-3 m-0">
            {/* Lucide UploadCloud icon with matching color and size */}
            <UploadCloud size={48} className="mb-2 mx-auto" style={{ color: '#6c96b7' }} />
            {/* Primary text matching font weight and color */}
            <p className="mb-1" style={{ color: '#005197', fontWeight: 500 }}>Click to upload or drag and drop</p>
            {/* Secondary text matching file limits */}
            <p className="mb-0 small text-muted">PDF, DOCX up to 10MB</p>
        </label>
    </div>
    {/* --- END OF EXACT ATTACHMENT SECTION --- */}

    {/* Display uploaded files (Ensure you keep your existing logic below this for displaying files) */}
    {uploadedFiles.length > 0 && (
        <div className="mt-3 text-start">
            {/* ... Rest of your uploaded files display logic ... */}
        </div>
    )}
        </>
    );
