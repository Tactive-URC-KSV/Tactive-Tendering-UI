...
import Flatpickr from "react-flatpickr"; // Imported but not used in the manual text input version

// Define the blue color constant outside
const bluePrimary = '#005197';

// --- Placeholder Options (as in your original code) ---
// Note: Keeping these empty as per your request, 
// but in a real app, these should be populated.
...
// ===================================================================
// 1. FORM SECTION COMPONENTS (MOVED OUTSIDE ContractorOverview)
// This is the FIX for the continuous typing issue.
// ===================================================================
            ...
            <div className="col-md-6 mb-3">
                ...
                <div className="input-group">
                    <input
                        ...
                        style={{ height: "40px" }}
                    />
                     {/* Your original code did not include the calendar icon here, keeping it as is */}
                </div>
            </div>
    ...
    <div className="card text-start border-0 shadow-sm mt-4" style={{ borderRadius: "8px", padding: "0 1.5rem 1.5rem 1.5rem" }}>
        ...
        <div className="row"> 
            <div className="col-md-6 mt-3 mb-4"> 
                ...
                <div className="input-group">
                    {/* Flatpickr logic (or just input) must use 'name' for handleChange */}
...
function ContractorOverview() {
    ...
    // Note: Removed redundant emailInviteData state

    const [formData, setFormData] = useState({
        entityCode: '', entityName: '', effectiveDate: '', entityType: '',
        natureOfBusiness: '', grade: '', attachment: null, phoneNo: '', emailID: '',
        ...
        contractorEmailId: '', // For Email Invite form
        contractorName:'',    // For Email Invite form
        contractorMessage:''  // For Email Invite form
    });
    ...
    const handleSelectChange = (selectedOption, actionMeta) => {
        ...
        // Allows clearing the field if supported by Select component behavior
    ...
    const handleSendInvitation = (e) => {
        e.preventDefault();
        // Since Email Invite fields are part of formData now
    ...
    // Note: handleEffectiveDateChange was not used in your original component code, removed for simplicity.
    // const handleEffectiveDateChange = (date) => { setFormData({ ...formData,taxRegDate: date }); };
        ...
        <div className="container-fluid min-vh-100 p-0">
            ...
            <div className="px-4 text-start">
                ...
                <form id="contractorForm" onSubmit={handleSubmit}>
                    ...
                    {/* The child components now need the necessary props (state/handlers) */}
