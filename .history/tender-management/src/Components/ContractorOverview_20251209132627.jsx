            ...
            <div className="px-4 text-start">
                ...
                {selectedView === 'manual' && (
                    <div className="d-flex justify-content-end mt-4">
                        ...
                        <button type="submit" form="contractorForm" className="btn px-4 fw-bold" style={{ backgroundColor: bluePrimary, color: "white", borderRadius: "6px", borderColor: bluePrimary }}>Review & Submit<ArrowRight size={22} color="white" className="ms-2" /></button>
                    </div>
                )}
            </div>
