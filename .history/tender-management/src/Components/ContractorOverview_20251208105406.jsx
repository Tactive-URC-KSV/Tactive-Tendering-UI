    ...
    <form onSubmit={handleSendInvitation} className="p-3">
        ...
        <div className="d-flex align-items-center p-3 rounded"
            ...
            <p className="mb-0 small" style={{ color: "#2563EBCC" }}>
                Invitation link will be sent to the contractor's email address. They'll receive
                a secure link to complete their onboarding process.
            </p>
        </div>

    </form>

    {/* BUTTON NOW OUTSIDE THE FORM */}
