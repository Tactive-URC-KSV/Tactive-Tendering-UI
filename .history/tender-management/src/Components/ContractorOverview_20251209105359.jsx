...
const ManualEntryForm = ({ formData, setFormData, handleChange, handleSelectChange, handleFileChange }) => (
    ...
    <div className="col-12 mt-3">
        ...
        >
            {/* IMPORTANT: 
               1. Added 'multiple' to allow selection of several files.
               2. 'onChange' now calls the handleFileChange function defined above.
            */}
            <input 
                type="file" 
                id="fileUpload" 
        ...
        <div className="d-flex flex-wrap gap-3">
            {formData.attachments && formData.attachments.map((file, index) => (
                <div 
                    ...
                    style={{ 
                        backgroundColor: '#F7F7F7', // Background for the file tag
                        maxWidth: '200px', 
                        overflow: 'hidden',
                        whiteSpace: 'nowrap',
                    }}
...
function ContractorOverview() {
    ...
    const [formData, setFormData] = useState({
        ...
        natureOfBusiness: '', grade: '', attachments: [], phoneNo: '', emailID: '',
