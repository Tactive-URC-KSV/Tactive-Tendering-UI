...
function TFProcess({ projectId }) {
            ...
            <div className="p-2">
                ...
                <div className="col-md-4 col-lg-4">
                    <label className="projectform text-start d-block">Scope of Work</label>
                        <input type="text" className="form-input w-100" placeholder="Enter Scope of Work" value={tenderDetail.scopeOfWork}
    ...
    <           div className="col-md-4 col-lg-4 ">
                    ...
                    <Select options={scopeOptions} isMulti placeholder="Select Scope of Package" className="w-100"
            classNamePrefix="select"
