...
const AddressDetailsContent = ({ formData, handleChange, handleSelectChange }) => (
    <div className="card text-start border-0 shadow-sm mt-4" style={{ borderRadius: "8px", padding: "0 1.5rem 1.5rem 1.5rem" }}>
        ...
        {/* Row 1: Phone No & Email ID (Existing code already had this correct in previous response) */}
        <div className="row"> 
            <div className="col-md-6 mt-3 mb-4">
                ...
                <input type="text" className="form-input w-100" placeholder="Enter Phone No"
                    ...
                    onChange={handleChange} // SIMPLIFIED HANDLER
                />
            </div>
            <div className="col-md-6 mt-3 mb-4">
        ...
        {/* Row 2: Address Type & Address 1 (Your latest input starts here) */}
        <div className="row"> 
            <div className="col-md-6 mt-3 mb-4"> 
                ...
                <Select
                    ...
                    onChange={(selectedOption) => handleSelectChange(selectedOption, { name: 'addressType' })} // CORRECTED SELECT HANDLER
                    classNamePrefix="select"
        ...
        <div className="row"> 
            ...
            <div className="col-md-6 mt-3 mb-4"> 
                ...
                <Select
                    ...
                    onChange={(selectedOption) => handleSelectChange(selectedOption, { name: 'country' })} // CORRECTED SELECT HANDLER
                    classNamePrefix="select"
        ...
        <div className="row">
            <div className="col-md-6 mt-3 mb-4"> 
                ...
                <Select
                    ...
                    onChange={(selectedOption) => handleSelectChange(selectedOption, { name: 'addresscity' })} // CORRECTED SELECT HANDLER
                    classNamePrefix="select"
