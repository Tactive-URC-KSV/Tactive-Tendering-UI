...
/**
 * Email Invite Form
 * **CORRECTED:** Layout, header, placeholders, and added 'message' field.
 */
const EmailInviteForm = ({ formData, handleChange, handleFileChange, bluePrimary }) => (
    <>
        ...
        <div className="d-flex align-items-center mb-4 p-2 rounded" style={{ backgroundColor: '#f0f8ff', borderLeft: `3px solid ${bluePrimary}` }}>
        ...
        {/* Send Invitation Button (Matches image) */}
...
/**
 * Address Details Form (Unchanged)
 */
...
/**
 * Contact Details Form (Unchanged)
 */
...
/**
 * Additional Info Form (Unchanged)
 */
...
const ContractorOverview = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        inviteName: '',
        inviteEmailID: '',
        message: '', // 🔑 ADDED: State for the Message textarea
    });
        ...
        <div className="container-fluid min-vh-100 p-0">
            ...
            <div className="px-4 text-start">
                ...
                <form id="contractorForm" onSubmit={handleSubmit}>
                    ...
                    {/* Additional sections appear only in Manual Entry mode */}
                ...
                {/* Submit/Cancel buttons only for Manual Entry mode */}
                {selectedView === 'manual' && (
                    <div className="d-flex justify-content-end mt-4">
