...
function TFProcess({ projectId }) {
    ...
    // New state for Package Details removal selection
    ...
    const getCurrentDate = () => {
        ...
        // Assuming your original code formats this as YYYY-MM-DD which is standard for ISO. 
        // If your input fields use d-m-Y, you might need a format utility here.
    ...
    // Helper function to navigate on unauthorized access (placeholder)
    ...
    // Scopes are assumed to be fetched via useScope() hook
            ...
            <div className="p-2">
                <div className="text-start ms-1 mt-4 d-flex justify-content-between align-items-center">
                    ...
                    <div className="d-flex gap-2">
                        ...
                        >
                            <X size={18} /> <span className="fw-medium ms-1">Remove ({boqForRemoval.size})</span>
                        </button>
                        <button
                            className="btn btn-sm"
