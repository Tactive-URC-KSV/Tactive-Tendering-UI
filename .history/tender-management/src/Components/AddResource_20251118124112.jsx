...
function AddResource() {
    ...
    const customStyles = {
        control: (provided, state) => ({
            ...
            minHeight: '38px', 
            // Setting width to 100% here allows the outer wrapper div to control the 80% width
            width: '100%', 
        }),
            ...
            >
                ...
                <FormSectionContainer title="Basic Information" icon={<span className="text-primary" style={{ fontSize: '1.2em' }}>•</span>}>
                    <div className="row g-3">
                        ...
                        {/* RIGHT COLUMN FIELD: Nature (Moved Right) */}
                        <div className="col-md-6">
                        ...
                        {/* RIGHT COLUMN FIELD: Rate (Moved Right) */}
                        <div className="col-md-6">
                ...
                <FormSectionContainer title="Quantity & Measurements" icon={<AlignLeft size={20} className="text-primary" />}>
                    <div className="row g-3">
                        ...
                        {/* RIGHT COLUMN FIELD: Quantity Type (Moved Right) */}
                        <div className="col-md-6">
                        ...
                        {/* RIGHT COLUMN FIELD: Calculated Quantity (Moved Right) */}
                        <div className="col-md-6">
                            <label className="form-label">Calculated Quantity <span style={{ color: "red" }}>*</span></label>
                            <input 
                                type="text" 
                                className="form-control ms-auto" 
                                style={{ borderRadius: '0.5rem', width: '80%' }} 
