        ...
        <div className="container-fluid min-vh-100">
            ...
            <div className="ms-3 me-3 bg-white rounded-3 mt-5 p-2" style={{ border: '1px solid #0051973D' }}>
                ...
                <div className="row g-3 ms-2 mt-2 mb-4 me-2 d-flex justify-content-between">
                    ...
                    <div className="col-lg-2 col-md-4 position-relative mt-3.5"> {/* Reduced col-lg width from 4 to 3 for smaller width */}
                        ...
                        <div className="dropdown w-100">
                            ...
                            >
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-chevron-down ms-1" style={{ width: '18px', height: '18px', color: '#005197CC' }}>
