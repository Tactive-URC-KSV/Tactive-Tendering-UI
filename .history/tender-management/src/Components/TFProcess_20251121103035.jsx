...
>
    ...
    // Example Placeholder Definition (Add this near the top of your file)
const Paperclip = ({ size, color }) => (/* SVG or Icon placeholder JSX */);
const ArrowUp = ({ size, color }) => (/* SVG or Icon placeholder JSX */);


const attachmentDetails = () => {
    // Note: This code assumes that 'Paperclip', 'ArrowUp', and 'form-input' styles are defined elsewhere in your component or CSS.
    return (
        <div className="p-2">
            ...
            <div className="row justify-content-start ms-1 mt-4 gap-4">
                ...
                {/* Technical Specification (First row, left) */}
            ...
            <div className="row justify-content-start ms-1 mt-4 gap-4">
                ...
                {/* Commercial Conditions (Second row, left) */}
                <div className="col-md-5 col-lg-5 p-3" style={{ border: '1px dotted #ccc', borderRadius: '8px' }}>
                    <div className="d-flex flex-column align-items-center justify-content-center py-4">
                        <ArrowUp size={30} color="#005197" />
