    ...
    <div className="row g-4">
        <div className="col-md-6">
            ...
            <div className="mb-3">
                ...
                <input type="number" className="form-control" placeholder="0.00"style={{ borderRadius: "0.5rem", maxWidth: "450px"  }} />
            </div>

            <div className="mb-3">
                <label className="form-label text-start w-100"> Currency <span style={{ color: "red" }}>*</span></label>
                <Select options={currencyOptions} styles={customStyles} placeholder="Select Currency" className="w-100" classNamePrefix="select" style={{maxWidth: "450px" }} /> </div>
            </div>
