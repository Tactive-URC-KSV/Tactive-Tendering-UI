...
// Added Info icon (Info) for Additional Info
...
function ContractorReview() {
    ...
    // Using navigate(-1) is what currently causes data loss on the *previous* form.
    // To retain data, the previous component (Form) needs to be updated to capture 
    // and re-use the passed data as suggested in the previous turn.
    ...
    const {
        ...
        branchName,
        bankAddress,
        // NEW ADDITIONAL INFO ADDED HERE
        additionalInfoType,
        registrationNo,
    } = formData;
        ...
        <div className="container-fluid min-vh-100 p-0">
            ...
            <div className="px-4 text-start">
                ...
                <div className="bg-white p-4 mb-4 shadow-sm" style={{ borderRadius: "8px", border: '1px solid #e0e0e0' }}>
                    ...
                    {/* FOOTER BUTTONS */}
                    <div className="d-flex justify-content-end mt-4 pt-3 border-top" style={{ borderColor: '#f0f0f0' }}>
                        <button
                            type="button"
...
// Default export to match the import statement: import ContractorReview from './Components/ContractorReview';
