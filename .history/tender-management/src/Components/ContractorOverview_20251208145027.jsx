...
    // NOTE: The original emailInviteData state is redundant as its values are stored in formData later, 
    // but I'm leaving it commented out to adhere to the request not to change existing flow drastically.
...
        e.preventDefault();
        // Using formData for email invite data as per the form's inputs
...
        const { name, value } = e.target;
        // CORRECTED: Use functional update to ensure scroll stability
