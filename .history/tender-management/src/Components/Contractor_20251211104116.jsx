...
function Contractor() {
    ...
    // === START OF NEW STATE FOR SORT/FILTER DROPDOWN ===
        ...
        <div className="container-fluid min-vh-100 p-0">
            ...
            <div className="ms-3 me-3 pt-3 d-flex justify-content-between align-items-center">
                ...
                <button
                    ...
                    style={{ backgroundColor: bluePrimary, color: "white" }} // Added primary styling 
                >
            ...
            <div className="ms-3 me-3 bg-white rounded-3 mt-4 p-4" style={{ border: '1px solid #0051973D' }}>
                ...
                <div className="row g-3 d-flex justify-content-between">
                    {/* Search Entity Input */}
                    <div className="col-lg-4 col-md-4"> {/* Adjusted column width */}
                    ...
                    {/* === START OF CHANGE: SORT BY DROPDOWN === */}
                    <div className="col-lg-4 col-md-4 position-relative"> {/* Adjusted column width and added position-relative */}
                        <label className="text-start d-block form-label-small" style={{ visibility: 'hidden' }}>Sort</label> {/* Invisible label for alignment */}
                            ...
                            {isSortDropdownOpen && (
                                <div 
                                    ...
                                    style={{ 
                                        ...
                                        right: '0', 
                                        left: 'auto',
                                        minWidth: '180px', // Adjusted to match image appearance
                                        zIndex: 1000 
                                    }}
                                >
                                    ...
                                    {/* Add C Grade, D Grade if needed */}
                                </div>
                            )}
                        </div>
                    </div>
                    {/* === END OF CHANGE: SORT BY DROPDOWN === */}
                </div>
            </div>
