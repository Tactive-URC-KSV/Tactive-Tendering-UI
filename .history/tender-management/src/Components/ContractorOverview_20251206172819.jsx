...
function ContractorOverview() {
   ...
   const ManualEntryForm = () => (
    ...
    <div className="card text-start border-0 shadow-sm mt-4" style={{ borderRadius: "8px", padding: "0 1.5rem 1.5rem 1.5rem" }}>
        ...
        {/* Row 1: Entity Code | Entity Name (Applying improved label/input styling) */}
        <div className="row">
            <div className="col-md-6 mt-3 mb-4">
                {/* Notice the mb-1 on the label and no spacing classes on the input field itself */}
                <label className="projectform text-start d-block mb-1"> 
                ...
                <input type="text" className="form-input w-100" placeholder="Enter Entity Code"
                    ...
                    // Added inline style to fine-tune the border/radius to match the image
        ...
        {/* Row 2: Effective Date (FIXED with FaCalendarAlt & Styling) | Entity Type */}
        <div className="row"> 
            <div className="col-md-6 mt-3 mb-4">
                {/* Label Spacing Adjustment */}
                <label htmlFor="effectiveDate" className="projectform-select text-start d-block mb-1">Effective Date <span style={{ color: 'red' }}>*</span></label> 
                
                {/* Input Group Styling */}
                <div className="input-group" style={{ borderRadius: '8px', border: '1px solid #dee2e6' }}>
                    
                    <input 
                        type="text" 
                        className="form-control border-0" // Remove default border from input itself
                        id="effectiveDate" 
                        name="effectiveDate" 
                        value={formData.effectiveDate} 
                        onChange={handleChange} 
                        placeholder="mm/dd/yy" 
                        style={{ height: "40px", borderRadius: '8px 0 0 8px' }} // Only left radius
                    />
                    
                    {/* FaCalendarAlt ICON used here with background & no border separation */}
                    <span 
                        className="input-group-text bg-white border-0" // Remove default border and ensure white background
                        style={{ height: "40px", borderRadius: '0 8px 8px 0', cursor: 'pointer' }} // Only right radius
                    >
            ...
            <div className="col-md-6 mt-3 mb-4">
                <label htmlFor="entityType" className="projectform-select text-start d-block mb-1">Entity Type <span style={{ color: 'red' }}>*</span></label>
                <Select
                    name="entityType"
                    ...
                    // You need to adjust the Select component's styles (via classNamePrefix or inline) to match border-radius and color
                />
            </div>
        </div>
        
        {/* Row 3: Nature of business | Grade */}
        <div className="row">
            <div className="col-md-6 mt-3 mb-4">
