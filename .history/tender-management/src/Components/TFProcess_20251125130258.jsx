...
const handleRemoveScope = (idToRemove) => {
    ...
    // ... inside your main component function, before the return statement

// Assuming Custom Hiding Components and handleRemoveScope are defined here...
...
return (
    <div className="p-2">
        ...
        {/* 🚨 MODIFIED ROW (Scope of Package - Full Width) 🚨 */}
        ...
        {/* 🚨 NEW ROW (Scope of Work - Forced to new line) 🚨 */}
        <div className="row align-items-center ms-1 mt-5">
            <div className="col-md-4 col-lg-4">
