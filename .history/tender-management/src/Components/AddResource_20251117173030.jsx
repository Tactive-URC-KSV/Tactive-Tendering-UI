...
function AddResource() {
    ...
    const FormSectionContainer = ({ title, icon, defaultOpen = false, children }) => {
        ...
        const HeaderContent = (
            <div className="py-3 px-4 d-flex justify-content-between align-items-center">
                ...
                {!isStatic && <ChevronDown size={20} style={{ color: '#2563EB'}} />}
            </div>
        );
    ...
    {/* 1. Resource Type - NEEDS WRAPPER */}
    <div className="col-md-6">
        <label className="form-label">Resource Type</label>
        <div style={{ width: '80%' }}> {/* <--- ADDED */}
            <Select 
    ...
    {/* 4. Rate - NEEDS INLINE STYLE */}
    <div className="col-md-6">
        <label className="form-label">Rate</label>
        <input 
            type="number" 
            className="form-control" 
            style={{ borderRadius: '0.5rem', width: '80%' }} {/* <--- MODIFIED STYLE */}
            placeholder="0.00" 
        />
    </div>
</div>
