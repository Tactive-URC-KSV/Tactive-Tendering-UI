...
>
        ...
        return (
            <div className="bg-white ms-3 me-3 rounded-3 p-3 mt-5" style={{ border: '1px solid #0051973D' }}>
                ...
                <div className="d-flex justify-content-between align-items-center ms-2 me-2 fw-bold" style={{ borderBottom: '1px solid #0051973D' }}>
                    ...
                    <div className="bg-white rounded-3 p-4 mt-4" style={{ border: '1px solid #0051973D' }}>
    <div className="d-flex justify-content-between align-items-center mb-3">
        <div className="text-start">
            <span className="fw-bold">Attachments</span>
            <div className="text-muted" style={{ fontSize: '14px' }}>
                Upload any supporting documents for this tender
            </div>
        </div>

        <label className="btn px-3 py-1 rounded-5 d-flex align-items-center"
            style={{ backgroundColor: '#DBEAFE', color: '#005197', cursor: 'pointer' }}>
        ...
        <div className="mt-3">
            {attachments.map((file, index) => (
                <div key={index}
                    ...
                    <div className="d-flex align-items-center">
                        <Paperclip size={18} className="me-2" color="#005197" />
    ...
    {attachments.length === 0 && (
        <div className="text-muted text-center p-3" style={{ fontSize: '14px' }}>
