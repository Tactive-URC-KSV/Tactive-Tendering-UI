...
    });
    ...
    // This handler already uses the functional update pattern (prev => {...})
...
                />
            </div> 
{/* END OF PART 1/2 OF THE ADDRESS DETAILS SECTION */}
{/* BEGINNING OF PART 2/2 OF THE ADDRESS DETAILS SECTION */}
        </div>
        <div className="row"> 
            <div className="col-md-6 mt-3 mb-4"> 
...
                    onChange={(e) => setFormData(prev => ({ ...prev, contactPhoneNo: e.target.value }))}
...
                    onChange={(e) => setFormData(prev => ({ ...prev, contactEmailID: e.target.value }))}
...
                    onChange={(e) => setFormData(prev => ({ ...prev, taxRegNo: e.target.value }))}
...
                    onChange={(e) => setFormData(prev => ({ ...prev, taxAddress1: e.target.value }))}
...
                    onChange={(e) => setFormData(prev => ({ ...prev, taxAddress2: e.target.value }))}
...
                    onChange={(e) => setFormData(prev => ({ ...prev, taxZipCode: e.target.value }))}
...
                    onChange={(e) => setFormData(prev => ({ ...prev, taxEmailID: e.target.value }))}
