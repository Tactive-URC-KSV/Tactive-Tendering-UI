...
import { ArrowLeft, Plus, Copy,  EditIcon, Trash2, IndianRupee, BadgeDollarSign, ClipboardPaste, Table, LayoutGridGrid} from "lucide-react";
...
<div className="btn-group me-2" role="group" aria-label="View switch">
  ...
  <button
    ...
    onClick={() => setViewType('Layoutgrid')}
    style={{
