...
function TFProcess({ projectId }) {
    ...
    const CustomMultiValueContainer = () => null; // Hides selected tags inside the box
const CustomDropdownIndicator = () => null;  // Hides the dropdown arrow
const CustomIndicatorSeparator = () => null; // Hides the vertical separator line
const CustomClearIndicator = () => null;
// Example of the removal handler (adjust to match your state variable name)
const handleRemoveScope = (idToRemove) => {
    // This updates the state by filtering out the removed item
    ...
    <div className="p-2">
        ...
        {/* Row 1: Tender No, Tender Date, Project Name */}
        ...
        {/* Row 2: Offer Submission Mode, Bid Opening Date, Submission Last Date */}
        <div className="row align-items-center justify-content-between ms-1 mt-5">
            <div className="col-md-4 col-lg-4">
        ...
        {/* Row 3: Contact Person, Contact Email, Contact Number */}
        <div className="row align-items-center justify-content-between ms-1 mt-5">
            <div className="col-md-4 col-lg-4 ">
        ...
        {/* 🚨 MODIFIED ROW: Scope of Work is now first, Scope of Package is last and full-width 🚨 */}
        <div className="row align-items-center ms-1 mt-5">
            
            {/* 1. Scope of Work (Moved to the first position) */}
            <div className="col-md-4 col-lg-4">
            ...
            {/* 2. Scope of Package (Moved to the second position and made full width) */}
            <div className="col-12 mt-4"> {/* 🚨 col-12 for full width, mt-4 adds vertical spacing 🚨 */}
                <div className="row"> {/* Use inner row to maintain indentation and alignment */}
                    <div className="col-md-4 col-lg-4 p-0"> {/* Use col-md-4 inside the col-12 container */}
                        ...
                        />
                        {/* EXTERNAL TAGS DISPLAY */}
                        <div className="mt-2 d-flex flex-wrap gap-2">
                            {scopeOptions 
                                .filter(opt => selectedScopes.includes(opt.value))
                                .map(selectedOpt => (
