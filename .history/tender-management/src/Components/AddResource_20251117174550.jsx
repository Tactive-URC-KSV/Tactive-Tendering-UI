            ...
            >
                <FormSectionContainer title="Basic Information" icon={<span className="text-primary" style={{ fontSize: '1.2em' }}>•</span>}>
                    <div className="row g-3">
                        ...
                        <div className="col-md-6">
    {/* NEW Wrapper with margin-left: auto to push the 80% block to the right */}
    <div style={{ width: '80%', marginLeft: 'auto' }}> 
        <label className="form-label">Rate</label>
        <input 
            type="number" 
            className="form-control" 
            style={{ borderRadius: '0.5rem' }} // Width is now controlled by the parent div, so we remove width: '80%' from here.
            placeholder="0.00" 
        />
    </div>
</div>
