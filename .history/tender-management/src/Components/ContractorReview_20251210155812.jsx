...
function ContractorReview() {
    ...
    const {
        ...
        natureOfBusiness,
        grade,
        attachmentMetadata = [], // <<< NEW: Use the persistent metadata array
        phoneNo,
        emailId,
        addressType,
        address1,
    ...
    return (
        ...
        {hasAttachments ? (
            // Use the metadata array for the loop
            attachmentMetadata.map((file, index) => (
                    ...
                    {/* Access size and lastModified, or use placeholder if type is not stored */}
