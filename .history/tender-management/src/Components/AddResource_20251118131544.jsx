...
function AddResource() {
    ...
    // --- CORRECTED FormSectionContainer TO ENSURE CONTINUOUS BORDERS FOR STATIC SECTIONS ---
    const FormSectionContainer = ({ title, icon, defaultOpen = false, children }) => {
        ...
        // Header Style: Top borders and rounding (if static, no bottom border/margin)
        const headerStyle = {
        ...
        // Content Style: Side/bottom borders and bottom rounding (if static, no top margin)
        const contentStyle = { 
            padding: '1rem 1.5rem', 
    ...
    return (
        <div className="container-fluid min-vh-100">
            ...
            {/* --- BOQ Summary Container (Top Rounded Corners) --- */}
            <div 
                ...
                style={{ 
                    ...
                    borderRadius: '0.5rem 0.5rem 0 0', // Ensures rounded top corners
                }} 
            >
                <div className="d-flex align-items-center">
            ...
            >
                ...
                {/* Wastage & Net Quantity (Collapsible) */}
