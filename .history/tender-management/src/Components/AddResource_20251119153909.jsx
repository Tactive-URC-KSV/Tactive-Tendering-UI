...
// Assume UomContext is correctly structured and exported
...
function AddResource() {
    ...
    // --- TEMPORARY / MOCKED BOQ DATA ---
    // NOTE: I am providing default values for boqUOM and boqTotalQuantity
    // which were empty strings in your original code, to make calculations possible.
    ...
    // Resource data state (Initial state for form and calculation)
    const [resourceData, setResourceData] = useState({
        coEfficient: 1, // Start at 1 for calculation
        ...
        resourceTotalCost: 0,
        rateLock: false,
        exchangeRate: 1, // Start at 1 for calculation
        ...
        currencyId: "",
        resourceId: "",
        boqId: "mock_boq_id", // Mocked ID
        projectId: "mock_project_id" // Mocked ID
    });
