...
const DetailItem = ({ label, value }) => {
    ...
    return (
        // mb-4 -> mb-3 (Slightly less space between rows)
        <div className="col-lg-4 col-md-6 col-sm-12 mb-3">
            <div className="text-start">
                <p 
                    // mb-1 -> mb-0 (Remove margin between label and value)
        ...
        <div className="container-fluid min-vh-100 p-0">
            ...
            <div className="px-4 text-start">
                ...
                >
                    ...
                    {/* ATTACHMENTS SECTION */}
                    {/* *** CHANGE 1: Removed border-top here to make the line appear below this section *** */}
                    <div className="attachments-section ">
                        ...
                        {/* List Container for Attachments */}
                    ...
                    {/* BUTTONS/FOOTER */}
                    {/* *** CHANGE 2: Kept border-top here. This border now appears AFTER the attachments section. *** */}
