 ...
 * Maintains vertical height when the value is empty by using a transparent non-breaking space.
 */
const DetailItem = ({ label, value }) => {
    // If value is missing/empty, use a non-breaking space (\u00A0) to preserve line height.
        ...
        <div className="col-lg-4 col-md-6 col-sm-12 mb-4">
            <div className="text-start">
                ...
                <p 
                    ...
                    style={{ 
                        fontSize: '0.9rem', 
                        color: value ? '#333' : 'transparent', // Ensures empty field looks truly empty
                        minHeight: '1.2em' 
                    }}
                >
                    {displayValue}
...
function ContractorReview() {
    ...
    // Determine the attachment display state
            ...
            <div className="px-4 text-start">
                ...
                >
                    ...
                    <div className="row mt-4">
                        ...
                        {/* --- VISUAL ROW 1: BASIC INFORMATION (Header + Data) --- */}
                        ...
                        {/* --- VISUAL ROW 2: ATTACHMENTS (Header) & ENTITY DETAILS (Data) --- */}

                        {/* C. Left Header Column: "Attachments" */}
                        {/* This header is what pushes the Entity Type/Nature/Grade to the right */}
                        <div className="col-lg-4 col-md-12 col-sm-12 mb-4">
                            <h5 className="fw-bold mb-1" style={{ color: bluePrimary }}>Attachments (Certificates/Licenses)</h5>
                            {/* No additional descriptive text here */}
                        </div>
                    ...
                    {/* === END: BASIC INFORMATION & ATTACHMENTS GRID === */}
                    
                    <hr className="my-4" style={{ borderColor: '#f0f0f0' }} />

                    {/* 3. Attachment File List (Full Width, below the grid, matching the list/card design) */}
                    <div className="attachment-file-list mt-3 px-3">
                        {hasAttachments ? (
                                ...
                                <div key={index} className="d-flex justify-content-between align-items-center p-3 rounded mb-2" style={{ border: '1px solid #f0f0f0' }}>
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            {/* Note: In a real app, you'd calculate type/size dynamically */}
                            ...
                            // Empty state display for attachments, as seen in image_1761f3.png
