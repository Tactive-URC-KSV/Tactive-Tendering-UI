...
function Contractor() {
    ...
    // === FINAL MODIFIED: HELPER COMPONENT FOR EXACT VISUAL MATCH (All Blue) ===
            ...
            >
                <input
                    ...
                    style={{ 
                        cursor: 'pointer', 
                        marginRight: '8px', 
                        // Color of the checkmark/fill when selected
                        accentColor: bluePrimary, 
                        transform: 'scale(1.05)',
                        // Set the border color to bluePrimary (or a light shade of it) always, 
                        // even when NOT selected, to match the image.
                        border: `1px solid ${bluePrimary}99`, // Soft blue border always
                        borderRadius: '3px', 
                    }}
                />
                <span 
        ...
        <div className="container-fluid min-vh-100">
            ...
            <div className="ms-3 me-3 bg-white rounded-3 mt-5 p-2" style={{ border: '1px solid #0051973D' }}>
                ...
                <div className="row g-3 ms-2 mt-2 mb-4 me-2 d-flex justify-content-between">
                    ...
                    {/* === SORT BY FIELD: LIGHT BLUE BUTTON, NARROW WIDTH, AND PUSHED DOWN (mt-3) === */}
