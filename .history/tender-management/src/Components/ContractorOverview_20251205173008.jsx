        ...
        <div className="card text-start border-0 shadow-sm mt-4" style={{ borderRadius: "8px", padding: "0 1.5rem 1.5rem 1.5rem" }}>
            ...
            <div className="row mb-3">
                ...
                <div className="col-md-6 mb-3">
                    ...
                    <input type="text" className="" id="taxRegNo" name="taxRegNo" value={formData.taxRegNo} onChange={handleChange} placeholder="Enter tax registration no" style={{ height: "40px" }} />
                </div>
            </div>
            <div className="row mb-3">
                <div className="col-md-6 mb-3">
