...
>
    ...
    <div className="d-flex flex-column" style={{ color: '#FFFFFF' }}>
        ...
        <div className="d-flex gap-5 mb-2"> 
            {/* Total Packages */}
            <div style={{ fontSize: '14px', width: '200px' }}> {/* Width helps align columns */}
                Total Packages: <span className="fw-bold" style={{ color: '#FFC107' }}>{boqArray.length > 0 ? 1 : 0}</span>
            </div> 

            {/* Selected Contractors */}
            <div style={{ fontSize: '14px', width: '200px' }}>
                Selected Contractors: <span className="fw-bold" style={{ color: '#FFC107' }}>{contractorsList.length}</span>
            </div>
        </div>
        ...
        <div className="d-flex gap-5">
            {/* Attachments */}
            <div style={{ fontSize: '14px', width: '200px' }}>
                Attachments: <span className="fw-bold" style={{ color: '#FFC107' }}>{Object.keys(attachments).filter(key => attachments[key].files?.length > 0 || attachments[key].notes).length}</span>
            </div>

            {/* Submission Deadline */}
            <div style={{ fontSize: '14px', width: '200px' }}>
                Submission Deadline: 
                <span className="fw-bold" style={{ color: tenderDetail.offerSubmissionDate ? '#FFC107' : '#dc3545' }}>
