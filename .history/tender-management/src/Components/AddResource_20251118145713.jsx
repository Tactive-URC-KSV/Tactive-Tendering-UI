...
function AddResource() {
    ...
    return (
        <div className="container-fluid min-vh-100">
            ...
            <div 
    className="text-white p-3 d-flex justify-content-between align-items-center ms-3 me-3" 
    style={{ 
        maxWidth: '100%', // Allow it to fill the width dictated by ms-3 me-3
        // REMOVED: marginLeft: 'auto',
        background: `linear-gradient(to right, ${darkBlue}, ${vibrantBlue})`, 
        borderRadius: '0.5rem 0.5rem 0 0', // Top rounded, bottom square for seamless connection
    }} 
>
                <div className="d-flex align-items-center">
