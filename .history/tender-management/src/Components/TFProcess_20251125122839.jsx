    ...
    <div className="d-flex flex-wrap gap-2 mt-1">
        {Array.isArray(tenderDetail.scopeOfPackage) && tenderDetail.scopeOfPackage.length > 0 ? (
            tenderDetail.scopeOfPackage.map((scopeId, index) => {
                ...
                return (
                    // 🚨 USE CUSTOM DISPLAY CLASS INSTEAD OF BOOTSTRAP BADGE 🚨
                    <span key={index} 
                          className="read-only-scope-tag p-2"
                          style={{ backgroundColor: '#EAF2FE', color: '#2563EBCC', fontSize: '14px', borderRadius: '15px', cursor: 'default' }}>
