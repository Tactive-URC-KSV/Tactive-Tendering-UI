    ...
    <div className="row g-4 ms-1">
        ...
        <div className="col-md-4 text-start">
            ...
            <span 
                ...
                style={{ color: '#dc3545' }} 
            >
                {/* 🌟 UPDATED DATE FORMATTING FOR SUBMISSION DATE */}
        ...
        <div className="col-md-4 text-start">
            ...
            <span className="fw-medium">
                {/* 🌟 UPDATED DATE FORMATTING FOR BID OPENING DATE */}
...
{/* End of Card 2 */}
    ...
    <div className="table-responsive ms-1 me-1">
        <table className="table table-borderless"> {/* <-- REMOVED table-striped here */}
            <thead style={{ color: '#b0b5b9ff', borderBottom: '2px solid #0051973D' }}>
                <tr>
