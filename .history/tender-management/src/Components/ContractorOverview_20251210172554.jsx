...
const defaultFormData = {
    entityCode: '', entityName: '', effectiveDate: '', 
    entityType: null, // <--- CHANGED
    natureOfBusiness: null, // <--- CHANGED
    grade: null, // <--- CHANGED
    attachments: [], 
    phoneNo: '', emailID: '',
    addressType: null, // <--- CHANGED
    address1: '', address2: '', country: null, addresscity: null, zipCode: '', // <--- CHANGED
    contactName: '', contactPosition: null, contactPhoneNo: '', contactEmailID: '', // <--- CHANGED
    taxType: null, territoryType: null, territory: null, taxRegNo: '', taxRegDate: '', // <--- CHANGED
    taxAddress1: '', taxAddress2: '', taxCity: null, taxZipCode: '', taxEmailID: '', // <--- CHANGED
    accountHolderName: '', accountNo: '', bankName: '', branchName: '', bankAddress: '',
    additionalInfoType: null, registrationNo: '', // <--- CHANGED
    contractorEmailId: '', 
    contractorName:'', 
    contractorMessage:'',
    attachmentMetadata: [] 
...
const [formData, setFormData] = useState(loadFormData());
    ...
    // NEW CODE (Stores the entire selected option object: { value: '...', label: '...' })
const handleSelectChange = (selectedOption, actionMeta) => {
    const { name } = actionMeta;
    // Store the entire object or null/empty object if nothing is selected
    setFormData(prev => ({ 
        ...prev, 
