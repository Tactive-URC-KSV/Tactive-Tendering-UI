...
<div className="mt-5 mb-5">
    ...
    {/* 1. TENDER SUMMARY BOX (Single Vertical Divider) */}
    <div 
    ...
    >
        ...
        {/* Box Header: Tender Summary */}
        <div className="mb-3 fw-bold" style={{ color: '#005197' }}> 
            Tender Summary
        </div>
        ...
        <div className="d-flex flex-column" style={{ color: '#005197', fontSize: '14px' }}> 
            ...
            <div className="d-flex mb-2"> 
                {/* Total Packages - LEFT COLUMN (Has Vertical Separator) */}
                <div 
                    className="d-flex justify-content-between pe-4" 
                    style={{ 
                        width: '50%', 
                        // Simplified border style: apply border, but remove padding/margin that causes gap
                ...
                {/* Selected Contractors - RIGHT COLUMN (Only apply left padding) */}
            ...
            <div className="d-flex">
                ...
                {/* Submission Deadline - RIGHT COLUMN (Only apply left padding) */}
                <div className="d-flex justify-content-between ps-4" style={{ width: '50%' }}>
