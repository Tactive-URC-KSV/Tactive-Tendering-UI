...
<div className="p-4 mt-5 bg-white rounded-3" style={{ border: '1px solid #e0e0e0', boxShadow: '0 2px 4px rgba(0,0,0,.05)' }}>
    ...
    {/* Content Area - This container holds the list of shaded blocks */}
    <div className="ms-1 me-1">
        {Object.keys(attachments).map((key, index) => {
            ...
            return (
                // 🌟 Individual Shaded Block for Each Attachment
                <div 
                    key={key} 
                    className="p-3 rounded-3 mb-3" // mb-3 adds space between blocks
                    style={{ 
                        backgroundColor: '#FAFAFA', // Requested light gray background
                    }}
                >
                    <div className="d-flex justify-content-between align-items-start">
                        ...
                        <div className="text-start me-4 flex-grow-1">
                            ...
                            {/* 2. File Type and Size (Red Color - Figma style) */}
                            {fileInfo ? (
                                ...
                                <span className="text-muted" style={{ fontSize: '13px', color: '#00000080' }}>No file uploaded</span>
                            )}
