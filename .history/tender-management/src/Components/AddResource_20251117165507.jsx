...
function AddResource() {
    ...
    // --- Placeholder Options for React Select ---
    const resourceTypeOptions = [
        { value: 'labor', label: 'Labor' },
        { value: 'material', label: 'Material' },
        { value: 'equipment', label: 'Equipment' },
    ];
    const emptyOption = [{ value: '', label: '' }]; // For empty placeholders

    // --- React Select Custom Styles to Match Rounded Corners ---
    const customStyles = {
        control: (provided, state) => ({
            ...provided,
            borderRadius: '0.5rem', // Match the form input rounding
            borderColor: state.isFocused ? darkBlue : provided.borderColor, // Blue border on focus
            boxShadow: state.isFocused ? `0 0 0 0.25rem rgba(0, 81, 151, 0.25)` : provided.boxShadow, // Custom focus shadow
            minHeight: '38px', // Ensure standard input height
        }),
    ...
    // Reusable component for the styled vertical containers (remains unchanged)
            ...
            >
                ...
                <FormSectionContainer title="Basic Information" icon={<span className="text-primary" style={{ fontSize: '1.2em' }}>•</span>}>
                    <div className="row g-3">
                        {/* Resource Type - Using React Select */}
                        ...
                        {/* Resource Name - Using React Select */}
                        <div className="col-md-6">
                ...
                <FormSectionContainer title="Quantity & Measurements" icon={<AlignLeft size={20} className="text-primary" />}>
                    <div className="row g-3">
                        ...
                        {/* Quantity Type - Using React Select */}
                        <div className="col-md-6">
                        ...
                        {/* Coefficient - Standard Input */}
                        <div className="col-md-6">
                            <label className="form-label">Coefficient</label>
                            <input type="number" className="form-control" style={{ borderRadius: '0.5rem' }} placeholder="0.00" />
                        </div>
                        {/* Calculated Quantity - Standard Input */}
                        <div className="col-md-6">
