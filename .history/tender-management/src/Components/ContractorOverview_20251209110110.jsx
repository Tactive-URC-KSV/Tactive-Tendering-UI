...
// --- Placeholder Options (Kept for completeness) ---
...
// Components defined outside ContractorOverview (Good practice, prevents re-creation)
    ...
    <>
        ...
        <div className="row mb-4">
            <div className="col-12 mt-3">
                ...
                >
                    {/* IMPORTANT: Added 'multiple' attribute and using handleFileChange */}
                    <input 
                        type="file" 
                        id="fileUpload" 
                        name="attachments" 
                ...
                <div className="d-flex flex-wrap gap-3">
                    {formData.attachments && formData.attachments.map((file, index) => (
                        <div 
                            key={index} // Using index is acceptable for non-reorderable lists
                        ...
                        >
                            ...
                            <button 
                                type="button" 
                                className="btn-close ms-auto" // ms-auto pushes button to the right
...
function ContractorOverview() {
    ...
    // --- REVISED STATE: attachment is now 'attachments' (array) ---
    const [formData, setFormData] = useState({
        entityCode: '', entityName: '', effectiveDate: '', entityType: '',
        natureOfBusiness: '', grade: '', 
        attachments: [], // CHANGED from 'attachment: null'
        phoneNo: '', emailID: '',
    ...
    // --- REVISED HANDLER: Adds multiple files and prevents re-trigger on same file ---
    ...
    // --- NEW HANDLER: Removes a file by name ---
                    ...
                    <div className="card text-start border-0 shadow-sm" style={{ borderRadius: "8px", padding: selectedView === 'manual' ? "0 1.5rem 1.5rem 1.5rem" : "1.5rem" }}>
                        {selectedView === 'manual' ? 
                            <ManualEntryForm 
                                ...
                                handleRemoveFile={handleRemoveFile} // Passed the new handler
                            /> 
                            : 
                            <EmailInviteForm 
                                formData={formData} 
