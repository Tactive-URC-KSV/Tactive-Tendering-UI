            ...
            <div className="row mb-4">
                <div className="col-md-6 mt-3 mb-4">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Enter Contractor Email ID"
                            ...
                            onChange={(e) => setFormData({ ...project, ContractorEmailId: e.target.value })}
                   ...
                   <div className="col-md-6 mt-3 mb-4">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Enter Contractor Name"
                            ...
                            onChange={(e) => setFormData({ ...project, ContractorName: e.target.value })}
                ...
                <div className="col-md-12 mt-3 mb-4">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Add a personalized message..."
                            ...
                            onChange={(e) => setFormData({ ...project, ContractorMessage: e.target.value })}
            ...
            <div className="row mb-3">
                <div className="col-md-6 mt-3 mb-4">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Enter Entity Code"
                            ...
                            onChange={(e) => setFormData({ ...project, EntityCode: e.target.value })}
                ...
                <div className="col-md-6 mt-3 mb-4">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Enter Entity Name"
                            ...
                            onChange={(e) => setFormData({ ...project, EntityName: e.target.value })}
            ...
            <div className="row mb-3">
               <div className="col-md-6 mt-3 mb-4">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Enter Phone No"
                            ...
                            onChange={(e) => setFormData({ ...project, PhoneNo: e.target.value })}
                ...
                <div className="col-md-6 mt-3 mb-4">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Enter Email ID"
                            ...
                            onChange={(e) => setFormData({ ...project, EmailId: e.target.value })}
                ...
                <div className="col-md-6 mb-3">
                   ...
                   <div className="col-md-6 mt-3 mb-4">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Enter Address 1"
                            ...
                            onChange={(e) => setFormData({ ...project, Address1: e.target.value })}
            ...
            <div className="row mb-3">
                 <div className="col-md-6 mt-3 mb-4">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Enter Address 2"
                            ...
                            onChange={(e) => setFormData({ ...project, Address2: e.target.value })}
            ...
            <div className="row mb-4">
                ...
                <div className="col-md-6 mt-3 mb-4">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Enter Zip/Postal Code"
                            ...
                            onChange={(e) => setFormData({ ...project, ZipCode: e.target.value })}
            ...
            <div className="row mb-4">
                    <div className="col-md-6 mt-3 mb-4">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Enter contact name"
                            ...
                            onChange={(e) => setFormData({ ...project, ContactName: e.target.value })}
            ...
            <div className="row mb-3">
                  <div className="col-md-6 mt-3 mb-4">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Enter Phone No"
                            ...
                            onChange={(e) => setFormData({ ...project, ContactPhoneNo: e.target.value })}
                 ...
                 <div className="col-md-6 mt-3 mb-4">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Enter Email ID"
                            ...
                            onChange={(e) => setFormData({ ...project, ContactEmailId: e.target.value })}
            ...
            <div className="row mb-3">
               ...
               <div className="col-md-6 mt-3 mb-4">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Enter tax registration no"
                            ...
                            onChange={(e) => setFormData({ ...project, TaxRegNo: e.target.value })}
                ...
                <div className="col-md-6 mb-3">
                    ...
                    <div className="col-md-6 mt-3 mb-4">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Enter Address 1"
                            ...
                            onChange={(e) => setFormData({ ...project, TaxAddress1: e.target.value })}
            ...
            <div className="row mb-3">
                 <div className="col-md-6 mt-3 mb-4">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Enter Address 2"
                            ...
                            onChange={(e) => setFormData({ ...project, TaxAddress2: e.target.value })}
            ...
            <div className="row mb-4">
                <div className="col-md-6 mt-3 mb-4">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Enter Zip/Postal Code"
                            ...
                            onChange={(e) => setFormData({ ...project, TaxZipCode: e.target.value })}
                ...
                <div className="col-md-6 mt-3 mb-4">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Enter Email ID"
                            ...
                            onChange={(e) => setFormData({ ...project, TaxEmailId: e.target.value })}
            ...
            <div className="row mb-3">
                  <div className="col-md-6 mt-3 mb-4">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Enter Account Holder Name"
                            ...
                            onChange={(e) => setFormData({ ...project, AccountHolderName: e.target.value })}
                   ...
                   <div className="col-md-6 mt-3 mb-4">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Enter Account No"
                            ...
                            onChange={(e) => setFormData({ ...project, AccountNo: e.target.value })}
            ...
            <div className="row mb-3">
                 <div className="col-md-6 mt-3 mb-4">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Enter Bank Name"
                            ...
                            onChange={(e) => setFormData({ ...project, BankName: e.target.value })}
                   ...
                   <div className="col-md-6 mt-3 mb-4">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Enter Branch Name"
                            ...
                            onChange={(e) => setFormData({ ...project, BranchName: e.target.value })}
            ...
            <div className="row mb-4">
                  <div className="col-md-6 mt-3 mb-4">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Enter Bank Address"
                            ...
                            onChange={(e) => setFormData({ ...project, BankAddress: e.target.value })}
                   ...
                   <Select
                    ...
                    <div className="col-md-6 mt-3 mb-4">
                        ...
                        <input type="text" className="form-input w-100" placeholder="Enter Registration No"
                            ...
                            onChange={(e) => setFormData({ ...project, RegistrationNo: e.target.value })}
