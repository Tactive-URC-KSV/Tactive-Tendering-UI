...
<div className="mt-5 mb-5">
    ...
    >
        ...
        {/* Box Header: Tender Summary (Centered Separately) */}
        <div className="mb-3 text-center fw-bold" style={{ color: '#005197' }}> 
            Tender Summary
        </div>
        ...
        <div className="d-flex flex-column" style={{ color: '#005197', fontSize: '14px' }}> 
            ...
            <div className="d-flex mb-2"> 
                {/* Total Packages - LEFT COLUMN (FIX: Reduced padding around border) */}
                <div 
                    className="d-flex justify-content-between pe-3" // Reduced padding from pe-4 to pe-3
                    style={{ 
                        width: '50%', 
                ...
                {/* Selected Contractors - RIGHT COLUMN (FIX: Reduced padding from ps-4 to ps-3) */}
                <div className="d-flex justify-content-between ps-3" style={{ width: '50%' }}>
            ...
            <div className="d-flex">
                {/* Attachments - LEFT COLUMN (FIX: Reduced padding around border) */}
                <div 
                    className="d-flex justify-content-between pe-3" // Reduced padding from pe-4 to pe-3
                    style={{ 
                        width: '50%',
                ...
                {/* Submission Deadline - RIGHT COLUMN (FIX: Reduced padding from ps-4 to ps-3) */}
                <div className="d-flex justify-content-between ps-3" style={{ width: '50%' }}>
