...
function ContractorOverview() {
    ...
    const [formData, setFormData] = useState({
        ...
        entityName: '',
        effectiveDate: '',
        entityType: 'Contractor', // Default value must match option value
        natureOfBusiness: '',
        grade: '',
        attachment: null,
        phoneNo: '', 
    ...
    // 4. NEW HANDLER FOR REACT SELECT: Handles objects instead of native event
    ...
    // 2. OPTIONS ARRAY FOR REACT SELECT (Entity Type)
                ...
                <div className="col-md-6 mb-3">
                    ...
                    <Select
                        ...
                        styles={{
                            ...
                            // Optional: to match Bootstrap/custom styles better
    ...
    const AddressDetailsContent = () => (
        <div className="card text-start border-0 shadow-sm mt-4" style={{ borderRadius: "8px", padding: "0 1.5rem 1.5rem 1.5rem" }}>
            ...
            <div className="row mb-3">
                <div className="col-md-6 mb-3">
                    <label htmlFor="addressType" className="">Address Type</label>
