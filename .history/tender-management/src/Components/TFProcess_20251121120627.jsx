            ...
            <div className="row mt-4">
                {attachmentTypes.map((item) => (
                    <div className="col-md-6 mb-4" key={item.key}>
                        ...
                        {/* Upload Box using YOUR CLASS NAME */}
                        <div className="upload-file row p-3 ms-auto me-auto bg-white rounded">
                            ...
                            {/* Subtitle */}
                            <div className="col-12 text-center mt-1 small text-muted">
                        ...
                        {attachments[item.key].files.length > 0 && (
                            <div className="mt-3 px-3 text-start">
                                <div className="row g-3">
                                    {attachments[item.key].files.map((file, idx) => (
