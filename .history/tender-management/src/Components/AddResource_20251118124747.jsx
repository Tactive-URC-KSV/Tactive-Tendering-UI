...
function AddResource() {
    ...
    const customStyles = {
        control: (provided, state) => ({
            ...
            minHeight: '38px', 
            // Ensures the Select component fills the 80% width wrapper
            width: '100%', 
        }),
            ...
            >
                <FormSectionContainer title="Basic Information" icon={<span className="text-primary" style={{ fontSize: '1.2em' }}>•</span>}>
                    <div className="row g-3">
                        {/* LEFT COLUMN: Resource Type (Label and Input Wrapper changed) */}
                        <div className="col-md-6">
                            <label className="form-label **text-end** w-100">Resource Type <span style={{ color: "red" }}>*</span></label>
                        ...
                        {/* RIGHT COLUMN: Nature (Label and Input Wrapper changed) */}
                        <div className="col-md-6">
                            <label className="form-label **text-end** w-100">Nature <span style={{ color: "red" }}>*</span></label>
                            <div style={{ width: '80%' }} className="ms-auto">
                                <Select 
                                    options={emptyOption} 
                                    styles={customStyles} 
                        ...
                        {/* LEFT COLUMN: Resource Name (Label and Input Wrapper changed) */}
                        <div className="col-md-6">
                            <label className="form-label **text-end** w-100">Resource Name <span style={{ color: "red" }}>*</span></label>
                            <div style={{ width: '80%' }} className="ms-auto">
                               <Select 
                                    options={emptyOption} 
                                    styles={{
                        ...
                        {/* RIGHT COLUMN: Rate (Label and Input changed) */}
                        <div className="col-md-6">
                            <label className="form-label **text-end** w-100"> Rate <span style={{ color: "red" }}>*</span></label>
                            <input 
                                type="number" 
                ...
                <FormSectionContainer title="Quantity & Measurements" icon={<AlignLeft size={20} className="text-primary" />}>
                    <div className="row g-3">
                        {/* LEFT COLUMN: UOM (Label and Input Wrapper changed) */}
                        <div className="col-md-6">
                            <label className="form-label **text-end** w-100">UOM <span style={{ color: "red" }}>*</span></label>
                            <div style={{ width: '80%' }} className="ms-auto">
                                <Select 
                                    options={emptyOption} 
                                    styles={customStyles} 
                        ...
                        {/* RIGHT COLUMN: Quantity Type (Label and Input Wrapper changed) */}
                        <div className="col-md-6">
                            <label className="form-label **text-end** w-100">Quantity Type <span style={{ color: "red" }}>*</span></label>
                            <div style={{ width: '80%' }} className="ms-auto">
                                <Select 
                                    options={emptyOption} 
                                    styles={customStyles} 
                        ...
                        {/* LEFT COLUMN: Coefficient (Label and Input changed) */}
                        <div className="col-md-6">
                            <label className="form-label **text-end** w-100">Coefficient <span style={{ color: "red" }}>*</span></label>
                            <input 
                                type="number" 
                                className="form-control ms-auto" 
                                style={{ borderRadius: '0.5rem', width: '80%' }} 
                        ...
                        {/* RIGHT COLUMN: Calculated Quantity (Label and Input changed) */}
                        <div className="col-md-6">
                            <label className="form-label **text-end** w-100">Calculated Quantity <span style={{ color: "red" }}>*</span></label>
                            <input 
                                type="text" 
                                className="form-control ms-auto" 
                                style={{ borderRadius: '0.5rem', width: '80%' }} 
