...
<div className="mt-5 mb-5">
    ...
    <div 
        ...
        style={{ 
            ...
            border: '1px solid #d9e4f2ff', // Light Blue Border
        }}
    >
        
        {/* Box Header: Tender Summary (Blue text, icon) */}
        <div className="d-flex align-items-center mb-3 fw-bold" style={{ color: '#005197' }}>
            {/* You need to replace this placeholder with your actual icon component or image */}
        ...
        <div className="d-flex flex-column" style={{ color: '#005197', fontSize: '14px' }}> 
            ...
            <div className="d-flex gap-5 mb-2"> 
                ...
                <div style={{ width: '200px' }}> 
                    Total Packages: <span style={{ color: '#005197' }}>{boqArray.length > 0 ? 1 : 0}</span> {/* Value is Blue and Not Bold */}
                </div> 

                {/* Selected Contractors */}
                <div style={{ width: '200px' }}>
                    Selected Contractors: <span style={{ color: '#005197' }}>{contractorsList.length}</span> {/* Value is Blue and Not Bold */}
                </div>
            </div>
            ...
            <div className="d-flex gap-5">
                {/* Attachments */}
                <div style={{ width: '200px' }}>
                    Attachments: <span style={{ color: '#005197' }}>{Object.keys(attachments).filter(key => attachments[key].files?.length > 0 || attachments[key].notes).length}</span> {/* Value is Blue and Not Bold */}
                </div>
                ...
                <div style={{ width: '200px' }}>
                    ...
                    <span 
                        style={{ 
                            // Red color (#dc3545) for the deadline (Set or Not Set)
                            color: '#dc3545' 
                        }}
                    >
