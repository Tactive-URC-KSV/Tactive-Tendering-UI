        ...
        <div className="container-fluid min-vh-100 p-0">
            ...
            <div className="px-4 text-start">
                ...
                <div className="d-flex justify-content-end mt-4">
                    <button type="button" className="btn px-4 fw-bold" onClick={handleGoBack} style={{ borderRadius: "6px", border: "none", color:'#005197CC' }}>
                        Edit
                    </button>
                    <button 
                        type="button" 
                        ...
                        style={{ backgroundColor: '#005197CC', color: "white", borderRadius: "6px"}}
                    >
                        Submit
                    </button>
                </div>
