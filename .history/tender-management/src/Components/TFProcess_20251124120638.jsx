...
<div className="mt-5">
    ...
    {Object.keys(attachments).map((key) => {
        ...
        // Assuming files[0] holds the file information (fileName, size, type)
        const fileInfo = files.length > 0 ? files[0] : null;

        // Helper function to format the file size (e.g., 4.2 MB)
            ...
            >
                <div className="d-flex justify-content-between align-items-start">
                    ...
                    <div className="text-start me-4 flex-grow-1">
                        ...
                        {/* 2. File Name/Details (RED COLOR) */}
                        {fileInfo ? (
                            <div className="d-block mt-1">
                                <span className="fw-medium me-2" style={{ fontSize: '13px', color: '#dc3545' }}>
                                    {/* Displaying File Name | Formatted Size */}
                                    {fileInfo.fileName || 'Attachment File'} | {formatFileSize(fileInfo.size) || 'N/A'}
                                </span>
                            </div>
                        ) : (
