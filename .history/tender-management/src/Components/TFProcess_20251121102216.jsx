                ...
                <div className="row gy-3">
                    ...
                    <div className="col-md-3">
                        <div className="border rounded p-3 bg-light">
                            <p className="fw-bold mb-2">Documents</p>
                    ...
                    <div className="col-md-3">
                        <div className="border rounded p-3 bg-light">
                            <p className="fw-bold mb-2">Approvals</p>
                            <ul className="list-unstyled small">
                                <li>• QC Approval</li>
                    ...
                    <div className="col-md-3">
                        <div className="border rounded p-3 bg-light">
                            <p className="fw-bold mb-2">Vendor Files</p>
                            <ul className="list-unstyled small">
                                <li>• Vendor Quote 1</li>
                                <li>• Vendor Quote 2</li>
                                <li>• Comparative Sheet</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="col-md-3">
                        <div className="border rounded p-3 bg-light">
                            <p className="fw-bold mb-2">Other Attachments</p>
                            <ul className="list-unstyled small">
                                <li>• Site Photos</li>
                                <li>• Work Order</li>
