        ...
        <>
            ...
            <div className="row mb-3">
                <div className="col-md-6 mb-3">
                    ...
                    <input type="text" className="w-100" id="entityCode" name="entityCode" value={formData.entityCode} onChange={handleChange} placeholder="Enter entity code" style={{ height: "40px" }} />
                </div>
                <div className="col-md-6 mb-3">
