...
function AddResource() {
    ...
    return (
        <div className="container-fluid min-vh-100">
            ...
            {/* --- BOQ Summary Container (FIXED: Simplified styles for fluid alignment) --- */}
            <div 
            ...
            {/* --- Main Content Area (FIXED: Re-added ms-3 me-3 for fluid alignment and spacing) --- */}
            <div 
                className="bg-white p-4 ms-3 me-3" // Re-added ms-3 me-3 for lateral margins/alignment
                style={{ 
                    // Removed max width and auto margins
                    borderRadius: '0 0 0.5rem 0.5rem',
                    border: `1px solid ${containerBorderColor}`, 
