  ...
  <>
   ...
   <div className="row mb-4">
    <div className="col-12 mt-3">
        ...
        {/* === Applied Exact Inline Border Styling === */}
        <div 
            className="p-4 text-center rounded" 
            style={{ 
                backgroundColor: "#f9f9f9", 
                cursor: "pointer", 
                // CRITICAL FIX: Explicitly define the dashed border style and color
                border: "2px dashed #ccc", // Use 2px thickness for visibility and #ccc for light grey color
                borderRadius: '8px' // Ensures rounded corners match the other fields
            }}
        >
