...
function AddResource() {
    ...
    const FormSectionContainer = ({ title, icon, defaultOpen = false, children }) => {
        ...
        // --- MODIFIED HEADER STYLE (Static: Top borders only, no bottom margin) ---
        const headerStyle = {
        ...
        // --- MODIFIED CONTENT STYLE (Static: Side and bottom borders only, no top margin) ---
        const contentStyle = { 
            padding: '1rem 1.5rem', 
    ...
    return (
        <div className="container-fluid min-vh-100">
            ...
            <div 
    className="text-white mx-3 d-flex justify-content-between align-items-center"
    style={{ 
        maxWidth: '90%',           // reduces width
        padding: '0.6rem 1rem',    // reduces height
