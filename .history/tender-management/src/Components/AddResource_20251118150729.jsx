...
function AddResource() {
    ...
    const FormSectionContainer = ({ title, icon, defaultOpen = false, children }) => {
        ...
        // Note: Using local state for collapsible sections if not using the <details> tag with 'open'
        ...
        // Collapsible sections using local state
        return (
            <div className="mb-4">
    ...
    return (
        <div className="container-fluid min-vh-100">
            ...
            {/* --- BOQ Summary Container (FIXED: Added marginRight and corrected borderRadius) --- */}
            <div 
                className="text-white p-3 d-flex justify-content-between align-items-center mx-3 " 
                style={{ 
                    // This combination centers the block with a max width of 93%
                    maxWidth: '93%', 
                    marginLeft: 'auto',
                    marginRight: 'auto', // Added this for proper centering
            ...
            {/* --- Main Content Area (FIXED: Updated styles to match BOQ Summary) --- */}
            <div 
                className="bg-white p-4" // Removed ms-3 me-3, using inline styles for centering
                style={{ 
                    // Match BOQ Summary width and centering
                    maxWidth: '93%', 
                    marginLeft: 'auto',
                    marginRight: 'auto',
                    // Re-added necessary border/shadow styles from previous correct version
                    borderRadius: '0 0 0.5rem 0.5rem',
                    border: `1px solid ${containerBorderColor}`, 
                    borderTop: 'none', 
                ...
                <FormSectionContainer title="Quantity & Measurements" icon={<AlignLeft size={20} className="text-primary" />}>
                    <div className="row g-3">
                        ...
                        <div className="col-md-6">
                            ...
                            {/* FIXED: Wrapped input in a div with 80% width */}
                            <div style={{ width: '80%' }}>
                                <input 
                                    type="number" 
                                    className="form-control" 
