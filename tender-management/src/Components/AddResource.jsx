...
function AddResource() {
    ...
    const boqId = useParams().boqId;
    const projectId = useParams().projectId;
    const tenderEstimationId = useParams().tenderEstimationId;
    ...
    const [resourceData, setResourceData] = useState({
        coEfficient: 1,
        calculatedQuantity: boq?.quantity || 0,
        wastePercentage: 0,
        wasteQuantity: 0,
        netQuantity: 0,
        rate: 0,
    ...
    const fetchTenderEstimationResource = () => {
    axios.get(
        `${import.meta.env.VITE_API_BASE_URL}/tender/estimatedResource/${tenderEstimationId}`,
        {
            headers: {
                Authorization: `Bearer ${sessionStorage.getItem('token')}`,
                'Content-Type': 'application/json'
        ...
        if (res.status === 200) {
            ...
            const cost = res.data.costDetails;
            const resource = tender.resource;

            setResourceData(prev => ({
                ...prev,
                coEfficient: tender.coEfficient ?? 0,
                ...
                costUnitRate: tender.costUnitRate ?? 0,
        ...
        <div className="container-fluid min-vh-100">
            ...
            >
                ...
                <div className="d-flex justify-content-end align-items-center">
                    <span className="me-3" style={{ fontSize: '0.9rem' }}>Unit of Measurement <strong>{boq?.uom?.uomCode}</strong></span>
                    <span style={{ fontSize: '0.9rem' }}>Total Quantity <strong>{boq?.quantity?.toFixed(3)}</strong></span>
                </div>
            </div>
                    ...
                    <div className="col-md-6">
                        ...
                        <div>
                            <Select
                                ...
                                className="w-100" classNamePrefix="select"
                    ...
                    <div className="col-md-6">
                        <div className="ms-auto">
                            ...
                            <Select
                                ...
                                placeholder="Select Nature" className="w-100"
            ...
            <div className="ms-3 me-3 rounded-3 mt-3 mb-3 bg-white pb-3">
                <div className="d-flex justify-content-between p-3 rounded-3" onClick={() => toggleSelection('Wastage & Net Quantity')} style={{ backgroundColor: '#EFF6FF', color: '#005197' }}>
            ...
            <div className="ms-3 me-3 rounded-3 mt-3 mb-3 bg-white pb-3">
                <div className="d-flex justify-content-between p-3 rounded-3" onClick={() => toggleSelection('Pricing & Currency')} style={{ backgroundColor: '#EFF6FF', color: '#005197' }}>
                    <div className="text-start fw-bold">
                        <Area size={20} className="me-1" />
                        Pricing & Currency
                    </div>
                ...
                {expandedSections["Pricing & Currency"] && (<div className="row g-3 ms-3 me-3 mt-2">
                    <div className="col-md-6">
                        <div className="mb-3">
