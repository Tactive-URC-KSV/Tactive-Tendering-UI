    ...
    return (
        <div className='container-fluid mt-3 min-vh-100'>
            ...
            <div className='row mt-3 align-items-center rounded bg-white p-3'>
                <div className='col-lg-3 col-md-6 col-sm-12'>
                    <label className='form-label text-start d-block ms-1'>Search</label>
                    <input type="text" value={projectName} className='form-input w-100' onChange={searchProjects} placeholder='Search by Project Name' />
                </div>
                <div className='col-lg-3 col-md-6 col-sm-12'>
                    <label className='form-label text-start d-block ms-1'>Sector</label>
                ...
                <div className='col-lg-3 col-md-6 col-sm-12'>
                    <label className='form-label text-start d-block ms-1'>Status</label>
                ...
                <div className='col-lg-3 col-md-6 col-sm-12'>
                    <label className='form-label text-start d-block ms-1'>Region</label>
