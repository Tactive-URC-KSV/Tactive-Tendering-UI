import { Filter, List, Plus, Grid, ClipboardCheck } from "lucide-react";
  ...
  const CheckboxFilterItem = ({ category, label }) => {
    ...
    return (
      <div
        ...
        style={{cursor: "pointer", paddingLeft: "1rem", paddingRight: "1rem", backgroundColor: isSelected ? "#E6F0F8" : "white", transition: "background-color 0.2s", minHeight: "28px", }}>
        <input type="checkbox"
          checked={isSelected}
          onChange={() => {}}
          style={{ cursor: "pointer", marginRight: "8px", accentColor: bluePrimary, transform: "scale(1.05)", border: "1px solid #005197CC", borderRadius: "3px",}}
        />
        <span
          className="fw-normal"
    ...
    <div className="container-fluid min-vh-100">
          ...
          <div className="col-lg-2 col-md-4 position-relative mt-3">
            ...
            <div className="dropdown w-100">
              <button
                ...
                style={{height: "38px", backgroundColor: "#E9F5FF", color: bluePrimary, boxShadow: "none", paddingLeft: "12px", paddingRight: "12px", border: `1px solid ${bluePrimary}33`, }}>
                Sort by
                <svg
              ...
              {isSortDropdownOpen && (
                <div
                  ...
                  style={{ position: "absolute", top: "100%", right: "0", left: "auto", minWidth: "180px", zIndex: 1000, padding: "4px 0", border: "1px solid #ccc", borderRadius: "4px", boxShadow: "0 4px 6px rgba(0,0,0,0.1)", }} >
                  <h6
      ...
      >
        <div className="d-flex justify-content-between">
          <div className="text-start fw-bold fs-6">
            Contractor List
          </div>
