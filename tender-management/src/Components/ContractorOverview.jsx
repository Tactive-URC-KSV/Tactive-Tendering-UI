        ...
        <div className="card text-start border-0 shadow-sm mt-4 px-4 pb-4" style={{ borderRadius: "8px", overflow: "hidden"  }}>
            ...
            <div className="row">
                <div className="col-md-6 mt-3 mb-4">
                    ...
                    <Select name="taxType" options={taxTypeOptions} onChange={handleSelectChange} classNamePrefix="select" value={taxTypeOptions?.find(opt => opt.value === formData.taxType)} placeholder="Select tax type" />
                </div>
                <div className="col-md-6 mt-3 mb-4">
                    <label className="projectform-select text-start d-block">Territory Type <span style={{ color: "red" }}>*</span></label>
                    <Select name="territoryType" options={territoryTypeOptions} onChange={handleSelectChange} classNamePrefix="select" value={territoryTypeOptions?.find(opt => opt.value === formData.territoryType)} placeholder="Select territory type" />
                </div>
            </div>
            <div className="row">
                <div className="col-md-6 mt-3 mb-4">
                    <label className="projectform-select text-start d-block">Territory <span style={{ color: "red" }}>*</span></label>
                    <Select name="territory" options={territoryOptions} onChange={handleSelectChange} classNamePrefix="select" value={territoryOptions?.find(opt => opt.value === formData.territory)} placeholder="Select territory" />
                </div>
                <div className="col-md-6 mt-3 mb-4">
                    <label className="projectform text-start d-block">Tax Reg No <span style={{ color: 'red' }}>*</span></label>
                    <input type="text" name="taxRegNo" className="form-input w-100" placeholder="Enter tax registration no" value={formData.taxRegNo} onChange={handleChange} />
                </div>
            </div>
            <div className="row">
                <div className="col-md-6 mt-3 mb-4">
                    ...
                    <div className="position-relative">
                        <Flatpickr
                            ...
                            options={{ dateFormat: "d-m-Y", allowInput: true }}
                            onClose={(_, dateStr) => {
                                setFormData(prev => ({ ...prev, taxRegDate: dateStr }));
                            }}
                        />
                        <span
                            className='calendar-icon'
                ...
                <div className="col-md-6 mt-3 mb-4">
                    <label className="projectform text-start d-block">Address 1</label>
                    <input type="text" name="taxAddress1" className="form-input w-100" placeholder="Enter address 1" value={formData.taxAddress1} onChange={handleChange} />
                </div>
            </div>
            <div className="row">
                <div className="col-md-6 mt-3 mb-4">
                    <label className="projectform text-start d-block">Address 2</label>
                    <input type="text" name="taxAddress2" className="form-input w-100" placeholder="Enter address 2" value={formData.taxAddress2} onChange={handleChange} />
                </div>
                <div className="col-md-6 mt-3 mb-4">
                    <label className="projectform-select text-start d-block">City <span style={{ color: "red" }}>*</span></label>
                    <Select name="taxCity" options={taxCityOptions} onChange={handleSelectChange} classNamePrefix="select" value={taxCityOptions?.find(opt => opt.value === formData.taxCity)} placeholder="Select city" />
                </div>
            </div>
            <div className="row">
                <div className="col-md-6 mt-3 mb-4">
                    <label className="projectform text-start d-block">Zip/Postal Code</label>
                    <input type="text" name="taxZipCode" className="form-input w-100" placeholder="Enter Zip/Postal Code" value={formData.taxZipCode} onChange={handleChange} />
                </div>
                <div className="col-md-6 mt-3 mb-4">
                    <label className="projectform text-start d-block">Email ID</label>
                    <input type="text" name="taxEmailID" className="form-input w-100" placeholder="Enter email ID" value={formData.taxEmailID} onChange={handleChange} />
                </div>
            </div>
        </div>
...
const EmailInviteForm = ({ formData, handleChange }) => (
    <>
...
const ReviewSummaryContent = ({ formData, handleGoBackToEntry, handleSubmitFinal }) => {
  ...
  <>
    <div className="d-inline-flex mb-4"
      style={{borderRadius: "6px",overflow: "hidden",border: `1px solid ${bluePrimary}`,}}>
      <button
