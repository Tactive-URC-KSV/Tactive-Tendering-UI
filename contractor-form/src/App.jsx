...
function App() {
  ...
  const [taxRegDate, setTaxRegDate] = useState(new Date());
...
const [additionalInfo, setAdditionalInfo] = useState({ type: "", registrationNo: ""});
 ...
 const handleFileChange = (e) => {
  ...
  const entityTypeOptions = [{ value: 'Contractor', label: 'Contractor' }, { value: 'Design Consultant', label: 'Design Consultant' }, { value: 'PMC Consultant', label: 'PMC Consultant' }];
  const natureOfBusinessOptions = [{ value: 'Contracting Services', label: 'Contracting Services' }, { value: 'Civil Contractor', label: 'Civil Contractor' }, { value: 'Infrastructure Contracting Services', label: 'Infrastructure Contracting Services' }];
  const gradeOptions = [{ value: 'A Grade', label: 'A Grade' }, { value: 'B Grade', label: 'B Grade' }];
  const addressTypeOptions = [{ value: 'Office Address', label: 'Office Address' }, { value: 'Present Address', label: 'Present Address' }];
  const taxTypeOptions = [{ value: 'Regular GST', label: 'Regular GST' }, { value: 'Composite GST', label: 'Composite GST' }, { value: 'GST Un-Register', label: 'GST Un-Register' }, { value: 'VAT Register', label: 'VAT Register' }, { value: 'VAT Un-Register', label: 'VAT Un-Register' }, { value: 'Trade License Register', label: 'Trade License Register' }, { value: 'Trade License Un-Register', label: 'Trade License Un-Register' }, { value: 'MSME Register', label: 'MSME Register' }];
  const territoryTypeOptions = [{ value: 'Country', label: 'Country' }, { value: 'State', label: 'State' }];
  const additionalInfoTypeOptions = [{ value: 'PAN No', label: 'PAN No' }, { value: 'TIN No', label: 'TIN No' }, { value: 'CIN No', label: 'CIN No' }];
...
const renderReviewForm = () => (
  <Container fluid className="bg-white p-4 min-vh-100" style={{ fontFamily: '"Inter", sans-serif' }}>
    <Card className="border-0 p-4">
     ...
     <Row 
  className="mb-5 pb-5 align-items-start" 
  style={{ borderBottom: '1px solid #0051973D' }}
>
        ...
        <Col md={9} className="ps-md-5">
          <Row className="gy-5">
            ...
            <Col md={4}>
              ...
              <div className="fw-bold text-dark fs-6">{basicInfo.entityType || ""}</div>
            </Col>
            <Col md={4}>
              <div className="text-muted mb-2 fs-6">Nature of Business</div>
              <div className="fw-bold text-dark fs-6">{basicInfo.natureOfBusiness || ""}</div>
            </Col>
            <Col md={4}>
              <div className="text-muted mb-2 fs-6">Grade</div>
              <div className="fw-bold text-dark fs-6">{basicInfo.grade || ""}</div>
            </Col>
          </Row>
...
{selectedFiles.map((file, index) => (
  <Col md={12} key={`${file.name}-${index}`} className="mb-2"> 
    <div className="d-flex align-items-center justify-content-between p-3 border border-light rounded-3 bg-light bg-opacity-25 shadow-sm">
      ...
      <Button 
        variant="link" 
        className="text-primary fw-bold text-decoration-none fs-6"
    ...
    <div className="p-3 border rounded text-muted bg-light bg-opacity-50" style={{ fontSize: '0.8rem' }}>
      No files uploaded
    </div>
  )}
</div>
  ...
  <Col md={9} className="ps-md-5">
    <Row className="gy-5">
      ...
      <Col md={4}>
        ...
        <div className="fw-bold text-dark fs-6">{addressDetails.addressType || ""}</div>
      </Col>
      <Col md={8}>
      ...
      <Col md={4}>
        ...
        <div className="fw-bold text-dark fs-6">{addressDetails.country || ""}</div>
      </Col>
      <Col md={4}>
        <div className="text-muted mb-1 fs-6">City</div>
        <div className="fw-bold text-dark fs-6">{addressDetails.city || ""}</div>
      </Col>
      <Col md={4}>
...
>
  ...
  <div className="fw-bold text-dark fs-6">
    {(() => {
      const dateVal = taxDetails.taxRegDate;

      const finalDate = Array.isArray(dateVal) ? dateVal[0] : dateVal;
  ...
  <Col md={9} className="ps-md-5">
    <Row className="gy-5">
      <Col md={4}>
        ...
        <div className="fw-bold text-dark fs-6">
          {additionalInfo.type || "PAN No"}
        </div>
      </Col>
      <Col md={8}>
        <div className="text-muted mb-1 fs-6">Registration No</div>
        <div className="fw-bold text-dark fs-6">
          {additionalInfo.registrationNo || ""}
        </div>
      </Col>
    </Row>
  </Col>
      ...
      <div className="d-flex justify-content-end gap-3 mt-4">
        <Button 
          ...
          className="px-5 py-2 border-2 fw-bold fs-6" 
        ...
        <Button 
          variant="primary" 
          className="px-5 py-2 shadow-sm fw-bold border-0 fs-6" 
        ...
        <Card.Body className="p-4">
          <Row>
            <Col md={6} className="outline-group">
             ...
             <Form.Control
  name="entityCode" value={basicInfo.entityCode} onChange={handleBasicInfoChange} className="outline-input" placeholder="Enter entity code"/>
            </Col>
            <Col md={6} className="outline-group">
            ...
            <Col md={6} className="outline-group">
              ...
              <div className="position-relative">
                ...
                <i 
                  ...
                  onClick={() => fpEffective.current.flatpickr.open()} 
                ></i>
              </div>
            </Col>
            <Col md={6} className="outline-group">
...
/>
  ...
  value={natureOfBusinessOptions.find(
    (opt) => opt.value === basicInfo.natureOfBusiness
  )}
  onChange={(selectedOption) =>
    setBasicInfo((prev) => ({
      ...prev,
      natureOfBusiness: selectedOption.value
    }))
  }
/>
</Col>
...
/>
  ...
  value={addressTypeOptions.find(
    (opt) => opt.value === addressDetails.addressType
  )}
  onChange={(selectedOption) =>
...
/>
          ...
          <Row>
            ...
            <Col md={6} className="outline-group">
              ...
              <Select styles={customSelectStyles} placeholder="Select Country" menuPortalTarget={document.body} />
            </Col>
          </Row>
          <Row>
            <Col md={6} className="outline-group">
...
<Col md={6} className="outline-group">
              ...
              <Select styles={customSelectStyles} placeholder="Select position" menuPortalTarget={document.body} />
            </Col>
          </Row>
          <Row>
            <Col md={6} className="outline-group">
...
/>
  ...
  onChange={(selectedOption) =>
    setTaxDetails(prev => ({
      ...prev,
      territoryType: selectedOption.value
    }))
  }
/>
  </Col>
  ...
  onChange={(selectedOption) =>
    setTaxDetails(prev => ({
      ...prev,
      territory: selectedOption.value
    }))
  }
/>
 </Col>
  ...
  <div className="position-relative">
    ...
    ></i>
          ...
          <Row>
            ...
            <Col md={6} className="outline-group">
              <label className="outline-label">City <span className="text-danger">*</span></label>
              <Select styles={customSelectStyles} placeholder="Select City" menuPortalTarget={document.body} />
            </Col>
          </Row>
          <Row>
            <Col md={6} className="outline-group">
